unit Unit_QrFindingPatanLabReport;
...
type
     TForm_QrFindingPatanLabReport = class(TForm)
    Qr_patanlabFinding: TQuickRep;
...
var
Form_QrFindingPatanLabReport: TForm_QrFindingPatanLabReport;
...
procedure TForm_QrFindingPatanLabReport.AddSignature;
VAR
...
procedure TForm_QrFindingPatanLabReport.ChildBand1AfterPrint(
...
procedure TForm_QrFindingPatanLabReport.ChildBand1BeforePrint(
...
procedure TForm_QrFindingPatanLabReport.CreateFindingsTable;
begin
...
procedure TForm_QrFindingPatanLabReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrFindingPatanLabReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrFindingPatanLabReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrFindingPatanLabReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrFindingPatanLabReport.lbl_reporteddate1Print(sender: TObject;
  var Value: string);
begin
//     lbl_ReportedDate1.Caption:=GetFindingPostDateTime
end;

procedure TForm_QrFindingPatanLabReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrFindingPatanLabReport.PrintBarcode;
Var
...
procedure TForm_QrFindingPatanLabReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrFindingPatanLabReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrFindingPatanLabReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrFindingPatanLabReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrFindingPatanLabReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrFindingPatanLabReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrFindingPatanLabReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
