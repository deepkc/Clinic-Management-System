unit Unit_QrDeptWiseNeuroBrtMicrobiologyReport;
...
type
     TForm_QrDeptWiseNeuroBrtMicrobiologyReport = class(TForm)
    Qr_NeuroBrtMicrobiology: TQuickRep;
    ...
    procedure Qr_NeuroBrtMicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseNeuroBrtMicrobiologyReport: TForm_QrDeptWiseNeuroBrtMicrobiologyReport;
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.FormCreate(Sender: TObject);
var
I:Integer;
RepComment: String;
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount > 35 then
      Qr_NeuroBrtMicrobiology.NewPage;
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.Qr_NeuroBrtMicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNeuroBrtMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
