unit Unit_QrDeptWiseNeuroBrtReport;
...
type
     TForm_QrDeptWiseNeuroBrtReport = class(TForm)
    Qr_NeuroBrtDeptWise: TQuickRep;
    ...
    procedure ChildBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
     ...
     public
          useridleft,useridright,userwiseid:String;
          { Public declarations }
     end;

var
     Form_QrDeptWiseNeuroBrtReport: TForm_QrDeptWiseNeuroBrtReport;
...
procedure TForm_QrDeptWiseNeuroBrtReport.AddSignature;
VAR
...
procedure TForm_QrDeptWiseNeuroBrtReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseNeuroBrtReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseNeuroBrtReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
//          QRShape1.Enabled := false;
     ...
     if gi_compileValue=14 then
          begin
               ...
               lbl_referaldoc.Caption :=GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);                   //GetRefDocCode(Gs_BillNo);
          end;
              ...
              begin
                   ...
                   begin
                        ...
                        begin
                            ...
                            sql.add ('select fullname,designation,signature,USERID');
                        ...
                        if (useridright<>'') or (useridleft<>'') then
                        gb_Signature:=True
                        else
                        gb_Signature:=false;
                   end;
...
procedure TForm_QrDeptWiseNeuroBrtReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNeuroBrtReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNeuroBrtReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNeuroBrtReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNeuroBrtReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseNeuroBrtReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNeuroBrtReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNeuroBrtReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
