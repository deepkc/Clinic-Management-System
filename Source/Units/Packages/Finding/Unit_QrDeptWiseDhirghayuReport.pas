unit Unit_QrDeptWiseDhirghayuReport;
...
type
     TForm_QrDeptWiseDhirghayuReport = class(TForm)
    Qr_DhirghayuDeptWise: TQuickRep;
    ...
    QRImage_Sanat_LT: TQRImage;
    QRImage_Sanat_LD: TQRImage;
    QRLabel79: TQRLabel;
...
var
     Form_QrDeptWiseDhirghayuReport: TForm_QrDeptWiseDhirghayuReport;
...
procedure TForm_QrDeptWiseDhirghayuReport.AddSignature;
begin
     ...
     if UpperCase(lbl_DocName_RD.Caption)='DR. SANAT CHALISE' then
     begin
          SignatureRT.Picture.Graphic:=QRImage_Sanat_LT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=QRImage_Sanat_LD.Picture.Graphic;
     end;
     {
     ...
     if UpperCase(lbl_Docname_LD.Caption)='DR. SANAT CHALISE' then
     begin
          SignatureLT.Picture.Graphic:=QRImage_Sanat_LT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=QRImage_Sanat_LD.Picture.Graphic;
     end;
     {
...
procedure TForm_QrDeptWiseDhirghayuReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseDhirghayuReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
...
procedure TForm_QrDeptWiseDhirghayuReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseDhirghayuReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseDhirghayuReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseDhirghayuReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseDhirghayuReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseDhirghayuReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseDhirghayuReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseDhirghayuReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseDhirghayuReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseDhirghayuReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseDhirghayuReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
