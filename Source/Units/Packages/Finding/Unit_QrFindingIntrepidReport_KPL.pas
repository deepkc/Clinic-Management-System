unit Unit_QrFindingIntrepidReport_KPL;
...
type
     TForm_QrFindingIntrepidReport_KPL = class(TForm)
    Qr_IntrepidFinding: TQuickRep;
...
var
Form_QrFindingIntrepidReport_KPL: TForm_QrFindingIntrepidReport_KPL;
...
procedure TForm_QrFindingIntrepidReport_KPL.AddSignature;
VAR
...
procedure TForm_QrFindingIntrepidReport_KPL.ChildBand1AfterPrint(
...
procedure TForm_QrFindingIntrepidReport_KPL.ChildBand1BeforePrint(
...
procedure TForm_QrFindingIntrepidReport_KPL.CreateFindingsTable;
begin
...
procedure TForm_QrFindingIntrepidReport_KPL.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
//          QRShape1.Enabled := false;
     ...
     lbl_referaldoc.Caption :=GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);                     //GetRefDoc(Gs_BillNo);   //
...
procedure TForm_QrFindingIntrepidReport_KPL.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrFindingIntrepidReport_KPL.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrFindingIntrepidReport_KPL.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrFindingIntrepidReport_KPL.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrFindingIntrepidReport_KPL.PrintBarcode;
Var
...
procedure TForm_QrFindingIntrepidReport_KPL.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrFindingIntrepidReport_KPL.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrFindingIntrepidReport_KPL.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrFindingIntrepidReport_KPL.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrFindingIntrepidReport_KPL.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrFindingIntrepidReport_KPL.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrFindingIntrepidReport_KPL.Table_FooterAfterScroll(DataSet: TDataSet);
begin
