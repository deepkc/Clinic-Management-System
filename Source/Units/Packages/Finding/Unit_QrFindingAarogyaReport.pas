unit Unit_QrFindingAarogyaReport;
...
type
     TForm_QrFindingAarogyaReport = class(TForm)
    Qr_AarogyaFinding: TQuickRep;
...
var
     Form_QrFindingAarogyaReport: TForm_QrFindingAarogyaReport;
...
procedure TForm_QrFindingAarogyaReport.AddSignature;
VAR
...
procedure TForm_QrFindingAarogyaReport.ChildBand1AfterPrint(
...
procedure TForm_QrFindingAarogyaReport.ChildBand1BeforePrint(
...
procedure TForm_QrFindingAarogyaReport.CreateFindingsTable;
begin
...
procedure TForm_QrFindingAarogyaReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
//          QRShape1.Enabled := false;
    ...
    // lbl_referaldoc.Caption := GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);                     //GetRefDoc(Gs_BillNo);   //
     ...
     label_address.Caption:= Gs_Address;
...
procedure TForm_QrFindingAarogyaReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrFindingAarogyaReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrFindingAarogyaReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrFindingAarogyaReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrFindingAarogyaReport.PrintBarcode;
Var
...
procedure TForm_QrFindingAarogyaReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrFindingAarogyaReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrFindingAarogyaReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrFindingAarogyaReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrFindingAarogyaReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrFindingAarogyaReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrFindingAarogyaReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
