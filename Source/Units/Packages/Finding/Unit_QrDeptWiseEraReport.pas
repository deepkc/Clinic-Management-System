...
uses
  ...
  pngimage, MemDS, DBAccess, Ora;

type
     TForm_QrDeptWiseEraReport = class(TForm)
    Qr_EraDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseEraReport: TForm_QrDeptWiseEraReport;
...
procedure TForm_QrDeptWiseEraReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseEraReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseEraReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseEraReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseEraReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
     ...
     begin
          ...
          begin
              ...
              begin
                  ...
                  sql.add ('select fullname,(select doct_specialization from hs_doct_doctor where DOCT_DOCNAME=l.fullname)specialization');
                  sql.Add(',(select doct_qualification from hs_doct_doctor where DOCT_DOCNAME=l.fullname)qualification');
                  sql.Add(', (select signature from hs_doct_doctor where DOCT_DOCNAME=l.fullname)signature from lab_usermain l where username in ( ');
          ...
          if gs_ReportFooterRegulation='S' then//Manual Report Footer
              begin
...
procedure TForm_QrDeptWiseEraReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseEraReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseEraReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseEraReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseEraReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseEraReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseEraReport.QRLabel80Print(sender: TObject;
  var Value: string);
begin
     value:= gs_HospitalName;
end;

procedure TForm_QrDeptWiseEraReport.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     //value:= gs_HospitalAddress;
end;

procedure TForm_QrDeptWiseEraReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseEraReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseEraReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseEraReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseEraReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseEraReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
