unit Unit_QrIntrepidMicrobiologyReport;
...
uses
  ...
  MemDS, DBAccess, Ora, pngimage,Unit_Master_Hos;

type
     TForm_QrIntrepidMicrobiologyReport = class(TForm)
    Qr_IntrepidMicrobiology: TQuickRep;
    ...
    QRLabel56: TQRLabel;
    qryTQuery: TOraQuery;
    QueryFindingPostByInrep: TOraQuery;
    QRLabel57: TQRLabel;
    QRLabel58: TQRLabel;
    ...
    procedure Qr_IntrepidMicrobiologyBeforePrint(Sender: TCustomQuickRep;
    ...
    procedure QRSubDetail3BeforePrint(Sender: TQRCustomBand;
     ...
     public
          ...
          useridleft,useridright:string;
     end;

var
     Form_QrIntrepidMicrobiologyReport: TForm_QrIntrepidMicrobiologyReport;
...
procedure TForm_QrIntrepidMicrobiologyReport.AddSignature;
...
begin
   ...
   begin
          if QueryFindingPostByInrep.FieldByName('USERID').AsInteger=OraQuery_FooterVerifiedBy.FieldByName('USERID').AsInteger then
          begin
...
procedure TForm_QrIntrepidMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrIntrepidMicrobiologyReport.FormCreate(Sender: TObject);
var
I:Integer;
RepComment: String;
begin
...
//          QRShape1.Enabled := false;
     ...
     QRLabel56.caption:=gs_UserName;
     //lbl_referaldoc.Caption := GetRefDoc(Gs_BillNo);
     lbl_referaldoc.Caption := GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);                          // GetRefDocfrompatienttest(gs_billno);
     ...
     begin
          ...
          begin
              ...
              begin
                   ...
                   with QueryFindingPostByInrep do
                   begin
                       Close;
                       SQL.Clear;
                       Session:=Dm_Hospital.Db;
                      ...
                      // lbl_DocName_LT.Caption:= OraQuery_CollectedBy.FieldByName('fullname').AsString;
                       lbl_DocName_LD.Caption:= QueryFindingPostByInrep.FieldByName('fullname').AsString;
                     //  lbl_Qualification_LT.Caption := OraQuery_CollectedBy.FieldByName('qualification').AsString;
                       lbl_Qualification_LD.Caption := QueryFindingPostByInrep.FieldByName('designation').AsString;
                     //  lbl_Specialization_LT.Caption := OraQuery_CollectedBy.FieldByName('specialization').AsString;
                       lbl_Specialization_LD.Caption := '';

                       if QueryFindingPostByInrep.FieldByName('NMCNO').AsString<>'' then
                       begin
                            lbl_Specialization_LD.Caption :='NMC No. '+ QueryFindingPostByInrep.FieldByName('NMCNO').AsString;
                            lbl_DocName_LD.Caption:='Dr. '+lbl_DocName_LD.Caption;
                       end;

                       if QueryFindingPostByInrep.FieldByName('NHPCNO').AsString<>'' then
                       begin
                            lbl_Specialization_LD.Caption :='NHPC No. '+QueryFindingPostByInrep.FieldByName('NHPCNO').AsString;
                       end;

                   end;
                   useridleft :=QueryFindingPostByInrep.FieldByName('USERID').AsString;
...
procedure TForm_QrIntrepidMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrIntrepidMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrIntrepidMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrIntrepidMicrobiologyReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrIntrepidMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrIntrepidMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrIntrepidMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
...
begin
     ...
     begin
          ...
          begin
               ...
               QRDBText1.Alignment := taLeftJustify;
               QRDBText1.Width := 289;
               QRDBText1.Lines.Text:='First Line';
          end;
     end;
...
procedure TForm_QrIntrepidMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount > 35 then
      Qr_IntrepidMicrobiology.NewPage;
...
procedure TForm_QrIntrepidMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrIntrepidMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrIntrepidMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
...
procedure TForm_QrIntrepidMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrIntrepidMicrobiologyReport.Qr_IntrepidMicrobiologyBeforePrint(
...
procedure TForm_QrIntrepidMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrIntrepidMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrIntrepidMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
