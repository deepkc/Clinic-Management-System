unit Unit_QrDeptWiseGMCLABA4MicrobiologyReport_kpl;
...
type
     TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl = class(TForm)
    Qr_GMClabA4Microbiology: TQuickRep;
    ...
    procedure Qr_GMClabA4MicrobiologyBeforePrint(Sender: TCustomQuickRep;
    ...
    procedure QRSubDetail6BeforePrint(Sender: TQRCustomBand;
     ...
     public
          ...
          useridleft,useridcenter,useridright:String;
          { Public declarations }
          pbIsEmergency:Boolean;
     end;

var
     Form_QrDeptWiseGMCA4MicrobiologyReport_kpl: TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl;
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.AddSignature;
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
...
//          QRShape1.Enabled := false;
   ...
   //  QRLabel65.Caption:=GetHeightWeightBP(gi_patienttestid,gi_patientid,gi_testnameid);
     ...
     begin
          ...
          begin
                   if gi_compileValue in [14,21,23,24,26,27,28] then
                   begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
    value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.PageFooterBand1BeforePrint(
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_GMClabA4Microbiology.NewPage;
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.Qr_GMClabA4MicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseGMCA4MicrobiologyReport_kpl.Table_FooterAfterScroll(DataSet: TDataSet);
begin
