object Form_SensitivityResultNeuroBrt: TForm_SensitivityResultNeuroBrt
  Left = 0
  Top = 0
  ...
  object dbgrd2: TDBGrid
    ...
    Columns = <
      item
        ...
        FieldName = 'Medicine'
        Title.Alignment = taCenter
        Title.Caption = 'Partial Sensitivity'
        Width = 154
        Visible = True
      end>
  end
