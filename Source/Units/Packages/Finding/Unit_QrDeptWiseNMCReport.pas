...
type
     TForm_QrDeptWiseNMCReport = class(TForm)
    Qr_NMCDeptWise: TQuickRep;
    ...
    procedure Qr_NMCDeptWiseBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseNMCReport: TForm_QrDeptWiseNMCReport;
...
procedure TForm_QrDeptWiseNMCReport.AddSignature;
begin
     ...
     {if UpperCase(lbl_DocName_RD.Caption)='MR. PRASHANT REGMI' then
     begin
          SignatureRT.Picture.Graphic:=Image_MeeraT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_MeeraT.Picture.Graphic;
     end;
...
procedure TForm_QrDeptWiseNMCReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNMCReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     ...
     begin
          ...
          begin
              ...
              begin
                  ...
                  sql.add ('select fullname,(select specilization from doctor where f_name||'' ''||l_name=l.fullname)specialization');
                  sql.Add(',(select qualification from doctor where f_name||'' ''||l_name=l.fullname)qualification');
                  sql.Add(', (select signature from doctor where f_name||'' ''||l_name=l.fullname)signature from lab_usermain l where username in ( ');
...
procedure TForm_QrDeptWiseNMCReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNMCReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNMCReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNMCReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNMCReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNMCReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNMCReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNMCReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
      if ItemsCount > 18 then
      Qr_NMCDeptWise.NewPage;
end;

procedure TForm_QrDeptWiseNMCReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNMCReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNMCReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNMCReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
     ...
     begin
          ...
          SummaryBand1.Height:=0;
          //QRLabel43.Top:=1;
          QRSysData_PageNo.Top:=45;
          QRLBL_PageCap.Top:=45;
          qrlbl_Of.Top:=45;
          lbl_totpage.Top:=45;
          QRLBL_ReportBy.Top:=45;
          QRLBL_ReportByCap.Top:=45;
...
procedure TForm_QrDeptWiseNMCReport.Qr_NMCDeptWiseBeforePrint(
...
procedure TForm_QrDeptWiseNMCReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNMCReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNMCReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
