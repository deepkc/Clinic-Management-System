unit Unit_QrPatanHistoPathInvestigativeResult;
...
type
     TForm_patanHistoQrPathFinding = class(TForm)
    Qr_patanlabHistorFinding: TQuickRep;
    ...
    procedure Qr_patanlabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
...
var
     Form_patanHistoQrPathFinding: TForm_patanHistoQrPathFinding;
...
procedure TForm_patanHistoQrPathFinding.AddSignature;
begin
...
procedure TForm_patanHistoQrPathFinding.CreateFindingsTable;
begin
...
procedure TForm_patanHistoQrPathFinding.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_patanHistoQrPathFinding.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_patanHistoQrPathFinding.FormCreate(Sender: TObject);
Var
     I:Integer;
...
procedure TForm_patanHistoQrPathFinding.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_patanHistoQrPathFinding.lbl_DocName_CDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape1.Enabled:=False;
end;

procedure TForm_patanHistoQrPathFinding.lbl_Docname_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape5.Enabled:=False;
end;

procedure TForm_patanHistoQrPathFinding.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape11.Enabled:=False;
end;

procedure TForm_patanHistoQrPathFinding.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape8.Enabled:=False;
end;

procedure TForm_patanHistoQrPathFinding.lbl_LabTechHPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_patanHistoQrPathFinding.lbl_LabTechPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_patanHistoQrPathFinding.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_patanHistoQrPathFinding.OraQuery_FindingAfterScroll(DataSet: TDataSet);
var
     ms: TMemoryStream;
...
procedure TForm_patanHistoQrPathFinding.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_patanHistoQrPathFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //ItemsCount := 0;
...
procedure TForm_patanHistoQrPathFinding.PrintBarcode;
Var
...
procedure TForm_patanHistoQrPathFinding.Qr_patanlabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_patanHistoQrPathFinding.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_patanHistoQrPathFinding.QRLabel80Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalName;
end;

procedure TForm_patanHistoQrPathFinding.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     value:=gs_HospitalAddress;
end;

procedure TForm_patanHistoQrPathFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
    // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_patanHistoQrPathFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_patanHistoQrPathFinding.QRSubDetail2AfterPrint(
...
procedure TForm_patanHistoQrPathFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_patanHistoQrPathFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
