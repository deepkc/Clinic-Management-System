unit Unit_QrDeptWiseVigourReport;
...
type
     TForm_QrDeptWiseVigourReport = class(TForm)
    Qr_VigourDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseVigourReport: TForm_QrDeptWiseVigourReport;
...
procedure TForm_QrDeptWiseVigourReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseVigourReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseVigourReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseVigourReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseVigourReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrDeptWiseVigourReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseVigourReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseVigourReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseVigourReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseVigourReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseVigourReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseVigourReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseVigourReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseVigourReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseVigourReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseVigourReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseVigourReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
