unit Unit_QrFindingIntrepidReport;
...
type
     TForm_QrFindingIntrepidReport = class(TForm)
...
var
Form_QrFindingIntrepidReport: TForm_QrFindingIntrepidReport;
...
procedure TForm_QrFindingIntrepidReport.AddSignature;
VAR
...
procedure TForm_QrFindingIntrepidReport.ChildBand1AfterPrint(
...
procedure TForm_QrFindingIntrepidReport.ChildBand1BeforePrint(
...
procedure TForm_QrFindingIntrepidReport.CreateFindingsTable;
begin
...
procedure TForm_QrFindingIntrepidReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrFindingIntrepidReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrFindingIntrepidReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrFindingIntrepidReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrFindingIntrepidReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrFindingIntrepidReport.PrintBarcode;
Var
...
procedure TForm_QrFindingIntrepidReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrFindingIntrepidReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrFindingIntrepidReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrFindingIntrepidReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrFindingIntrepidReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrFindingIntrepidReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrFindingIntrepidReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
