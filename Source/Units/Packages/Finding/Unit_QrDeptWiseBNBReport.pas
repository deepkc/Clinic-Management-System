...
type
     TForm_QrDeptWiseBnbReport = class(TForm)
    Qr_BnbDeptWise: TQuickRep;
    ...
    QRShape15: TQRShape;
    QRLabel55: TQRLabel;
    QRLabel_RepoertAD: TQRLabel;
    OraQuery2: TOraQuery;
    QRLabel_analysisdatead: TQRLabel;
    QRLabel56: TQRLabel;
...
var
     Form_QrDeptWiseBnbReport: TForm_QrDeptWiseBnbReport;
...
procedure TForm_QrDeptWiseBnbReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseBnbReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseBnbReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseBnbReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseBnbReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
//          QRShape1.Enabled := false;
     ...
     lbl_Name.Caption := UPPERCASE(Gs_PatientName);
     ...
     //bl_referaldoc.Caption := GetRefDocfrompatienttest(gs_billno);
     lbl_RegisteredDate.Caption := GetSampleRegesteredDate(gs_SampleNo);
     lbl_ReportedDate.Caption := GetFindingPostDate(gs_SampleNo);
     QRLabel_RepoertAD.Caption:=GetSampleRegesteredDateAD(gs_SampleNo)+' AD';
     QRLabel_analysisdatead.Caption:=GetFindingPostDateAD(gs_SampleNo);
...
procedure TForm_QrDeptWiseBnbReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseBnbReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseBnbReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseBnbReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseBnbReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseBnbReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseBnbReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
      //if ItemsCount > 32 then
      //Qr_BnbDeptWise.NewPage;
end;

procedure TForm_QrDeptWiseBnbReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseBnbReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseBnbReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseBnbReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseBnbReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
