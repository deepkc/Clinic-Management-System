unit Unit_QrDeptWiseA4ReportNOZOMIKpl;
...
type
     TForm_QrDeptWiseA4NOZOMIReportKpl = class(TForm)
    Qr_NOZOMIDeptWise: TQuickRep;
    ...
    procedure Qr_NOZOMIDeptWiseAfterPrint(Sender: TObject);
    procedure Qr_NOZOMIDeptWiseBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseA4NOZOMIReportKpl: TForm_QrDeptWiseA4NOZOMIReportKpl;
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.AddSignature;
Var
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.FormCreate(Sender: TObject);
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.FormShow(Sender: TObject);
begin
     //gi_testhead:=0;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.Hospital_namePrint(sender: TObject;
  var Value: string);
begin
   value:=gs_HospitalName;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRDBText1Print(Sender: TObject; var Value: string);
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRLabel26Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalAddress;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRLabel32Print(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRLabel46Print(sender: TObject;
  var Value: string);
begin
      value:=gs_HospitalPhoneNumber;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSubDetail2AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //new page
     if (Table_Findings.FieldByName('FOOTER').AsString<>'')and(Table_Findings.FindNext=true)  then
     begin
          Qr_NOZOMIDeptWise.NewPage;
        //  gb_isheadershown:=True;
          Table_Findings.FindPrior;
     end;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSysData2Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.Qr_NOZOMIDeptWiseAfterPrint(
  Sender: TObject);
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.Qr_NOZOMIDeptWiseBeforePrint(
...
procedure TForm_QrDeptWiseA4NOZOMIReportKpl.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseA4NOZOMIReportKpl.Table_FooterAfterScroll(DataSet: TDataSet);
begin
