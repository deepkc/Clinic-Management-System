unit Unit_QrDeptWiseNCHRCA4MicrobiologyReport;
...
type
     TForm_QrDeptWiseNCHRCA4MicrobiologyReport = class(TForm)
    Qr_NCHRCA4Microbiology: TQuickRep;
    ...
    procedure Qr_NCHRCA4MicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseNCHRCA4MicrobiologyReport: TForm_QrDeptWiseNCHRCA4MicrobiologyReport;
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.AddSignature;
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.PageFooterBand1BeforePrint(
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_NCHRCA4Microbiology.NewPage;
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.Qr_NCHRCA4MicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNCHRCA4MicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
