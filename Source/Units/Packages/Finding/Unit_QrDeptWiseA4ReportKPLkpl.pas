unit Unit_QrDeptWiseA4ReportKPLKpl;
...
uses
  ...
  MemDS, DBAccess,Unit_Master, Ora;

type
     TForm_QrDeptWiseA4NReportKPLkpl = class(TForm)
    Qr_KPLDeptWise: TQuickRep;
    ...
    procedure Qr_KPLDeptWiseAfterPrint(Sender: TObject);
    procedure Qr_KPLDeptWiseBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseA4NReportKPLkpl: TForm_QrDeptWiseA4NReportKPLkpl;
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.AddSignature;
Var
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.FormCreate(Sender: TObject);
...
//          QRShape1.Enabled := false;
     ...
     lbl_referaldoc.Caption := GetRefDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);          //GetRefDoc(Gs_BillNo);
     ...
     begin
          ...
          begin
               ...
               begin
                   ...
                   SQL.Add('select doct_docname as docname,doct_qualification as QUALIFICATION,doct_specialization as SPECIALIZATION,doct_nmcno as nmcno from hs_doct_doctor');
                   SQL.Add('where docid='+InttoStr( gi_PatientDocId));//;Gi_RefDocId
//                   SQL.savetofile('c:/footercheckverify.txt');
                   Open;
                   if gi_PatientDocId>0 then
                   begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.FormShow(Sender: TObject);
begin
     //gi_testhead:=0;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.Hospital_namePrint(sender: TObject;
  var Value: string);
begin
   value:=gs_HospitalName;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRDBText1Print(Sender: TObject; var Value: string);
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRLabel26Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalAddress;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.QRLabel32Print(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSubDetail2AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //new page
     if (Table_Findings.FieldByName('FOOTER').AsString<>'')and(Table_Findings.FindNext=true)  then
     begin
          Qr_KPLDeptWise.NewPage;
        //  gb_isheadershown:=True;
          Table_Findings.FindPrior;
     end;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSysData2Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.Qr_KPLDeptWiseAfterPrint(
  Sender: TObject);
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.Qr_KPLDeptWiseBeforePrint(
...
procedure TForm_QrDeptWiseA4NReportKPLkpl.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseA4NReportKPLkpl.Table_FooterAfterScroll(DataSet: TDataSet);
begin
