unit Unit_QrDeptWiseShankarapurReport;
...
type
     TForm_QrDeptWiseShankarapurReport = class(TForm)
    Qr_ShankarapurDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseShankarapurReport: TForm_QrDeptWiseShankarapurReport;
...
procedure TForm_QrDeptWiseShankarapurReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseShankarapurReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseShankarapurReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseShankarapurReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseShankarapurReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrDeptWiseShankarapurReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseShankarapurReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseShankarapurReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseShankarapurReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseShankarapurReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseShankarapurReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseShankarapurReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseShankarapurReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseShankarapurReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseShankarapurReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseShankarapurReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseShankarapurReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
