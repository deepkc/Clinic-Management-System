unit Unit_QrAarogyaMicrobiologyReport;
...
type
     TForm_QrAarogyaMicrobiologyReport = class(TForm)
    Qr_AarogyaMicrobiology: TQuickRep;
    ...
    procedure Qr_AarogyaMicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrAarogyaMicrobiologyReport: TForm_QrAarogyaMicrobiologyReport;
...
procedure TForm_QrAarogyaMicrobiologyReport.AddSignature;
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.FormCreate(Sender: TObject);
var
I:Integer;
RepComment: String;
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrAarogyaMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrAarogyaMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrAarogyaMicrobiologyReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrAarogyaMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrAarogyaMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrAarogyaMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount > 35 then
      Qr_AarogyaMicrobiology.NewPage;
...
procedure TForm_QrAarogyaMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrAarogyaMicrobiologyReport.Qr_AarogyaMicrobiologyBeforePrint(
...
procedure TForm_QrAarogyaMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrAarogyaMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrAarogyaMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
