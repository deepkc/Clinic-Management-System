unit Unit_QrDeptWiseVigourMicrobiologyReport;
...
type
     TForm_QrDeptWiseVigourMicrobiologyReport = class(TForm)
    Qr_VigourMicrobiology: TQuickRep;
    ...
    procedure Qr_VigourMicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseVigourMicrobiologyReport: TForm_QrDeptWiseVigourMicrobiologyReport;
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.FormCreate(Sender: TObject);
var
I:Integer;
RepComment: String;
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseVigourMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseVigourMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseVigourMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount > 35 then
      Qr_VigourMicrobiology.NewPage;
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.Qr_VigourMicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseVigourMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseVigourMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    //QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseVigourMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
