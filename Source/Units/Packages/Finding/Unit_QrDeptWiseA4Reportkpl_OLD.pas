...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
      if ItemsCount > 35 then
      Qr_NMCA4DeptWise.NewPage;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
