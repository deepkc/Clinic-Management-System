unit Unit_QrGMCHistoPathInvestigativeResult;
...
type
     TForm_GMCHistoQrPathFinding = class(TForm)
    Qr_GMClabHistorFinding: TQuickRep;
    ...
    procedure Qr_GMClabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
...
var
     Form_GMCHistoQrPathFinding: TForm_GMCHistoQrPathFinding;
...
procedure TForm_GMCHistoQrPathFinding.AddSignature;
begin
...
procedure TForm_GMCHistoQrPathFinding.CreateFindingsTable;
begin
...
procedure TForm_GMCHistoQrPathFinding.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_GMCHistoQrPathFinding.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_GMCHistoQrPathFinding.FormCreate(Sender: TObject);
Var
     I:Integer;
...
procedure TForm_GMCHistoQrPathFinding.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_GMCHistoQrPathFinding.lbl_DocName_CDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape1.Enabled:=False;
end;

procedure TForm_GMCHistoQrPathFinding.lbl_Docname_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape5.Enabled:=False;
end;

procedure TForm_GMCHistoQrPathFinding.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape11.Enabled:=False;
end;

procedure TForm_GMCHistoQrPathFinding.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape8.Enabled:=False;
end;

procedure TForm_GMCHistoQrPathFinding.lbl_LabTechHPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_GMCHistoQrPathFinding.lbl_LabTechPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_GMCHistoQrPathFinding.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_GMCHistoQrPathFinding.OraQuery_FindingAfterScroll(DataSet: TDataSet);
var
     ms: TMemoryStream;
...
procedure TForm_GMCHistoQrPathFinding.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_GMCHistoQrPathFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //ItemsCount := 0;
...
procedure TForm_GMCHistoQrPathFinding.PrintBarcode;
Var
...
procedure TForm_GMCHistoQrPathFinding.Qr_GMClabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_GMCHistoQrPathFinding.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_GMCHistoQrPathFinding.QRLabel80Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalName;
end;

procedure TForm_GMCHistoQrPathFinding.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     value:=gs_HospitalAddress;
end;

procedure TForm_GMCHistoQrPathFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
    // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_GMCHistoQrPathFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_GMCHistoQrPathFinding.QRSubDetail2AfterPrint(
...
procedure TForm_GMCHistoQrPathFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_GMCHistoQrPathFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
