unit Unit_QrDeptWiseNOZOMIMicrobiologyReport;
...
type
     TForm_QrDeptWiseNOZOMIMicrobiologyReport = class(TForm)
    Qr_NOZOMIMicrobiology: TQuickRep;
    ...
    procedure Qr_NOZOMIMicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseNOZOMIMicrobiologyReport: TForm_QrDeptWiseNOZOMIMicrobiologyReport;
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.addressPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.AddSignature;
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.hospital_namePrint(
  sender: TObject; var Value: string);
begin
      value:=gs_HospitalName;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.PageFooterBand1BeforePrint(
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRLabel59Print(
  sender: TObject; var Value: string);
begin
   value:=gs_HospitalPhoneNumber;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_NOZOMIMicrobiology.NewPage;
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.Qr_NOZOMIMicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseNOZOMIMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
