unit Unit_QrDeptWiseMeridianReport;
...
type
     TForm_QrDeptWiseMeridianReport = class(TForm)
    Qr_MeridianDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseMeridianReport: TForm_QrDeptWiseMeridianReport;
...
procedure TForm_QrDeptWiseMeridianReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseMeridianReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseMeridianReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseMeridianReport.CreateFindingsTable;
begin
     ...
     begin
          ...
          FieldDefs.Add('Extra', ftString, 255);
          FieldDefs.Add('ExtraFinding', ftString, 255);
...
procedure TForm_QrDeptWiseMeridianReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrDeptWiseMeridianReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseMeridianReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseMeridianReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseMeridianReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseMeridianReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseMeridianReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseMeridianReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseMeridianReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseMeridianReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseMeridianReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseMeridianReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseMeridianReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
