unit Unit_QrDeptWiseCivilHospitalReport;
...
type
     TForm_QrDeptWiseCivilHospitalReport = class(TForm)
    Qr_CivilHospitalDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseCivilHospitalReport: TForm_QrDeptWiseCivilHospitalReport;
...
procedure TForm_QrDeptWiseCivilHospitalReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.FormCreate(Sender: TObject);
begin
     ps_deptype := GetUserDepType(gi_UserID);
     Ps_Depid:= inttostr(gi_depid);
...
//          QRShape1.Enabled := false;
     ...
     begin
          ...
          begin
              ...
              begin
                   lbl_Qualification_RD.Caption := GetManualFooternameRightQualification(Ps_Depid);
                   lbl_DocName_RD.Caption := GetManualFooternameRight(Ps_Depid);
                   lbl_Specialization_RD.Caption :=GetManualFooternameRightSpecialization(Ps_Depid);
                   QRLabel5.Caption :=GetManualFooternameRightStatus(Ps_Depid);
                   if Trim(QRLabel5.Caption) = '' then
                        QRShape11.Enabled := false;


                  lbl_Qualification_LD.Caption := GetManualFooternameLeftQualification(Ps_Depid);
                  lbl_Docname_LD.Caption := GetManualFooternameLeft(Ps_Depid);
                  lbl_Specialization_LD.Caption := GetManualFooternameLeftSpecialization(Ps_Depid);
                  QRLabel2.Caption := GetManualFooternameLeftStatus(Ps_Depid);
                  if Trim(QRLabel2.Caption) = '' then
                     QRShape1.Enabled := false;

                   lbl_Qualification_CD.Caption := GetManualFooternameCenterQualification(Ps_Depid);
                   lbl_DocName_CD.Caption := GetManualFooternameCenter(Ps_Depid);
                   lbl_Specialization_CD.Caption := GetManualFooternameCenterSpecialization(Ps_Depid);
                   QRLabel30.Caption := GetManualFooternameCenterStatus(Ps_Depid);
                   if Trim(QRLabel30.Caption) = '' then
                        QRShape12.Enabled := false;


                  lbl_Qualification_CT.Caption :=GetManualFooternameCenterQualification(Ps_Depid);
                  lbl_Docname_CT.Caption :=GetManualFooternameCenter(Ps_Depid);
                  lbl_Specialization_CT.Caption :=GetManualFooternameCenterSpecialization(Ps_Depid);
                  QRLabel28.Caption := GetManualFooternameCenterStatus(Ps_Depid);
                  if Trim(QRLabel28.Caption) = '' then
                        QRShape2.Enabled := false;


                  lbl_Qualification_LT.Caption := GetManualFooternameLeftQualification(Ps_Depid);
                  lbl_DocName_LT.Caption :=GetManualFooternameLeft(Ps_Depid);
                  lbl_Specialization_LT.Caption := GetManualFooternameLeftSpecialization(Ps_Depid);
                  QRLabel9.Caption := GetManualFooternameLeftStatus(Ps_Depid);
                  if Trim(QRLabel9.Caption) = '' then
                     QRShape5.Enabled := false;

                  lbl_Qualification_RT.Caption :=GetManualFooternameRightQualification(Ps_Depid);
                  lbl_DocName_RT.Caption := GetManualFooternameRight(Ps_Depid);
                  lbl_Specialization_RT.Caption := GetManualFooternameRightSpecialization(Ps_Depid);
                  QRLabel29.Caption := GetManualFooternameRightStatus(ps_depid);
...
procedure TForm_QrDeptWiseCivilHospitalReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseCivilHospitalReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseCivilHospitalReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseCivilHospitalReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseCivilHospitalReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseCivilHospitalReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseCivilHospitalReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseCivilHospitalReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
