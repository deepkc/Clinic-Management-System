unit Unit_QrDeptWiseMANGALAMA4MicrobiologyReport;
...
uses
  ...
  MemDS, DBAccess, Ora, pngimage;

type
     TForm_QrDeptWiseMANGALAMA4MicrobiologyReport = class(TForm)
    Qr_MANGALAMA4Microbiology: TQuickRep;
    ...
    qrdbtxtSensitivity: TQRDBText;
    qrshp2: TQRShape;
    qrlbl6: TQRLabel;
    qrlbl7: TQRLabel;
    qrlbl8: TQRLabel;
    qrdbtxtTest: TQRDBText;
    qrdbtxtTest1: TQRDBText;
    qrshp3: TQRShape;
    qrshp6: TQRShape;
    qrshp7: TQRShape;
    qrshp9: TQRShape;
    qrshp4: TQRShape;
    qrlbl9: TQRLabel;
    Table_Sensitivity: TTable;
    Table_Sensitivity2: TTable;
    Table_Sensitivity3: TTable;
    qrsbdtl2 :TQRSubDetail;
    qrsbdtl3 :TQRSubDetail;
    ...
    QRShape17: TQRShape;
    QRShape18: TQRShape;
    Table_Finding2: TTable;
    Table_Finding3: TTable;
    ...
    qrlbl5: TQRLabel;
    qrshp1: TQRShape;
    qrsbdtlSubDetail_SampleSource: TQRSubDetail;
    qrdbtxt1: TQRDBText;
    qrdbtxt2: TQRDBText;
    qrdbtxt3: TQRDBText;
    qrdbtxt4: TQRDBText;
    QRSubDetail7: TQRSubDetail;
    qrdbrchtxt1: TQRDBRichText;
    qrlbl1: TQRLabel;
    Richtext_Comment: TQRLabel;
    QRDBText20: TQRDBText;
    QRDBText21: TQRDBText;
    QRDBText22: TQRDBText;
    Table_sensitivity4: TTable;
    Table_Finding4: TTable;
    ...
    QrLabel60: TQRLabel;
    QrLabel58: TQRLabel;
    QrLabel_billno: TQRLabel;
    OraQuery_FINDINGPOSTBY: TOraQuery;
    QueryFindingPostBy: TOraQuery;
    QRLabel59: TQRLabel;
    QRLabel61: TQRLabel;
    QRLabel62: TQRLabel;
    QRLabel63: TQRLabel;
    ...
    QRLabel71: TQRLabel;
    QRLabel72: TQRLabel;
    lbl_reporteddate1: TQRLabel;
    QRShape23: TQRShape;
    QRShape24: TQRShape;
    QRShape25: TQRShape;
    QRShape26: TQRShape;
    signatureLLD: TQRImage;
          ...
          procedure qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
    ...
    procedure Qr_MANGALAMA4MicrobiologyBeforePrint(Sender: TCustomQuickRep;
    ...
    procedure QRSubDetail6BeforePrint(Sender: TQRCustomBand;
     ...
     public
          pi_Resistivity,pi_PSensitivity,pi_Sensitivity,
          pi_Resistivity2,pi_PSensitivity2,pi_Sensitivity2,
          pi_Resistivity3,pi_PSensitivity3,pi_Sensitivity3: integer;
          useridleft,useridcenter,useridright,useridleftcenter:String;
          { Public declarations }
          pbIsEmergency:Boolean;
     end;

var
     Form_QrDeptWiseMANGALAMA4MicrobiologyReport: TForm_QrDeptWiseMANGALAMA4MicrobiologyReport;
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.AddSignature;
...
begin
     ...
     SignatureCT.Enabled:= true;
     SignatureCD.Enabled:= true;
     SignatureLLD.Enabled:= true;

     //

     SignatureLD.Picture.Graphic := nil;
     SignatureLLD.Picture.Graphic := nil;
    ...
    if useridcenter='' then
       useridcenter:='0';

    if useridright='' then
       useridright:='0';

    if useridleftCenter='' then
        useridleftCenter:='0';
          ...
          begin
               ...
               try
                ...
                begin
                       ...
                       SignatureLD.Picture.Assign(JPG);
                end;
               finally
                     JPG.Free;
                     ms.Free;
            ...
            begin
              ...
              try
                     ...
                     begin
                       JPG.LoadFromStream(ms);
                       //SignatureCT.Picture.Assign(JPG);
                       SignatureLLD.Picture.Assign(JPG);
                     end;
              finally
                     JPG.Free;
                     ms.Free;
   ...
   begin
     ...
     {if UpperCase(lbl_DocName_RD.Caption)='DR. BANITA GURUNG' then
     begin
          SignatureRT.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_RD.Caption)='LAXMAN POKHREL' then
     begin
          SignatureRT.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_RD.Caption)='BUDHA LAXMI MAHARJAN' then
     begin
          SignatureRT.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_RD.Caption)='JIVAN PARIYAR' then
     begin
          SignatureRT.Picture.Graphic:=Image_JivanT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_JivanT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_RD.Caption)='ROJINA SHRESTHA' then
     begin
          SignatureRT.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
          SignatureRD.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
     end;


     (*Signature on Right Align end*)

     (*Signature on Center Align*)

     if UpperCase(lbl_DocName_CT.Caption)='DR. BANITA GURUNG' then
     begin
          SignatureCT.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
          SignatureCD.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_CT.Caption)='LAXMAN POKHREL' then
     begin
          SignatureCT.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
          SignatureCD.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_CT.Caption)='BUDHA LAXMI MAHARJAN' then
     begin
          SignatureCT.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
          SignatureCD.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_CT.Caption)='JIVAN PARIYAR' then
     begin
          SignatureCT.Picture.Graphic:=Image_JivanT.Picture.Graphic;
          SignatureCD.Picture.Graphic:=Image_JivanT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_CD.Caption)='ROJINA SHRESTHA' then
     begin
          SignatureCT.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
          SignatureCD.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
     end;

     (*Signature on Center Align end*)

     (*Signature on Left Align*)
     if UpperCase(lbl_Docname_LD.Caption)='DR. BANITA GURUNG' then
     begin
          SignatureLT.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=Image_BanitaT.Picture.Graphic;
     end
     else if UpperCase(lbl_Docname_LD.Caption)='LAXMAN POKHREL' then
     begin
          SignatureLT.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=Image_LaxmanT.Picture.Graphic;
     end
     else if UpperCase(lbl_Docname_LD.Caption)='BUDHA LAXMI MAHARJAN' then
     begin
          SignatureLT.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=Image_BudhaT.Picture.Graphic;
     end
     else if UpperCase(lbl_Docname_LD.Caption)='JIVAN PARIYAR' then
     begin
          SignatureLT.Picture.Graphic:=Image_JivanT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=Image_JivanT.Picture.Graphic;
     end
     else if UpperCase(lbl_DocName_LD.Caption)='ROJINA SHRESTHA' then
     begin
          SignatureLT.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
          SignatureLD.Picture.Graphic:=Image_RojinaT.Picture.Graphic;
     end; }
     (*Signature on Left Align end*)
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.CreateFindingsTable;
begin
     ...
     if FileExists(gs_temppath + '\Findings2.db') then
     begin
          with Table_Finding2 do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Findings2.db';
               DeleteTable;
          end;
     end;
     with Table_Finding2 do
     ...
     if FileExists(gs_temppath + '\Findings3.db') then
     begin
          with Table_Finding3 do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Findings3.db';
               DeleteTable;
          end;
     end;
     with Table_Finding3 do
     ...
     if FileExists(gs_temppath + '\Findings4.db') then
     begin
          with Table_Finding4 do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Findings4.db';
               DeleteTable;
          end;
     end;
     with Table_Finding4 do
     ...
     if FileExists(gs_temppath + '\Sensitivity.db') then
     begin
          with Table_Footer do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Sensitivity.db';
               DeleteTable;
          end;
     end;
     with Table_Sensitivity do
     begin
          Close;
          DatabaseName := gs_temppath;
          TableName := 'Sensitivity.db';
          ...
          FieldDefs.Add('Sensitivity', ftString, 100);
          FieldDefs.Add('PSensitivity', ftString, 100);
          FieldDefs.Add('Resistivity', ftString, 100);
          CreateTable;
     end;
     if FileExists(gs_temppath + '\Sensitivity2.db') then
     begin
          with Table_Footer do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Sensitivity2.db';
               DeleteTable;
          end;
     end;
     with Table_Sensitivity2 do
     begin
          Close;
          DatabaseName := gs_temppath;
          TableName := 'Sensitivity2.db';
     ...
     if FileExists(gs_temppath + '\Sensitivity3.db') then
     begin
          with Table_Footer do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Sensitivity3.db';
               DeleteTable;
          end;
     end;
     with Table_Sensitivity3 do
     begin
          Close;
          DatabaseName := gs_temppath;
          TableName := 'Sensitivity3.db';
     ...
     if FileExists(gs_temppath + '\Sensitivity4.db') then
     begin
          with Table_Footer do
          begin
               Close;
               DatabaseName := gs_temppath;
               TableName := 'Sensitivity4.db';
               DeleteTable;
          end;
     end;
     with Table_Sensitivity4 do
     begin
          Close;
          DatabaseName := gs_temppath;
          TableName := 'Sensitivity4.db';
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
     //Qr_NCHRCA4Microbiology.Page
...
//          QRShape1.Enabled := false;
     ...
     QRAsBarcode_Sampleno.Text:=IntToStr(gi_PatientID);  //FormatFloat('00000',StrtoInt(Copy(gs_SampleNo,9,length(gs_SampleNo))));
    ...
    // lbl_referaldoc.Caption:=GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);
     lbl_RegisteredDate.Caption := GetSampleRegesteredDate(gs_SampleNo);
     lbl_ReportedDate.Caption := GetFindingPostDate(gs_SampleNo);
     lbl_ReportedDate1.Caption := GetFindingPostDateAD(gs_SampleNo);
    // lbl_patienttype.Caption:=GetOPDWard(Gs_BillNo);
     QrLabel_billno.Caption:=Gs_BillNo;
     QRLabel63.Caption:=Gs_Address;
   //  QRLabel65.Caption:=GetHeightWeightBP(gi_patienttestid,gi_patientid,gi_testnameid);
     QRLabel68.caption:=Gs_MobileNo;
     ...
     lbl_referaldoc.Caption :=GetRefDocCode(Gs_BillNo);  }

     {if (getbednoforreportbnb(gi_patientid)<>'') and (CheckISDischarged(gi_PatientID)<>'') then
          lbl_patienttype.Caption:='IPD/'+getbednoforreportbnb(gi_patientid)
     else
          lbl_patienttype.Caption:=GetOPDWard(Gs_BillNo);}
     ...
     begin
          if LoadInvestigativeResult2(Table_Findings,Table_Finding2,Table_Finding3,Table_Finding4,Table_Sensitivity,Table_Sensitivity2,Table_Sensitivity3,Table_sensitivity4, Table_Footnote,gi_PatientID, gi_PatientTestID, true, gs_TestDate,
     ...
     begin
          ...
          begin
              if gi_compileValue in [14,21,23,24,25,26,27,28] then
                   begin
                        ...
                        begin
                            ...
                            sql.Add(' from lab_usermain l where userid in ( ');
                            ...
                            lbl_Qualification_RT.Caption := OraQuery_FooterVerifiedBy.FieldByName('designation').AsString;
                            lbl_Qualification_RD.Caption := OraQuery_FooterVerifiedBy.FieldByName('designation').AsString;
                            lbl_Specialization_RT.Caption :='';
                            lbl_Specialization_RD.Caption :='';
                            if OraQuery_FooterVerifiedBy.FieldByName('NMCNO').AsString<>'' then
                            begin
                                 lbl_Specialization_RD.Caption :='NMC No. '+ OraQuery_FooterVerifiedBy.FieldByName('NMCNO').AsString;
                                 lbl_Specialization_RT.Caption:='NMC No. '+ OraQuery_FooterVerifiedBy.FieldByName('NMCNO').AsString;
                                 lbl_DocName_RD.Caption:= 'Dr. '+lbl_DocName_RD.Caption;
                                 lbl_DocName_RT.Caption:='Dr. '+lbl_DocName_RD.Caption;
                            end;

                            if OraQuery_FooterVerifiedBy.FieldByName('NHPCNO').AsString<>'' then
                            begin
                                 lbl_Specialization_RD.Caption :='NHPC No. '+OraQuery_FooterVerifiedBy.FieldByName('NHPCNO').AsString;
                                  lbl_Specialization_RT.Caption:='NHPC No. '+OraQuery_FooterVerifiedBy.FieldByName('NHPCNO').AsString;
                            end;
                        ...
                        begin
                            ...
                            open;
                            lbl_DocName_LT.Caption:= OraQuery_FINDINGPOSTBY.FieldByName('fullname').AsString;
                            lbl_DocName_LD.Caption:= OraQuery_FINDINGPOSTBY.FieldByName('fullname').AsString;
                            lbl_Qualification_LT.Caption := OraQuery_FINDINGPOSTBY.FieldByName('designation').AsString;
                            lbl_Qualification_LD.Caption := OraQuery_FINDINGPOSTBY.FieldByName('designation').AsString;
                            lbl_Specialization_LT.Caption := '';
                            lbl_Specialization_LD.Caption := '';

                            if OraQuery_FINDINGPOSTBY.FieldByName('NMCNO').AsString<>'' then
                            begin
                                 lbl_Specialization_LT.caption:= 'NMC No. '+ OraQuery_FINDINGPOSTBY.FieldByName('NMCNO').AsString;
                                 lbl_Specialization_LD.Caption :='NMC No. '+ OraQuery_FINDINGPOSTBY.FieldByName('NMCNO').AsString;
                                 lbl_DocName_LD.Caption:='Dr. '+lbl_DocName_LD.Caption;
                                 lbl_DocName_LT.Caption:='Dr. '+lbl_DocName_LD.Caption;
                            end;

                            if OraQuery_FINDINGPOSTBY.FieldByName('NHPCNO').AsString<>'' then
                            begin
                                 lbl_Specialization_LD.Caption :='NHPC No. '+OraQuery_FINDINGPOSTBY.FieldByName('NHPCNO').AsString;
                                 lbl_Specialization_LT.caption:='NHPC No. '+OraQuery_FINDINGPOSTBY.FieldByName('NHPCNO').AsString;
                            end;
                   ...
                   QueryFindingPostBy.Free;


          end
          else if gs_ReportFooterRegulation='C' then  // checkbox wise footer
          begin
//               lbl_Qualification_LD.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Left');
//               lbl_Docname_LD.Caption :=GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Left');
//               lbl_Specialization_LD.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Left');
//               QRLabel5.Caption:=GetReportFooterName(gs_SampleNo,ps_deptype, 'Left');
//               if Trim(QRLabel5.Caption)='' then
//                    QRShape1.Enabled:=False;
//
               useridleft:=GetReportFooteruserid(gs_SampleNo,ps_deptype, 'Left');
//
//
//               lbl_Qualification_RD.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Right');
//               lbl_DocName_RD.Caption := GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Right');
//               lbl_Specialization_RD.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Right');
//               QRLabel30.Caption:=GetReportFooterName(gs_SampleNo,ps_deptype, 'Right');
//               if Trim(QRLabel30.Caption)='' then
//                    QRShape11.Enabled:=False;
               useridright:=GetReportFooteruserid(gs_SampleNo,ps_deptype, 'Right');

               useridleftcenter:=GetReportFooteruserid(gs_SampleNo,ps_deptype, 'Left1');
//
//
//               lbl_Qualification_CD.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Center');
//               lbl_DocName_CD.Caption := GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Center');
//               lbl_Specialization_CD.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Center');
//               QRLabel51.Caption :=GetReportFooterName(gs_SampleNo,ps_deptype, 'Center');
//               if Trim(QRLabel51.Caption) = '' then
//                    QRShape12.Enabled := false;
               useridcenter:=GetReportFooteruserid(gs_SampleNo,ps_deptype, 'Center');
//
//               lbl_Qualification_LT.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Left');
//               lbl_DocName_LT.Caption :=GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Left');
//               lbl_Specialization_LT.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Left');
//               QRLabel9.Caption:=GetReportFooterName(gs_SampleNo,ps_deptype, 'Left');
//               if Trim(QRLabel9.Caption)='' then
//                    QRShape5.Enabled:=False;
//
//               lbl_Qualification_RT.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Right');
//               lbl_DocName_RT.Caption :=GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Right');
//               lbl_Specialization_RT.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Right');
//               QRLabel29.Caption:=GetReportFooterName(gs_SampleNo,ps_deptype, 'Right');
//               if Trim(QRLabel29.Caption)='' then
//                    QRShape8.Enabled:=False;
//
//               lbl_Qualification_CT.Caption :=GetReportFooterStatus(gs_SampleNo,ps_deptype, 'Center');
//               lbl_Docname_CT.Caption :=GetReportFooterQualification(gs_SampleNo,ps_deptype, 'Center');
//               lbl_Specialization_CT.Caption := GetReportFooterSpecialization(gs_SampleNo,ps_deptype, 'Center');
//               QRLabel28.Caption :=GetReportFooterName(gs_SampleNo,ps_deptype, 'Center');
...
//                    QRShape2.Enabled := false;
              ...
              begin
                  ...
                  if Trim(lbl_Qualification_CT.Caption) = '' then
                        QRShape2.Enabled := false;
                  ...
                  if Trim(lbl_Qualification_LT.Caption) = '' then
                     QRShape5.Enabled := false;
                  ...
                  if Trim(lbl_Qualification_RT.Caption) = '' then
                    QRShape8.Enabled := false;
              end;
          end;

          if LoadInvestigativeResult2(Table_Findings,Table_Finding2,Table_Finding3,Table_Finding4,Table_Sensitivity,Table_Sensitivity2,Table_Sensitivity3,Table_sensitivity4, Table_Footer, gi_PatientID,gi_PatientTestID, false, gs_TestDate,
               Gs_SelectedDepList, Gs_SelectedTestNameList) then
               // UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedTestNameList, 0, gi_Printing);
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
    value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
   // QRLBL_ReportBy.Caption:= gs_UserName;
  { if gb_footerspace=True then
   begin
        Form_QrDeptWiseNCHRCA4MicrobiologyReport.PageFooterBand1.Height:=gi_footerspace;
   end;}
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_MANGALAMA4Microbiology.NewPage;
      li_testnameid:=Table_Findings.FieldByName('testnameid').AsInteger;

      if SensitiveTest(li_testnameid) then
      begin
           qrsbdtl2.Enabled:=true;
           qrsbdtl3.Enabled:= true;
           qrshp4.Enabled:= False;
           ...
           if Table_Sensitivity.RecordCount=0 then
          begin
               qrsbdtl2.Enabled:=false;
               qrsbdtl2.Height:=0;
               qrsbdtl3.Enabled:= False;
               qrsbdtl3.Height:=0;
               qrshp4.Enabled:= false;
               QRLabel35.Enabled:=true;
               QRLabel36.Enabled:= true;
      ...
      if Table_Findings.FieldByName('unit').AsString='' then
      begin
        QRLabel42.Enabled:= false;
        QRDBText3.Enabled:= false;
      end
      ...
      if (Table_Sensitivity.RecordCount<=0) and (Table_Sensitivity2.RecordCount<=0) and (Table_Sensitivity3.RecordCount<=0) and (Table_Sensitivity4.RecordCount<=0) then
      begin
           qrsbdtl2.Enabled:=False;
           qrsbdtl2.Height:=0;
           qrsbdtl3.Enabled:=False;
           ...
           QRSubDetail12.Enabled:=False;
           QRSubDetail12.Height:=0;
      end
      else if (Table_Sensitivity.RecordCount>0) and (Table_Sensitivity2.RecordCount<=0) and (Table_Sensitivity3.RecordCount<=0) and (Table_Sensitivity4.RecordCount<=0) then
      begin
           qrsbdtl2.Enabled:=True;
           qrsbdtl3.Enabled:=True;
           qrsubdetail2.Enabled:=False;
      ...
      begin
           ...
           qrsubdetail2.Enabled:=True;
           qrsubdetail3.Enabled:=True;
           QRSubDetail6.Enabled:=True;
           QRSubDetail4.Enabled:=True;
           QRSubDetail11.Enabled:=False;
           QRSubDetail11.Height:=0;
           QRSubDetail12.Enabled:=False;
           QRSubDetail12.Height:=0;
      ...
      begin
           ...
           QRSubDetail6.Enabled:=True;
           QRSubDetail4.Enabled:=True;
           QRSubDetail11.Enabled:=True;
           QRSubDetail12.Enabled:=True;
      end
      ...
      if (Table_Findings.RecordCount>0) and (Table_Finding2.RecordCount<=0)and (Table_Finding3.RecordCount<=0) and (Table_Finding4.RecordCount<=0) then
      begin
           QRSubDetail1.Enabled:=True;
           QRSubDetail8.Enabled:=False;
           QRSubDetail8.Height:=0;
           QRSubDetail9.Enabled:=False;
           QRSubDetail9.Height:=0;
           QRSubDetail10.Enabled:=False;
           QRSubDetail10.Height:=0;
      end
      else if (Table_Findings.RecordCount>0) and (Table_Finding2.RecordCount>0)and (Table_Finding3.RecordCount<=0) and (Table_Finding4.RecordCount<=0) then
      begin
           QRSubDetail1.Enabled:=True;
           QRSubDetail8.Enabled:=True;
           QRSubDetail9.Enabled:=False;
           QRSubDetail9.Height:=0;
           QRSubDetail10.Enabled:=False;
           QRSubDetail10.Height:=0;
      ...
      begin
           ...
           QRSubDetail8.Enabled:=True;
           QRSubDetail9.Enabled:=True;
           QRSubDetail10.Enabled:=True;
      end

end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
     ...
     begin
          ...
          SummaryBand1.Height:=0;
          //QRLabel43.Top:=1;
          QRSysData_PAGENO.Top:=65;
          //QRLBL_PageCap.Top:=65;
          //qrlbl_Of.Top:=65;
          lbl_totpage.Top:=65;
          //QRLBL_ReportBy.Top:=95;
          //QRLBL_ReportByCap.Top:=95;
          QRLabel51.Top:=65;
          QRLabel26.Top:=70;
          QRLabel5.Enabled:=False;
          lbl_DocName_RD.Enabled:=False;
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.Qr_MANGALAMA4MicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseMANGALAMA4MicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
