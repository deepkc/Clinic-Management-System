unit Unit_QrDeptWiseA4ReportKpl;
...
type
     TForm_QrDeptWiseBioDiagReportKpl = class(TForm)
    ...
    procedure Qr_NMCA4DeptWiseAfterPrint(Sender: TObject);
...
var
     Form_QrDeptWiseBioDiagReportKpl: TForm_QrDeptWiseBioDiagReportKpl;
...
procedure TForm_QrDeptWiseBioDiagReportKpl.AddSignature;
Var
...
procedure TForm_QrDeptWiseBioDiagReportKpl.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseBioDiagReportKpl.FormCreate(Sender: TObject);
...
procedure TForm_QrDeptWiseBioDiagReportKpl.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseBioDiagReportKpl.FormShow(Sender: TObject);
begin
     //gi_testhead:=0;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseBioDiagReportKpl.PageFooterBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLBL_ReportBy.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRDBText1Print(Sender: TObject; var Value: string);
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRLabel32Print(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail2AfterPrint(
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSysData2Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseBioDiagReportKpl.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseBioDiagReportKpl.Qr_NMCA4DeptWiseAfterPrint(
  Sender: TObject);
...
procedure TForm_QrDeptWiseBioDiagReportKpl.Qr_NMCA4DeptWiseBeforePrint(
...
procedure TForm_QrDeptWiseBioDiagReportKpl.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseBioDiagReportKpl.Table_FooterAfterScroll(DataSet: TDataSet);
begin
