unit Unit_QrDeptWiseNepalCancerReport;
...
type
     TForm_QrDeptWiseNepalCancerReport = class(TForm)
    Qr_NepalCancerDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseNepalCancerReport: TForm_QrDeptWiseNepalCancerReport;
...
procedure TForm_QrDeptWiseNepalCancerReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.ChildBand1AfterPrint(
...
procedure TForm_QrDeptWiseNepalCancerReport.ChildBand1BeforePrint(
...
procedure TForm_QrDeptWiseNepalCancerReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseNepalCancerReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseNepalCancerReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseNepalCancerReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseNepalCancerReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseNepalCancerReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseNepalCancerReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseNepalCancerReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseNepalCancerReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
