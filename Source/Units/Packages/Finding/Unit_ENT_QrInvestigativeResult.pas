unit Unit_ENT_QrInvestigativeResult;
...
type
     TForm_ENT_QrFinding = class(TForm)
    ENT_QrFinding: TQuickRep;
    ...
    QRLabel4: TQRLabel;
          ...
          procedure ENT_QrFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
    ...
    procedure ENT_QrFindingAfterPrint(Sender: TObject);
...
var
     Form_ENT_QrFinding: TForm_ENT_QrFinding;
...
procedure TForm_ENT_QrFinding.AddSignature;
begin
...
procedure TForm_ENT_QrFinding.CreateFindingsTable;
begin
...
procedure TForm_ENT_QrFinding.FormCreate(Sender: TObject);
Var
     RepComment: String;
begin
   ...
   //  QRLabel5.Caption:='';
     ...
     else if gi_compileValue in [2,5,6] then
     begin
       //img_dhulikhel.Enabled:=false;
...
procedure TForm_ENT_QrFinding.FormDestroy(Sender: TObject);
begin
     //Table_Findings.Free;
     //Table_Footer.Free;
...
procedure TForm_ENT_QrFinding.lbl_DocName_RDPrint(Sender: TObject; var Value: string);
begin
     // Value:=GetReportFooterQualification(gs_SampleNo, 'Verified by');
end;

procedure TForm_ENT_QrFinding.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
...
procedure TForm_ENT_QrFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_ENT_QrFinding.PrintBarcode;
Var
...
procedure TForm_ENT_QrFinding.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_ENT_QrFinding.QRDBText2Print(Sender: TObject; var Value: string);
begin
     (* ********************************* *)
...
procedure TForm_ENT_QrFinding.QRDBText4Print(Sender: TObject; var Value: string);
begin
     ps_flag := Value;
...
procedure TForm_ENT_QrFinding.QRDBText7Print(sender: TObject; var Value: string);
begin
     Value:=UpperCase(Value);
end;

procedure TForm_ENT_QrFinding.ENT_QrFindingAfterPrint(Sender: TObject);
begin
     //QrFinding.NewPage;
end;

procedure TForm_ENT_QrFinding.ENT_QrFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_ENT_QrFinding.QRLabel30Print(sender: TObject;
  var Value: string);
begin
    value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_ENT_QrFinding.QRLabel80Print(sender: TObject; var Value: string);
begin
QRlabel80.Caption:=gs_HospitalName;
end;

procedure TForm_ENT_QrFinding.QRLabel81Print(sender: TObject; var Value: string);
begin
QRLabel81.Caption:=gs_HospitalAddress;
end;

procedure TForm_ENT_QrFinding.QRLabel82Print(sender: TObject; var Value: string);
begin
QRLabel82.Caption:=gs_HospitalPhoneNumber;
end;

procedure TForm_ENT_QrFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_ENT_QrFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_ENT_QrFinding.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
      if Richtext_Comment.Caption='' then
     begin
          QRSubDetail2.Visible:= false;
     end
     else
     QRSubDetail2.Visible:= true;
end;

procedure TForm_ENT_QrFinding.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_ENT_QrFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_ENT_QrFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
