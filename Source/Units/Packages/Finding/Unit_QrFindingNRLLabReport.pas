unit Unit_QrFindingNRLLabReport;
...
type
     TForm_QrFindingNRLLabReport = class(TForm)
    Qr_NRLlabFinding: TQuickRep;
...
var
Form_QrFindingNRLLabReport: TForm_QrFindingNRLLabReport;
...
procedure TForm_QrFindingNRLLabReport.AddSignature;
VAR
...
procedure TForm_QrFindingNRLLabReport.ChildBand1AfterPrint(
...
procedure TForm_QrFindingNRLLabReport.ChildBand1BeforePrint(
...
procedure TForm_QrFindingNRLLabReport.CreateFindingsTable;
begin
...
procedure TForm_QrFindingNRLLabReport.FormCreate(Sender: TObject);
var
RepComment:string;
begin
    ...
    // lbl_referaldoc.Caption :=GetRefDoc(Gs_BillNo);   //GetRefHosDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);
     ...
     begin
          ...
          begin
               ...
               if gi_compileValue in [1,14,21,22,23,24,26]  then
               begin
              ...
              begin
                   if gi_compileValue in [14,21,23,24,26,27] then
                   begin
...
procedure TForm_QrFindingNRLLabReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrFindingNRLLabReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrFindingNRLLabReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrFindingNRLLabReport.lbl_reporteddate1Print(sender: TObject;
  var Value: string);
begin
//     lbl_ReportedDate1.Caption:=GetFindingPostDateTime
end;

procedure TForm_QrFindingNRLLabReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrFindingNRLLabReport.PrintBarcode;
Var
...
procedure TForm_QrFindingNRLLabReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrFindingNRLLabReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrFindingNRLLabReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrFindingNRLLabReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrFindingNRLLabReport.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrFindingNRLLabReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrFindingNRLLabReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
