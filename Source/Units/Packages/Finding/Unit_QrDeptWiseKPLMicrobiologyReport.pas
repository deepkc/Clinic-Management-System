unit Unit_QrDeptWiseKPLMicrobiologyReport;
...
type
     TForm_QrDeptWiseKPLMicrobiologyReport = class(TForm)
    Qr_KPLMicrobiology: TQuickRep;
    ...
    procedure Qr_KPLMicrobiologyBeforePrint(Sender: TCustomQuickRep;
...
var
     Form_QrDeptWiseKPLMicrobiologyReport: TForm_QrDeptWiseKPLMicrobiologyReport;
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.addressPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.AddSignature;
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.hospital_namePrint(
  sender: TObject; var Value: string);
begin
      value:=gs_HospitalName;
end;

procedure TForm_QrDeptWiseKPLMicrobiologyReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseKPLMicrobiologyReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.PageFooterBand1BeforePrint(
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseKPLMicrobiologyReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_KPLMicrobiology.NewPage;
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.Qr_KPLMicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseKPLMicrobiologyReport.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseKPLMicrobiologyReport.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseKPLMicrobiologyReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
