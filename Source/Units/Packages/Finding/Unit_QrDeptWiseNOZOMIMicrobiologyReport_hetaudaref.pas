unit Unit_QrDeptWiseNOZOMIMicrobiologyReport_hetaudaref;
...
uses
  ...
  MemDS, DBAccess, Ora, pngimage, acPNG;

type
     TForm_QrDeptWiseMicrobiologyReport_hetaudaref = class(TForm)
    Qr_HetaudaMicrobiology: TQuickRep;
    ...
    procedure Qr_HetaudaMicrobiologyBeforePrint(Sender: TCustomQuickRep;
    ...
    procedure QRSubDetail6BeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    procedure addressPrint(sender: TObject; var Value: string);
...
var
     Form_QrDeptWiseMicrobiologyReport_hetaudaref: TForm_QrDeptWiseMicrobiologyReport_hetaudaref;
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.addressPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.AddSignature;
...
begin
     ...
     SignatureCD.Picture.Graphic := nil;
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.CreateFindingsTable;
begin
     ...
     begin
          ...
          FieldDefs.Add('Range', ftString, 200);
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.FormCreate(Sender: TObject);
var
RepComment: String;
begin
     //
...
//          QRShape1.Enabled := false;
    ...
    // lbl_referaldoc.Caption := GetRefDocfrompatienttest(gs_billno);
     lbl_referaldoc.Caption:=GetRefDoctFromPatientTest(gi_PatientTestID,Gs_BillNo);
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.hospital_namePrint(
  sender: TObject; var Value: string);
begin
      value:=gs_HospitalName;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDate+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     if Value = '' then
     begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.PageFooterBand1BeforePrint(
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRLabel59Print(
  sender: TObject; var Value: string);
begin
   value:=gs_HospitalPhoneNumber;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
var
li_testnameid:integer;
begin
      if ItemsCount >60 then
      Qr_HetaudaMicrobiology.NewPage;
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail3BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail4BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if Richtext_Comment.Caption='' then
     begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSubDetail6BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    if (Table_Findings.FieldByName('Flag').AsString = 'H') or (Table_Findings.FieldByName('Flag').AsString = 'L') then
      QRDBText2.Font.Style := [fsBold]
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.QRSysData_PageNoPrint(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.Qr_HetaudaMicrobiologyBeforePrint(
...
procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.qrsbdtlSubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.SummaryBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
    QRLabel50.Caption:= gs_UserName;
end;

procedure TForm_QrDeptWiseMicrobiologyReport_hetaudaref.Table_FooterAfterScroll(DataSet: TDataSet);
begin
