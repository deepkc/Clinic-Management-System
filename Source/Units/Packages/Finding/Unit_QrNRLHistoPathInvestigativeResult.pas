unit Unit_QrNRLHistoPathInvestigativeResult;
...
type
     TForm_NRLHistoQrPathFinding = class(TForm)
    Qr_NRLlabHistorFinding: TQuickRep;
    ...
    procedure Qr_NRLlabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
...
var
     Form_NRLHistoQrPathFinding: TForm_NRLHistoQrPathFinding;
...
procedure TForm_NRLHistoQrPathFinding.AddSignature;
begin
...
procedure TForm_NRLHistoQrPathFinding.CreateFindingsTable;
begin
...
procedure TForm_NRLHistoQrPathFinding.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_NRLHistoQrPathFinding.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_NRLHistoQrPathFinding.FormCreate(Sender: TObject);
Var
     I:Integer;
...
procedure TForm_NRLHistoQrPathFinding.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_NRLHistoQrPathFinding.lbl_DocName_CDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape1.Enabled:=False;
end;

procedure TForm_NRLHistoQrPathFinding.lbl_Docname_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape5.Enabled:=False;
end;

procedure TForm_NRLHistoQrPathFinding.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape11.Enabled:=False;
end;

procedure TForm_NRLHistoQrPathFinding.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape8.Enabled:=False;
end;

procedure TForm_NRLHistoQrPathFinding.lbl_LabTechHPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_NRLHistoQrPathFinding.lbl_LabTechPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_NRLHistoQrPathFinding.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_NRLHistoQrPathFinding.OraQuery_FindingAfterScroll(DataSet: TDataSet);
var
     ms: TMemoryStream;
...
procedure TForm_NRLHistoQrPathFinding.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_NRLHistoQrPathFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //ItemsCount := 0;
...
procedure TForm_NRLHistoQrPathFinding.PrintBarcode;
Var
...
procedure TForm_NRLHistoQrPathFinding.Qr_NRLlabHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_NRLHistoQrPathFinding.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_NRLHistoQrPathFinding.QRLabel80Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalName;
end;

procedure TForm_NRLHistoQrPathFinding.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     value:=gs_HospitalAddress;
end;

procedure TForm_NRLHistoQrPathFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
    // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_NRLHistoQrPathFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_NRLHistoQrPathFinding.QRSubDetail2AfterPrint(
...
procedure TForm_NRLHistoQrPathFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_NRLHistoQrPathFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
