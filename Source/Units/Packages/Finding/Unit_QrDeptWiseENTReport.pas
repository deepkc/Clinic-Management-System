...
type
     TForm_QrDeptWiseENTReport = class(TForm)
    Qr_ENTDeptWise: TQuickRep;
...
var
     Form_QrDeptWiseENTReport: TForm_QrDeptWiseENTReport;
...
procedure TForm_QrDeptWiseENTReport.AddSignature;
begin
...
procedure TForm_QrDeptWiseENTReport.CreateFindingsTable;
begin
...
procedure TForm_QrDeptWiseENTReport.FormCreate(Sender: TObject);
begin
...
procedure TForm_QrDeptWiseENTReport.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrDeptWiseENTReport.lbl_PrintdatePrint(sender: TObject;
  var Value: string);
begin
     value:=TodaysDateVS+' '+TodaysTime;
end;

procedure TForm_QrDeptWiseENTReport.lbl_referaldocPrint(Sender: TObject; var Value: string);
begin
     {if Value = '' then
     begin
...
procedure TForm_QrDeptWiseENTReport.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrDeptWiseENTReport.PrintBarcode;
Var
...
procedure TForm_QrDeptWiseENTReport.QRDBText1Print(Sender: TObject; var Value: string);
begin
...
procedure TForm_QrDeptWiseENTReport.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrDeptWiseENTReport.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrDeptWiseENTReport.QRSubDetail3AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
...
procedure TForm_QrDeptWiseENTReport.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrDeptWiseENTReport.Table_FooterAfterScroll(DataSet: TDataSet);
begin
