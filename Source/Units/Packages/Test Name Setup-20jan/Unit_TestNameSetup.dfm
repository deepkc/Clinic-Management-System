object Form_TestNameSetup: TForm_TestNameSetup
  ...
  object Query_list: TQuery
    ...
    SQL.Strings = (
        ...
        'Select Trim(TestName)TTestName,TN.TESTNAMEID,Tn.CptCode,TN.TESTN' +
        'AMECODE,TN.DEPID,TN.TESTNAME,(Select DepName From Department whe' +
        're DepId=TN.DepID) DepName,to_number(TO_CHAR(TN.TESTPRICE,'#39'99999' +
        '9990D00'#39'))TESTPRICE'
  ...
  object QuerySampleSource: TQuery
    Constrained = True
    SQL.Strings = (
      'Select * from SAMPLESOURCE'
      'Order by SAMPLESOURCE')
    Left = 360
    Top = 312
  end
  ...
  object Query_TestNameCategory: TQuery
    DatabaseName = 'Hospital'
    Constrained = True
    SQL.Strings = (
  ...
  object Query_GetAutoTestNameCode: TQuery
    DatabaseName = 'HOSPITAL'
    SQL.Strings = (
