...
uses
  ...
  fxn,dm,
  Dialogs, Buttons, StdCtrls, CheckLst, DBCtrls, DB, DBTables;
          ...
          begin
               ...
               begin
                    ...
                    begin
                         ...
                         SQL.Add('Values(');
                         SQL.Add(IntToStr(i)+','+#39+(Arr_Test[i,0])+#39+','+#39+(Arr_Test[i,1])+#39+','+#39+(Arr_Test[i,2])+#39+','+#39+(Arr_Test[i,3])+#39);
                         SQL.Add(','+#39+(Arr_Test[i,4])+#39+','+#39+(Arr_Test[i,5])+#39+','+#39+(Arr_Test[i,6])+#39+')');
                         ExecSQL
                    end;
               end;
          end
...
begin
     Query_Dep.Close;
     Query_Dep.DatabaseName:=gs_DatabaseName;
     Query_Dep.Open;
//     Table:=TTable.Create(nil);
