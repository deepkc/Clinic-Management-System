unit Unit_QrNeuroBrtHistoPathInvestigativeResult;
...
type
     TForm_NeuroBrtHistoQrPathFinding = class(TForm)
    Qr_NeuroBrtHistorFinding: TQuickRep;
    ...
    procedure Qr_NeuroBrtHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
...
var
     Form_NeuroBrtHistoQrPathFinding: TForm_NeuroBrtHistoQrPathFinding;
...
procedure TForm_NeuroBrtHistoQrPathFinding.AddSignature;
begin
...
procedure TForm_NeuroBrtHistoQrPathFinding.CreateFindingsTable;
begin
...
procedure TForm_NeuroBrtHistoQrPathFinding.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_NeuroBrtHistoQrPathFinding.FormCreate(Sender: TObject);
Var
     I:Integer;
...
procedure TForm_NeuroBrtHistoQrPathFinding.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_NeuroBrtHistoQrPathFinding.lbl_DocName_CDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape1.Enabled:=False;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.lbl_Docname_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape5.Enabled:=False;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape11.Enabled:=False;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape8.Enabled:=False;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.lbl_LabTechHPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.lbl_LabTechPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_NeuroBrtHistoQrPathFinding.OraQuery_FindingAfterScroll(DataSet: TDataSet);
var
     ms: TMemoryStream;
...
procedure TForm_NeuroBrtHistoQrPathFinding.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //ItemsCount := 0;
...
procedure TForm_NeuroBrtHistoQrPathFinding.PrintBarcode;
Var
...
procedure TForm_NeuroBrtHistoQrPathFinding.Qr_NeuroBrtHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_NeuroBrtHistoQrPathFinding.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_NeuroBrtHistoQrPathFinding.QRLabel80Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalName;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     value:=gs_HospitalAddress;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_NeuroBrtHistoQrPathFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_NeuroBrtHistoQrPathFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
