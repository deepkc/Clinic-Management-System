...
begin
     ...
     begin
          ...
          SQL.Clear;
          SQL.Add('SELECT * FROM '+gs_Hos_DB_UserName+'.DEPARTMENT');
          //Sql.Add('Where IsPathologicalDep=''Y''');
...
begin
     ...
     begin
          ...
          begin
               ...
               begin
                    SQL.Clear;
                    SQL.Add('Update '+gs_Hos_DB_UserName+'.Department Set Extended_Report=''Y'' Where DepID=' + IntToStr(pi_Depid));
               end
               else
               begin
                    SQL.Clear;
                    SQL.Add('Update '+gs_Hos_DB_UserName+'.Department Set Extended_Report=''N'' Where DepId=' + IntToStr(pi_Depid));
               end;
               ExecSQL;
          end;
     end;
