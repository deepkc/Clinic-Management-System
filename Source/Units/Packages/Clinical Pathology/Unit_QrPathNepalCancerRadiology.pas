unit Unit_QrPathNepalCancerRadiology;
...
type
     TForm_QrNepalCancerRadiology = class(TForm)
    QrFindingNepalCancer: TQuickRep;
    ...
    procedure QrFindingNepalCancerApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
...
var
     Form_QrNepalCancerRadiology: TForm_QrNepalCancerRadiology;
...
procedure TForm_QrNepalCancerRadiology.AddSignature;
begin
...
procedure TForm_QrNepalCancerRadiology.CreateFindingsTable;
begin
...
procedure TForm_QrNepalCancerRadiology.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_QrNepalCancerRadiology.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrNepalCancerRadiology.FormCreate(Sender: TObject);
Var
...
procedure TForm_QrNepalCancerRadiology.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_QrNepalCancerRadiology.lblrefno2Print(sender: TObject;
  var Value: string);
begin
    if Value='' then
...
procedure TForm_QrNepalCancerRadiology.lbl_Docname_CDPrint(sender: TObject;
  var Value: string);
begin
     if Trim(Value)='' then
     QRShape4.Enabled:=False;
...
procedure TForm_QrNepalCancerRadiology.lbl_DocName_CTPrint(sender: TObject;
  var Value: string);
begin
     if Trim(Value)='' then
     QRShape3.Enabled:=False;
...
procedure TForm_QrNepalCancerRadiology.lbl_Docname_LDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     QRShape1.Enabled:=False;
end;

procedure TForm_QrNepalCancerRadiology.lbl_DocName_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     QRShape5.Enabled:=False;
end;

procedure TForm_QrNepalCancerRadiology.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     QRShape11.Enabled:=False;
end;

procedure TForm_QrNepalCancerRadiology.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     QRShape8.Enabled:=False;
end;

procedure TForm_QrNepalCancerRadiology.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_QrNepalCancerRadiology.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_QrNepalCancerRadiology.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     ItemsCount := 0;
end;

procedure TForm_QrNepalCancerRadiology.PageHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TForm_QrNepalCancerRadiology.PrintBarcode;
Var
...
procedure TForm_QrNepalCancerRadiology.QrFindingNepalCancerApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_QrNepalCancerRadiology.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_QrNepalCancerRadiology.QRLabel6Print(sender: TObject;
  var Value: string);
begin
     value:=gs_UserName;
end;

procedure TForm_QrNepalCancerRadiology.qrlbl3Print(sender: TObject; var Value: string);
begin
value:=UpperCase(qrlbl3.Caption)   ;
end;

procedure TForm_QrNepalCancerRadiology.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_QrNepalCancerRadiology.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_QrNepalCancerRadiology.QRSysData1Print(sender: TObject;
  var Value: string);
begin
...
procedure TForm_QrNepalCancerRadiology.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_QrNepalCancerRadiology.Table_FooterAfterScroll(DataSet: TDataSet);
begin
