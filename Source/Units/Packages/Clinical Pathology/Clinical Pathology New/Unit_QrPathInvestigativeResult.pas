...
begin
     ...
     QRLabel31.Caption:= orqryGetFindings.FieldByName('titleone').AsAnsiString;
     ms.Clear;
...
procedure TForm_QrPathFinding.QRSubDetail3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
    {if (QRSubDetail3.Expanded > 0) then
     begin
        QRShape2.Size.Height := DetailBand1.size.Height + DetailBand1.Expanded-50;
     end;}
end;
