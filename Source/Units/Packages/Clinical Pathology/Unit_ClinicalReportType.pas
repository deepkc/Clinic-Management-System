...
begin
    ...
    // RefreshQuery(Query_Listing,'');
     ...
     begin
          ...
          sql.Clear;
          sql.Add('select tena_testname as testname,tena_testnameid as testnameid from Hs_Tena_testname');
     ...
     begin
          ...
          Session:=DM_Hospital.DB;
          sql.Clear;
          sql.Add('select rt.isactive,ts.tena_testnameid as testnameid,ts.tena_testname as testname,rt.reporttype,rt.reporttypeid from '+gs_Hos_DB_UserName+'.Hs_Tena_testname ts,'+gs_DB_UserName+'.clinical_reporttype rt');
          sql.Add('where TS.Tena_TESTNAMEID=RT.TESTNAMEID');
          open;
     end;
...
begin
     ...
     begin
          ...
          Session:=DM_Hospital.DB;
          sql.Clear;
          sql.Add('select rt.isactive,ts.tena_testnameid,ts.tena_testname,rt.reporttype,rt.reporttypeid from '+gs_DB_UserName+'.hs_tena_testname ts,'+gs_DB_UserName+'.clinical_reporttype rt');
          sql.Add('where TS.tena_TESTNAMEID=RT.TESTNAMEID');
          open;
     end;
end;
