unit Unit_QrMangalamHistoPathInvestigativeResult;
...
type
     TForm_MangalamHistoQrPathFinding = class(TForm)
    Qr_MangalamHistorFinding: TQuickRep;
    ...
    QRLabel51: TQRLabel;
    lbl_DocName_RT1: TQRLabel;
    lbl_Qualification_RT2: TQRLabel;
    lbl_Specialization_RT3: TQRLabel;
    QRLabel29: TQRLabel;
    ...
    lbl_DocName_RD1: TQRLabel;
    lbl_Qualification_RD2: TQRLabel;
    lbl_Specialization_RD3: TQRLabel;
    ...
    QRLabel46: TQRLabel;
    QRLabelRefno: TQRLabel;
    QRLabelref: TQRLabel;
    QRLabel_RefNo: TQRLabel;
    QRBand1: TQRBand;
    qrdbtxtDescription: TQRDBText;
    QRLabel38: TQRLabel;
    QRLabel40: TQRLabel;
    lbl_Specialization1_RD: TQRLabel;
    lbl_Specialization1_CD: TQRLabel;
    lbl_Specialization1_LD: TQRLabel;
    lbl_Specialization1_RT: TQRLabel;
    lbl_Specialization1_CT: TQRLabel;
    lbl_Specialization1_LT: TQRLabel;
    QRRichdbText1: TQRDBRichText;
    QRRichTextFindingDetail: TQRRichText;
    QRLabel31: TQRLabel;
    QRLabel12: TQRLabel;
    OraQry_LoadPatientFootnoteinQRRichBox: TOraQuery;
    ...
    procedure Qr_MangalamHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
    ...
    procedure QRSubDetail2AfterPrint(Sender: TQRCustomBand;
      BandPrinted: Boolean);
     private
          ItemsCount,countfooter: integer;
          ps_deptype:String;
     ...
     public
          PB_ADDFOOTNOTE:BOOLEAN;{ Public declarations }
          useridleft,useridcenter,useridright, useridLeftCenter,useridrightcenter,useridleftcenter1,useridleftcenter2,useridleftcenter3: string;
    userid1,userid2,userid3,userid4,userid5,signatureactive1,signatureactive2,signatureactive3,signatureactive4,signatureactive5: string;
     end;

var
     Form_MangalamHistoQrPathFinding: TForm_MangalamHistoQrPathFinding;
...
procedure TForm_MangalamHistoQrPathFinding.CreateFindingsTable;
begin
...
procedure TForm_MangalamHistoQrPathFinding.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
//     QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_MangalamHistoQrPathFinding.DetailBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     {if (DetailBand1.Expanded > 0) then
     begin
        QRShape2.Size.Height := DetailBand1.size.Height + DetailBand1.Expanded-50;
     end; }
     if (QRRichTextFindingDetail.Lines.Text='') then     //(QRLabel31.Caption='Advise') and
     begin
          //QRLabel31.Height:=0;
          //QRLabel12.Height:=0;
          //QRRichTextFindingDetail.Height:=0;
          QRLabel31.Enabled:=False;
          QRRichTextFindingDetail.Enabled:=False;
     end
     else
     begin
          //QRLabel31.Height:=17;
          //QRLabel12.Height:=17;
          //QRRichTextFindingDetail.Height:=19;
          QRLabel31.Enabled:=true;
          QRRichTextFindingDetail.Enabled:=true;
     end;
end;

procedure TForm_MangalamHistoQrPathFinding.FormCreate(Sender: TObject);
Var
     I:Integer;
...
//          SummaryBand1.Enabled := false;
         // SummaryBand1.Enabled := False;
        //  SummaryBand1.Height:=25;
     end;
//     if gi_TestNameId =570 then
//     begin
...
//          QRShape1.Enabled := false;
     ...
     begin
      ...
      if gi_compileValue in [23,24]  then
               begin
    ...
    // QRLabel12.Caption := Gs_PatientIdCaption;
     ...
     Lbl_sampno.Caption := gs_SampleNo+' /'+FormatFloat('000000',StrtoInt(Copy(gs_SampleNo,7,length(gs_SampleNo))));
     ...
     QRLabel_RefNo.Caption:= GetRefNoFromPatientTest(gi_PatientTestID);
     ...
     begin
          ...
          SQL.Clear;
          //if IsClinicalDep(Gi_DepID) then
          ...
          sql.add('and patientid <>0');
//          SQL.Add('And Delete_Status=''N''');
          SQL.Add('Order by Sn');
          //SQL.SAVETOFILE('C:\PATIENTHISTOLOGY.TXT');
          Open;
end;
        ...
        begin
            ...
            begin
               ...
               begin
                   ...
                   SQL.Clear;
                   Session:=Dm_Hospital.Db;
                   SQL.add ('select fullname,userid,(select doct_SPECIALIZATION from hs_doct_doctor WHERE doct_DOCID=l.DOCTORID)specialization');
                   SQL.Add(',(select doct_qualification from hs_doct_doctor WHERE doct_DOCID=l.DOCTORID)qualification,(select doct_NMCNO from hs_doct_doctor where  doct_DOCID=l.DOCTORID)NMCNO');
                   SQL.Add(',signature from lab_usermain l where username in ( ');
              ...
              begin
                ...
                begin
                    ...
                    SQL.Clear;
                    Session:=Dm_Hospital.Db;
                    SQL.add ('select fullname,(select doct_SPECIALIZATION from hs_doct_doctor WHERE doct_DOCID=l.DOCTORID)specialization');
                    SQL.Add(',(select doct_qualification from hs_doct_doctor WHERE doct_DOCID=l.DOCTORID)qualification,(select doct_NMCNO from hs_doct_doctor where  doct_DOCID=l.DOCTORID)NMCNO');
                    SQL.Add(',signature from lab_usermain l where username in ( ');
...
//
//
//          //Lbl_Docname_HExtra.Caption:='';
//          //lbl_Docname_Extra.Caption:='';
//          with OraQuery_FooterVerifiedBy do
//              begin
//                  Close;
//                  SQL.Clear;
...
//                  Sql.Add(' And PRF.DepType='+QuotedStr(Gs_deptype));
...
//                    else if I=3 then
//                    begin
//                         {lbl_Docname_HExtra.Caption:= OraQuery_FooterVerifiedBy.FieldByName('DOCNAME').AsString;
//                         lbl_Docname_Extra.Caption:= OraQuery_FooterVerifiedBy.FieldByName('DOCNAME').AsString;
//                         lbl_Qualification_HExtra.Caption := OraQuery_FooterVerifiedBy.FieldByName('qualification').AsString;
//                         lbl_Qualification_Extra.Caption := OraQuery_FooterVerifiedBy.FieldByName('qualification').AsString;
//                         lbl_Specialization_HExtra.Caption :=OraQuery_FooterVerifiedBy.FieldByName('specialization').AsString;
//                         lbl_Specialization_Extra.Caption :=OraQuery_FooterVerifiedBy.FieldByName('specialization').AsString;}
//                    end;
...
//
               ...
               begin
                    useridright := GetReportUseridRight(gs_SampleNo, 'Right');
                    useridleft := GetReportUseridRight(gs_SampleNo, 'Left');
                    useridcenter :=  GetReportUseridRight(gs_SampleNo, 'Center');
...
//                    Qrshape16.Enabled:=true;
               ...
               begin
                 ...
                 { if (lbl_Docname_HExtra.Caption='') then
                  begin
                       lbl_Docname_HExtra.Enabled:=False;
                       lbl_Qualification_HExtra.Enabled:=False;
                       lbl_Specialization_HExtra.Enabled:=False;
                       QRShape12.Enabled:=False;
                  end;
                  if (lbl_Docname_Extra.Caption='') then
                  begin
                       lbl_Docname_Extra.Enabled:=False;
                       lbl_Qualification_Extra.Enabled:=False;
                       lbl_Specialization_Extra.Enabled:=False;
...
//              end;
              ...
              begin
                   ...
                   lbl_DocName_RD.Caption :='Dr.'+  GetManualFooternameRight(gs_userdepid);
                   ...
                   if lbl_Qualification_RD.Caption<>'' then
                   begin
                   ...
                   if Trim(lbl_Qualification_RD.Caption) = '' then
                        QRShape4.Enabled := false;


                  lbl_Qualification_LD.Caption := GetManualFooternameLeftQualification(gs_userdepid);
                  lbl_Docname_LD.Caption :='Dr.'+  GetManualFooternameLeft(gs_userdepid);
                  ...
                  if lbl_Qualification_LD.Caption<>'' then
                  begin
                  ...
                  if Trim(lbl_Qualification_LD.Caption) = '' then
                     QRShape1.Enabled := false;

                   lbl_Qualification_CD.Caption := GetManualFooternameCenterQualification(gs_userdepid);
                   lbl_DocName_CD.Caption :='Dr.'+ GetManualFooternameCenter(gs_userdepid);
                   ...
                   if lbl_Qualification_CD.Caption<>'' then
                   begin
                  ...
                  begin
                   ...
                   if Trim(lbl_Qualification_CD.Caption) = '' then
                        QRShape3.Enabled := false;


                  lbl_Qualification_CT.Caption :=GetManualFooternameCenterQualification(gs_userdepid);
                  lbl_Docname_CT.Caption :='Dr.'+ GetManualFooternameCenter(gs_userdepid);
                  ...
                  if lbl_Qualification_CT.Caption<>''  then
                   begin
                  ...
                  lbl_DocName_LT.Caption :='Dr.'+ GetManualFooternameLeft(gs_userdepid);
                  ...
                  if lbl_Qualification_LT.Caption<>'' then
                  begin
                  ...
                  lbl_DocName_RT.Caption := 'Dr.'+ GetManualFooternameRight(gs_userdepid);
                  ...
                  if lbl_Qualification_RT.Caption<>'' then
                   begin
                         lbl_DocName_RT.Enabled:=True;
                         lbl_Qualification_RT.Enabled:=True;
                         lbl_Specialization_RT.Enabled:=True;
                  ...
                  lbl_Qualification_RD.Caption := GetManualFooternameRightQualification(gs_userdepid);
                   ...
                   lbl_Specialization_RD.Caption :=GetManualFooternameRightSpecialization(gs_userdepid);
                   lbl_Specialization1_RD.Caption :=GetManualFooternameRightSpecialization1(gs_userdepid);
                   QRLabel5.Caption :=GetManualFooternameRightStatus(gs_userdepid);
                   if Trim(lbl_DocName_RD.Caption) = '' then
                        BEGIN
                         QRShape4.Enabled := false;
                  ...
                  lbl_Specialization_LD.Caption := GetManualFooternameLeftSpecialization(gs_userdepid);
                  lbl_Specialization1_LD.Caption := GetManualFooternameLeftSpecialization1(gs_userdepid);
                  QRLabel2.Caption := GetManualFooternameLeftStatus(gs_userdepid);
                  if Trim(lbl_Docname_LD.Caption) = '' then
                  BEGIN
                     QRShape1.Enabled := false;
                  ...
                  lbl_Specialization_CD.Caption := GetManualFooternamecenterSpecialization(gs_userdepid);
                  lbl_Specialization1_CD.Caption := GetManualFooternamecenterSpecialization1(gs_userdepid);
                  if Trim(lbl_DocName_CD.Caption) = '' then
                  BEGIN
                    QRShape3.Enabled := false;
                  END;
                  ...
                  lbl_Specialization_LT.Caption := GetManualFooternameLeftSpecialization(gs_userdepid);
                  lbl_Specialization1_LT.Caption := GetManualFooternameLeftSpecialization1(gs_userdepid);
                  //QRLabel9.Caption := GetManualFooternameLeftStatus(gs_userdepid);
                  if Trim(lbl_DocName_LT.Caption) = '' then
                  BEGIN
                     QRShape5.Enabled := false;
                 ...
                 lbl_Qualification_CT.Caption := GetManualFooternamecenterQualification(gs_userdepid);
                  ...
                  lbl_Specialization_CT.Caption := GetManualFooternamecenterSpecialization(gs_userdepid);
                  lbl_Specialization1_CT.Caption := GetManualFooternamecenterSpecialization1(gs_userdepid);
                  if Trim(lbl_DocName_CT.Caption) = '' then
                  BEGIN
                    QRShape2.Enabled := false;
                  END;
                  ...
                  lbl_Specialization_RT.Caption := GetManualFooternameRightSpecialization(gs_userdepid);
                  lbl_Specialization1_RT.Caption := GetManualFooternameRightSpecialization1(gs_userdepid);
                  //QRLabel29.Caption := GetManualFooternameRightStatus(gs_userdepid);
                  if Trim(lbl_DocName_RT.Caption) = '' then
                  BEGIN
                    QRShape12.Enabled := false;
         ...
         { With OraQry_LoadPatientFootnoteinQRRichBox do
          Begin
               ...
               if gi_PatientTestID <> null then
                    sql.Add('AND PATIENTTESTID IN '+(inttostr(gi_PatientTestID)))
               else
               begin
...
procedure TForm_MangalamHistoQrPathFinding.FormDestroy(Sender: TObject);
begin
     Table_Findings.Free;
     Table_Footer.Free;
...
procedure TForm_MangalamHistoQrPathFinding.lbl_DocName_CDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape1.Enabled:=False;
end;

procedure TForm_MangalamHistoQrPathFinding.lbl_Docname_LTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape5.Enabled:=False;
end;

procedure TForm_MangalamHistoQrPathFinding.lbl_DocName_RDPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape11.Enabled:=False;
end;

procedure TForm_MangalamHistoQrPathFinding.lbl_DocName_RTPrint(sender: TObject; var Value: string);
begin
     if Trim(Value)='' then
     //QRShape8.Enabled:=False;
end;

procedure TForm_MangalamHistoQrPathFinding.lbl_LabTechHPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_MangalamHistoQrPathFinding.lbl_LabTechPrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_UserName;
end;

procedure TForm_MangalamHistoQrPathFinding.LoadPatientClinicalData;
Var
     Qry:TOraQuery;
...
procedure TForm_MangalamHistoQrPathFinding.OraQuery_FindingAfterScroll(DataSet: TDataSet);
var
     ms: TMemoryStream;
...
begin
     ...
     //QRRichText_footnote.lines.loadfromstream(ms);
     QRRichTextFindingDetail.Lines.LoadFromStream(ms);
     ms.Free;
     //qrdbtxttITLE1.Font.Style := [fsBold];
end;

procedure TForm_MangalamHistoQrPathFinding.PageFooterBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //QRShape2.Height:=QRRichText1.Height;
end;

procedure TForm_MangalamHistoQrPathFinding.PageHeaderBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     //ItemsCount := 0;
...
procedure TForm_MangalamHistoQrPathFinding.PrintBarcode;
Var
...
procedure TForm_MangalamHistoQrPathFinding.Qr_MangalamHistorFindingApplyPrinterSettings(Sender: TObject; var Cancel: Boolean; DevMode: Pointer);
begin
     UpdateTestProgressStatus(Gs_BillNo, Gs_SelectedPatientTestID, 0, gi_Printing);
end;

procedure TForm_MangalamHistoQrPathFinding.QRLabel4Print(sender: TObject; var Value: string);
begin
...
procedure TForm_MangalamHistoQrPathFinding.QRLabel80Print(sender: TObject;
  var Value: string);
begin
    value:=gs_HospitalName;
end;

procedure TForm_MangalamHistoQrPathFinding.QRLabel81Print(sender: TObject;
  var Value: string);
begin
     value:=gs_HospitalAddress;
end;

procedure TForm_MangalamHistoQrPathFinding.QRSubDetail1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
    // if ItemsCount > 32 then
     // QrFinding.NewPage;
end;

procedure TForm_MangalamHistoQrPathFinding.QRSubDetail1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TForm_MangalamHistoQrPathFinding.QRSubDetail2AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
     if QRRichdbText1.DataSet.RecordCount > 0 then
          BandPrinted := true
     else
          BandPrinted := false;
end;

procedure TForm_MangalamHistoQrPathFinding.SubDetail_SampleSourceBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
     if gb_HideSource then
          PrintBand := false;
end;

procedure TForm_MangalamHistoQrPathFinding.Table_FooterAfterScroll(DataSet: TDataSet);
begin
