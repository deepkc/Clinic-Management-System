...
begin
     ...
     begin
          ...
          Le_TestPackageTitle.Text := FieldByName('TestPackageTitle').AsString;
          Le_TestPackageName.Text := FieldByName('TestPackageName').AsString;
...
//               CB_HideAllTestInPatientList.Checked := false;
          ...
          gi_TestNameId := FieldByName('TestPackageid').AsInteger;
          ...
          TESTPACKAGEID:=Query_list.FieldByName('testpackageid').AsInteger;
...
begin
     ...
     begin
          DeleteData(Query_list.FieldByName('TestPackageId').AsInteger,'TestPackageId','TestPackage',gs_DatabaseName);
     end;
     Query_list.Close;
     Query_list.Open;
...
begin
     ...
     begin
          ExportDBGrid(Form_TestPackageNameSetup, DBGrid1, true, 'TestName List of Package Test' ,TodaysDateVS + ' BS -' + TodaysDate + ' AD');
     end;
end;
