object Form_TestPackageNameSetup: TForm_TestPackageNameSetup
    ...
    object TabSheet1: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'TESTPACKAGENAME'
            Width = 108
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'TESTPACKAGETITLE'
  ...
  object Query_list: TOraQuery
    SQL.Strings = (
        ...
        'Select Trim(TestPackagename)TTestName,Tp.*,(TESTPRICE+VAT)TOTALP' +
        'RICE,(TESTPRICEFOREIGNER+TAXFRG)TOTALPRICEFRG from TestPackage T' +
        'p'
      'Where 99=99'
      'Order by Testpackagename'
      ''
      '')
    Left = 312
    Top = 312
