object Form_TestPackageDetail: TForm_TestPackageDetail
  ...
  object Query_TestPackageName: TOraQuery
    SQL.Strings = (
      'select * from testname where isactive='#39'Y'#39' and ispackagetest='#39'Y'#39
      'and 1=1'
      '')
    Left = 176
    Top = 273
  ...
  object Query_Blank: TOraQuery
    SQL.Strings = (
        ...
        'Select Trim(TestName)TTestName,Tn.*,(TESTPRICE+VAT)TOTALPRICE,(T' +
        'ESTPRICEFOREIGNER+TAXFRG)TOTALPRICEFRG from TestName Tn'
      'Where 99=99'
      'Order by TestName'
      ''
      '')
  ...
  object Table_TestPackage: TOraTable
    Left = 496
    Top = 352
  end
  ...
  object Query_Grid: TOraQuery
    SQL.Strings = (
      'SELECT ROWNUM AS SN , A.* FROM ('
        ...
        'Select testpackageid,(Select TestName From dhulikhel.Testname wh' +
        'ere testnameid=td.testpackageid)TestPackage,testnameid'
      
        ',(Select TestName From dhulikhel.Testname where testnameid=td.te' +
        'stnameid)TEstName'
      ',isActive'
      'from TestPackageDetail td'
      'WHERE 1=1'
      
        'order by (SELECT DISPLAYORDER FROM dhulikhel.TESTNAME WHERE TEST' +
        'NAMEID=TD.TESTNAMEID)'
      ')A')
    Left = 696
    Top = 176
  end
