          ...
          Try
               ...
               begin
                    ...
                    begin
                         ...
                         SQL.Clear;
                         SQL.Add('select Doccode,Doctor,Sum(GrossTotal)GrossTotal,Sum(Discount)Discount,Sum(subtotal)Subtotal,sum(SvrTax)SvrTax,sum(nettotal)NetTotal');
                         ...
                         Sql.Add('group by Doccode,Doctor');
     ...
     begin
          Try
               ...
               begin
                    ...
                    if pb_ToXl then
                    begin
                         SendToExcels_query(Query_Data,nil,'Referral Wise Revenue',DateEditXFrom.VSDateAsText+'-'+DateEditXTo.VSDateAsText,'',gs_HospitalName,gs_HospitalAddress,0);
                    end
                    else
                    QuickRep1.Preview;
