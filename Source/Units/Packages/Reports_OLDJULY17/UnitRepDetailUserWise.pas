...
procedure TFormRepDetailUserWise.FormCreate(Sender: TObject);
begin
...
procedure TFormRepDetailUserWise.QRExpr16Print(sender: TObject; var Value: string);
begin
     Pf_Refund:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Refund);
end;

procedure TFormRepDetailUserWise.QRExpr17Print(sender: TObject; var Value: string);
begin
     Pf_Deposit:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Deposit);
end;

procedure TFormRepDetailUserWise.QRExpr28Print(sender: TObject; var Value: string);
begin
      Value:=FormatFloat('#0,0.00',pf_Collection-Pf_Refund+Pf_Deposit-Pf_DepositRefund);
end;

procedure TFormRepDetailUserWise.QRExpr32Print(sender: TObject; var Value: string);
begin
      Pf_DepositRefund:=StrToFloat(value);
      Value:=FormatFloat('#0,0.00',Pf_DepositRefund);
end;

procedure TFormRepDetailUserWise.QRExpr3Print(sender: TObject; var Value: string);
begin
