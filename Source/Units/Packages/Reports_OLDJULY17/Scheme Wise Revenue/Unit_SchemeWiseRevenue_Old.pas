               ...
               begin
                    ...
                    begin
                         ...
                         if Rb_BillWise.Checked then
                              ...
                              SQL.Add(
                                   'Select PatientID,PatientName,PayType,BillNo,ServiceType,BillDate,Schemename,OUND (SUM (((Amount + VatAmt) * Qty)- (Amount * Qty * DisPer / 100)),2)AS AMOUNT from VW_Scheme_Wise_Revenue_Detail');
                         if Schemeid <> '' then
                              SQL.Add('Where Schemeid=' + #39 + Schemeid + #39)
                         else
                              SQL.Add('Where 99=99');
