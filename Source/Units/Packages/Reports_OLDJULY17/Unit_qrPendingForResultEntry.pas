unit Unit_qrPendingForResultEntry;
...
type
  TForm_qrPendingForResultEntry = class(TForm)
...
var
  Form_qrPendingForResultEntry: TForm_qrPendingForResultEntry;

implementation

{$R *.dfm}

procedure TForm_qrPendingForResultEntry.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrPendingForResultEntry.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
