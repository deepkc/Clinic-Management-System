unit Unit_qrPendingSampleCollectionReport;
...
type
  TForm_qrPendingSampleCollectionReport = class(TForm)
...
var
  Form_qrPendingSampleCollectionReport: TForm_qrPendingSampleCollectionReport;

implementation

{$R *.dfm}

procedure TForm_qrPendingSampleCollectionReport.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrPendingSampleCollectionReport.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
