...
type
  TForm_RepAdjustedDeposit = class(TForm)
    QuickRep_AdjustedDeposit: TQuickRep;
    ...
    procedure QuickRep_AdjustedDepositBeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
    procedure QRDBText64Print(sender: TObject; var Value: string);
    procedure QRDBText74Print(sender: TObject; var Value: string);
    procedure QuickRep_AdjustedDepositAfterPrint(Sender: TObject);
...
var
  Form_RepAdjustedDeposit: TForm_RepAdjustedDeposit;

implementation

{$R *.dfm}

procedure TForm_RepAdjustedDeposit.FormCreate(Sender: TObject);
begin
//          lbl_hosname.Caption:=gs_HospitalName;
     lbl_Address.Caption:=gs_HospitalAddress;
end;

procedure TForm_RepAdjustedDeposit.QRDBText64Print(sender: TObject;
  var Value: string);
begin
     c:=c+1;
...
procedure TForm_RepAdjustedDeposit.QRDBText74Print(sender: TObject;
  var Value: string);
begin
     d:=d+1;
...
procedure TForm_RepAdjustedDeposit.QRExpr16Print(sender: TObject; var Value: string);
begin
     Pf_Refund:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Refund);
end;

procedure TForm_RepAdjustedDeposit.QRExpr17Print(sender: TObject; var Value: string);
begin
     Pf_Deposit:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Deposit);
end;

procedure TForm_RepAdjustedDeposit.QRExpr28Print(sender: TObject; var Value: string);
begin
      Value:=FormatFloat('#0,0.00',pf_Collection-Pf_Refund+Pf_Deposit-Pf_DepositRefund);
end;

procedure TForm_RepAdjustedDeposit.QRExpr32Print(sender: TObject; var Value: string);
begin
      Pf_DepositRefund:=StrToFloat(value);
      Value:=FormatFloat('#0,0.00',Pf_DepositRefund);
end;

procedure TForm_RepAdjustedDeposit.QRExpr3Print(sender: TObject; var Value: string);
begin
     pf_Collection:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',pf_Collection);
end;

procedure TForm_RepAdjustedDeposit.QRLabel_HosNamePrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_HospitalName;
end;

procedure TForm_RepAdjustedDeposit.QuickRep_AdjustedDepositAfterPrint(Sender: TObject);
begin
     a:=0;
     b:=0;
     c:=0;
...
procedure TForm_RepAdjustedDeposit.QuickRep_AdjustedDepositBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
     a:=0;
     b:=0;
