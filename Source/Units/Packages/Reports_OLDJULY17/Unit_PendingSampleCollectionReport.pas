unit Unit_PendingSampleCollectionReport;
...
type
  TForm_PendingSampleCollectionReport = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_PendingSampleCollectionReport: TForm_PendingSampleCollectionReport;

implementation
       uses Unit_qrPendingSampleCollectionReport,UnitSendToExcel;
{$R *.dfm}

procedure TForm_PendingSampleCollectionReport.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_PendingSampleCollectionReport.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrPendingSampleCollectionReport do
     begin
          ...
          begin
               ...
               if (dblcb_department.KeyValue)<>null then
               begin
                    SQL[3]:=' and ae.depid='+#39+inttostr(dblcb_department.KeyValue)+#39;
               end
               else
                    SQL[3]:=' and 1=1';
               if (DBLCB_Test.KeyValue)<>null then
               begin
                    SQL[4]:=' and ae.TESTNAMEID='+#39+inttostr(DBLCB_Test.KeyValue)+#39;
               end
               else
                    SQL[4]:=' and 1=1';
               SQL[6]:='Where d.deptype='+#39+(ps_DepType)+#39;
...
procedure TForm_PendingSampleCollectionReport.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_PendingSampleCollectionReport.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_PendingSampleCollectionReport.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_PendingSampleCollectionReport.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_PendingSampleCollectionReport.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrPendingSampleCollectionReport,Form_qrPendingSampleCollectionReport);
end;

procedure TForm_PendingSampleCollectionReport.FormDestroy(Sender: TObject);
begin
     Form_qrPendingSampleCollectionReport.Free;
end;

procedure TForm_PendingSampleCollectionReport.FormKeyDown(Sender: TObject;
...
procedure TForm_PendingSampleCollectionReport.FormShow(Sender: TObject);
begin
...
procedure TForm_PendingSampleCollectionReport.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_PendingSampleCollectionReport.SpeedButton2Click(
  Sender: TObject);
begin
