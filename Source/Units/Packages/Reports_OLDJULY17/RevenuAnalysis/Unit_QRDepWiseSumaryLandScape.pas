unit Unit_QRDepWiseSumaryLandScape;
...
type
  TForm_QRDepWiseSumaryLandScape = class(TForm)
    QuickRep1: TQuickRep;
...
var
  Form_QRDepWiseSumaryLandScape: TForm_QRDepWiseSumaryLandScape;

implementation

{$R *.DFM}

procedure TForm_QRDepWiseSumaryLandScape.QRLabel8Print(sender: TObject;
  var Value: String);
begin
     ...
     Begin
          ...
          QRLabel_SvrTaxCap.Left:=683;
          QRLabel_RefundTaxCap.Caption:='RF VAT';
     End
     Else
     Begin
          QRLabel_SvrTaxCap.Caption:='SVR Tax';
          QRLabel_SvrTaxCap.Left:=673;
          QRLabel_RefundTaxCap.Caption:='RF SVR Tax';
     End;
end;

procedure TForm_QRDepWiseSumaryLandScape.QRLabel_HosSloganTitlePrint(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRDepWiseSumaryLandScape.QRLabel_HosAddressPrint(sender: TObject;
  var Value: String);
begin
   Value:=gs_HospitalAddress;
end;

procedure TForm_QRDepWiseSumaryLandScape.QRLabel16Print(sender: TObject;
  var Value: String);
begin
   Value:=gs_HospitalPhoneNumber;
end;

procedure TForm_QRDepWiseSumaryLandScape.Query_RevenueCollectionAfterScroll(
  DataSet: TDataSet);
begin
   Inc(pi_Sno);
end;

procedure TForm_QRDepWiseSumaryLandScape.Query_RevenueCollectionBeforeScroll(
  DataSet: TDataSet);
begin
   QRLabelSno.Caption:=IntToStr(pi_Sno);
end;

procedure TForm_QRDepWiseSumaryLandScape.QuickRep1EndPage(
  Sender: TCustomQuickRep);
begin
//   pi_Sno:=1;
end;

procedure TForm_QRDepWiseSumaryLandScape.QuickRep1BeforePrint(
...
procedure TForm_QRDepWiseSumaryLandScape.FormShow(Sender: TObject);
begin
     if gs_TaxSystem='VAT' then
     Begin
          QRLabel_SvrTaxCap.Caption:='VAT';
...
procedure TForm_QRDepWiseSumaryLandScape.QRExpr23Print(
...
procedure TForm_QRDepWiseSumaryLandScape.QRExpr24Print(
  sender: TObject; var Value: String);
begin
...
procedure TForm_QRDepWiseSumaryLandScape.QRExpr27Print(sender: TObject; var Value: string);
begin
     pf_CommunityRefund:=StrToFloat(Value);
     Value:=FormatFloat('#,##0.00',pf_CommunityRefund);
end;

procedure TForm_QRDepWiseSumaryLandScape.QRExpr31Print(
  sender: TObject; var Value: String);
begin
...
procedure TForm_QRDepWiseSumaryLandScape.QRExpr33Print(
  sender: TObject; var Value: String);
begin
