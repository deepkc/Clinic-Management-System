...
type
  TForm_QRTestBillWise = class(TForm)
    QR_TestBillWise: TQuickRep;
    QRGroupTop: TQRGroup;
    QRLabel6: TQRLabel;
    ...
    procedure QR_TestBillWiseBeforePrint(Sender: TCustomQuickRep;
  ...
  public
    { Public declarations }
       ...
       Procedure HideMinButtonOnReport;

  end;

var
  Form_QRTestBillWise: TForm_QRTestBillWise;
...
procedure TForm_QRTestBillWise.QRLabel16Print(sender: TObject;
  var Value: String);
begin
   Value:=gs_HospitalName;
end;

procedure TForm_QRTestBillWise.QRLabel17Print(sender: TObject;
  var Value: String);
begin
   Value:=gs_HosSloganTitle;
end;

procedure TForm_QRTestBillWise.QRLabel18Print(sender: TObject;
  var Value: String);
begin
   Value:=gs_HospitalAddress;
end;

procedure TForm_QRTestBillWise.QRLabel19Print(sender: TObject;
  var Value: String);
begin
   Value:=gs_HospitalPhoneNumber;
end;

procedure TForm_QRTestBillWise.QR_TestBillWiseBeforePrint(
...
procedure TForm_QRTestBillWise.QRDBText10Print(sender: TObject;
  var Value: String);
begin
     BillType:=Value;
end;

procedure TForm_QRTestBillWise.QRExpr11Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr5Print(sender: TObject;
  var Value: String);
begin
     If (BillType='CASH') OR (BillType='CREDIT') then
...
procedure TForm_QRTestBillWise.QRExpr7Print(sender: TObject;
  var Value: String);
begin
     If (BillType='CASH') OR (BillType='CREDIT') then
...
procedure TForm_QRTestBillWise.QRExpr13Print(sender: TObject;
  var Value: String);
begin
     If (BillType='CASH') OR (BillType='CREDIT') then
...
procedure TForm_QRTestBillWise.QRExpr2Print(sender: TObject;
  var Value: String);
begin
     If (BillType='CASH') OR (BillType='CREDIT') then
...
procedure TForm_QRTestBillWise.QRExpr17Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr15Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr16Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr18Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr8Print(sender: TObject;
  var Value: String);
begin
...
procedure TForm_QRTestBillWise.QRExpr12Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',pf_Netamount);
end;

procedure TForm_QRTestBillWise.QRExpr6Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',pf_NetDiscount);
end;

procedure TForm_QRTestBillWise.QRExpr10Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',pf_NetSubTotal);
end;

procedure TForm_QRTestBillWise.QRExpr14Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',pf_NetSvrTax);
end;

procedure TForm_QRTestBillWise.QRExpr3Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',pf_NetTotal);
end;

procedure TForm_QRTestBillWise.QRDBText1Print(sender: TObject;
  var Value: String);
begin
     Curr_Dept:=Value;
...
Procedure TForm_QRTestBillWise.HideMinButtonOnReport;
  var
    i: Integer;
begin
...
procedure TForm_QRTestBillWise.QueryDetailAfterScroll(DataSet: TDataSet);
begin
