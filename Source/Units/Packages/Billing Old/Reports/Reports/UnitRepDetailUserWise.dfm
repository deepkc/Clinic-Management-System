object FormRepDetailUserWise: TFormRepDetailUserWise
  Left = 0
  Top = 0
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCollection.AMOUNT)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCollection.NETAMOUNT)'
        Mask = '0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCollection.VATAMT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCollection.DISCOUNT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRBand4: TQRBand
      ...
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryRefund.NETAMOUNT)'
        Mask = '0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryRefund.VATAMT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr12: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryRefund.DISCOUNT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr14: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QueryRefund.AMOUNT)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRSubDetailIPCollection: TQRSubDetail
      Left = 48
      Top = 401
      Width = 960
      Height = 20
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel_HosPhone: TQRLabel
        Left = 416
        Top = 31
        Width = 127
        Height = 15
    ...
    object QRBand5: TQRBand
      ...
      object QRExpr17: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QueryDeposit.CR)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRBand3: TQRBand
      ...
      object QRExpr32: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QueryAdvanceRefund.DR)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
    ...
    object QRBand6: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCredit.AMOUNT)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCredit.NETAMOUNT)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCredit.VATAMT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr13: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryCredit.DISCOUNT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object QueryCreditRefund: TQuery
    DatabaseName = 'Hospital'
    SQL.Strings = (
  ...
  object QueryDeposit: TQuery
    DatabaseName = 'Hospital'
    SQL.Strings = (
      
        'Select PatientId,PatientName,Sum(CRAmount)as CR,BillDAte,BillTim' +
        'e,BillNo'
  ...
  object QueryIPCashCollection: TQuery
  ...
  object QueryAdvanceRefund: TQuery
    DatabaseName = 'Hospital'
    SQL.Strings = (
      
        'Select PatientId,Sum(DRAmount) as Dr,BillDate as ModifyDate,Bill' +
        'Time as ModifyTime,BillNo'
      
        'From VW_User_Wise_Coll_Detail Where((BillDAte>=:FromDate) AND(Bi' +
        'llDate<=:ToDate)) and DrAmount > 0'
      'And(BillBy=:UserId) '
  ...
  object QueryCollectionNew: TQuery
    SQL.Strings = (
