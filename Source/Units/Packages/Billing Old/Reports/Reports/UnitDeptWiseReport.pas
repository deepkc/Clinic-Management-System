          ...
          begin
               ...
               begin
                    ...
                    begin
                         ...
                         Sql.Clear;
                         Sql.Add(' select DepName, Round(Sum(Total),3) as CashAmt, Nvl(Round(Sum(CreditTotal),3),0) as CreditAmt,');
                         Sql.Add(' NVL(Round(Sum(Discount),3),0) as FreeConAmt,NVL(Round(Sum(RfFreeCon),3),0)as RefFreeCon, NVl(Round(Sum(NetREfAMt),3),0) as NetRefAMt');
                    ...
                    begin
                         ...
                         Sql.Add('where depositDate>='#39 + DateEditxFrom.text + #39 +'and depositDate<='#39 + DateEditXTo.text + #39);
                         open;
                    end;
