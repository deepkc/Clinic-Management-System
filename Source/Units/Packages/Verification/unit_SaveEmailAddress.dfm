object Form_SaveEmailAddress: TForm_SaveEmailAddress
  Left = 0
  Top = 0
  Caption = 'SaveEmailAddress'
  ClientHeight = 271
  ClientWidth = 288
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object BBtnBB_Save: TBitBtn
      ...
      TabOrder = 1
      OnClick = BBtnBB_SaveClick
    end
    object BBtnBB_New: TBitBtn
      Left = 102
      Top = 0
      Width = 63
      Height = 30
      ...
      ParentDoubleBuffered = False
      TabOrder = 2
      OnClick = BBtnBB_NewClick
    end
    object BBtnBB_Close: TBitBtn
      Left = 226
      Top = 0
      Width = 63
      Height = 30
