...
uses
  ...
  DBTables, QRPDFFilt, DBCtrls,Unit_QrFindingPatanLabReport,Unit_QrDeptWisePATANLABA4MicrobiologyReport,Unit_QrPatanHistoPathInvestigativeResult;
...
type
    ...
    OraQuery_emailname: TOraQuery;
    datasource2: TDataSource;
    dblcb_emailname: TDBLookupComboBox;
    CB_emailname: TCheckBox;
    ...
    procedure dblcb_emailnameClick(Sender: TObject);
    procedure CB_emailnameClick(Sender: TObject);
...
uses Unit_Verification,Unit_QrFindingGMCLabReport_kpl,Unit_QrDeptWiseGMCLABA4MicrobiologyReport_kpl,Unit_QrDeptWiseNRLLABA4MicrobiologyReport,Unit_QrDeptWiseGMCLABA4MicrobiologyReport,Unit_QrFindingNRLLabReport,Unit_QrFindingGMCLabReport,Unit_QrNRLHistoPathInvestigativeResult,Unit_QrGMCHistoPathInvestigativeResult,Unit_QrPathInvestigativeResult,Unit_QrDeptWiseNMCA4Report,Unit_QrDeptWiseNepalCancerReport,Unit_QrDeptWiseA4Reportkpl,Unit_QrFindingIntrepidReport,Unit_QrDeptWiseNCHRCA4MicrobiologyReport,Unit_QrDeptWiseINTREPIDA4MicrobiologyReport,Unit_QrDeptWiseMANGALAMA4MicrobiologyReport,Unit_QrFindingMangalamReport,Unit_QrMangalamHistoPathInvestigativeResult;
...
procedure TForm_Broadcastpopup.CB_emailnameClick(Sender: TObject);
begin
   if cb_emailname.Checked then
   begin
         dblcb_emailname.Enabled:=false;
         le_email.text:='';
         dblcb_emailname.KeyValue:=0;
   end
   else
   begin
         dblcb_emailname.Enabled:=true;
         le_email.text:='';
...
procedure TForm_Broadcastpopup.dblcb_emailnameClick(Sender: TObject);
begin
    le_email.Text:=dblcb_emailname.Text;
end;
    ...
    // Le_Mobileno.EditLabel.Caption:=Gs_MobileNo;
     ...
     cb_email.Checked := true;
      ...
      begin
          CB_LetterHead.Enabled:=True;
          CB_LetterHead.Visible:=true;
         CB_emailname.Visible:=True;
         dblcb_emailname.Visible:=True;
         cb_emailname.checked:=true;
         dblcb_emailname.Enabled:=False;

         dblcb_emailname.Visible:=True;
         with OraQuery_emailname do
         begin
           Close;
          Session:=Dm_Hospital.Db;
          SQL.Clear;
          sql.Add('select * from saveemailaddress');
          Open;
         end;
...
begin
     ...
     gb_QRHeadFoot:=True;
     gs_EmailBodymessage:=Memo_Message.text;
    ...
    { if gi_compileValue=3 then
     ...
     else if gi_compileValue=22 then  //BIODIAG
     begin
          if Gi_DepID=2 then
          begin
               Try
                    Form_QrDeptWiseNCHRCA4MicrobiologyReport := TForm_QrDeptWiseNCHRCA4MicrobiologyReport.Create(nil);
                    with Form_QrDeptWiseNCHRCA4MicrobiologyReport do
                    begin
                         //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                         Qr_NCHRCA4Microbiology.Prepare;
                         lbl_totpage.Caption := IntToStr(Qr_NCHRCA4Microbiology.QRPrinter.PageCount);
                         lbl_totpageh.Caption := IntToStr(Qr_NCHRCA4Microbiology.QRPrinter.PageCount);
                        ...
                        SaveQrAsPdf(Form_QrDeptWiseNCHRCA4MicrobiologyReport.Qr_NCHRCA4Microbiology, gs_temppath + '\InvRep');
                        SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                        DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                        ShowDoneMessage;
          ...
          begin
               try
                    ...
                    begin
                        ...
                        SaveQrAsPdf(Form_QrDeptWiseBioDiagReportKpl.Qr_NMCA4DeptWise, gs_temppath + '\InvRep');
                        SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                        DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                        ShowDoneMessage;
     ...
     begin
          ...
          begin
               ...
               begin
                    Try
                         ...
                         with Form_QrDeptWiseMANGALAMA4MicrobiologyReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_MANGALAMA4Microbiology.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_MANGALAMA4Microbiology.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_MANGALAMA4Microbiology.QRPrinter.PageCount);

                              if CB_LetterHead.Checked=True then
                              begin
                                   QRImage_TopNepalCancer.Enabled:=True;
                              end
                              else
                              begin
                                   QRImage_TopNepalCancer.Enabled:=false;
                              end;

                              //****** GS_TEMPPATH\INVREP SO **DO NOT CHANGE THIS FOLDER**

                             SaveQrAsPdf(Form_QrDeptWiseMANGALAMA4MicrobiologyReport.Qr_MANGALAMA4Microbiology, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
               ...
               begin
                    try
                         Form_QrFindingMangalamReport := TForm_QrFindingMangalamReport.Create(nil);
                         with Form_QrFindingMangalamReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_MangalamFinding.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_MangalamFinding.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_MangalamFinding.QRPrinter.PageCount);
                             ...
                             SaveQrAsPdf(Form_QrFindingMangalamReport.Qr_MangalamFinding, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
          ...
          begin
               ...
               Try
                    ...
                    with Form_MangalamHistoQrPathFinding do
                    begin
                         //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                         Qr_MangalamHistorFinding.Prepare;
                         lbl_totpage.Caption := IntToStr(Qr_MangalamHistorFinding.QRPrinter.PageCount);
                         lbl_totpageh.Caption := IntToStr(Qr_MangalamHistorFinding.QRPrinter.PageCount);

                         if CB_LetterHead.Checked=True then
                         begin
                              //QRImage_TopMangalam.Enabled:=True;
                         end
                         else
                         begin
                              //QRImage_TopMangalam.Enabled:=false;
                         end;

                         //****** GS_TEMPPATH\INVREP SO **DO NOT CHANGE THIS FOLDER**

                        SaveQrAsPdf(Form_MangalamHistoQrPathFinding.Qr_MangalamHistorFinding, gs_temppath + '\InvRep');
                        SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                        DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                        ShowDoneMessage;
     ...
     else if (gi_compileValue=24)  and (gb_isppl = True)then  //PPL
       begin
            // depid:= Form_Verification.Table_List.FieldByName('DepID').AsInteger;
            if Not IsClinicalDep(Gi_DepID) then
            begin
                 ...
                 begin
                      Try
                           ...
                           with Form_QrDeptWisepatanA4MicrobiologyReport do
                           begin
                                //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                                Qr_patanlabA4Microbiology.Prepare;
                                lbl_totpage.Caption := IntToStr(Qr_patanlabA4Microbiology.QRPrinter.PageCount);
                                lbl_totpageh.Caption := IntToStr(Qr_patanlabA4Microbiology.QRPrinter.PageCount);

                                if CB_LetterHead.Checked=True then
                                begin
                                      QRImage_Patan.Enabled:=true;
                                      QRImage_Patan.Top:=45;
                               ...
                               SaveQrAsPdf(Form_QrDeptWisepatanA4MicrobiologyReport.Qr_patanlabA4Microbiology, gs_temppath + '\InvRep');
                               SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                               DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                               ShowDoneMessage;
                 ...
                 begin
                      try
                           ...
                           with Form_QrFindingPatanLabReport do
                           begin
                                //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                                Qr_patanlabFinding.Prepare;
                                lbl_totpage.Caption := IntToStr(Qr_patanlabFinding.QRPrinter.PageCount);
                                lbl_totpageh.Caption := IntToStr(Qr_patanlabFinding.QRPrinter.PageCount);
                               ...
                               SaveQrAsPdf(Form_QrFindingPatanLabReport.Qr_patanlabFinding, gs_temppath + '\InvRep');
                               SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                               DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                               ShowDoneMessage;
            ...
            begin
                 ...
                 Try
                      ...
                      with Form_patanHistoQrPathFinding do
                      begin
                           //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                           Qr_patanlabHistorFinding.Prepare;
                           lbl_totpage.Caption := IntToStr(Qr_patanlabHistorFinding.QRPrinter.PageCount);
                           lbl_totpageh.Caption := IntToStr(Qr_patanlabHistorFinding.QRPrinter.PageCount);
                          ...
                          SaveQrAsPdf(Form_patanHistoQrPathFinding.Qr_patanlabHistorFinding, gs_temppath + '\InvRep');
                          SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                          DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                          ShowDoneMessage;
    ...
    else if (gi_compileValue=24) and (gb_isppl = False) then  //NARAYANI REFERENCE LABORATORY
     begin
          // depid:= Form_Verification.Table_List.FieldByName('DepID').AsInteger;
          if Not IsClinicalDep(Gi_DepID) then
            begin
               ...
               begin
                    Try
                         ...
                         with Form_QrDeptWiseNRLA4MicrobiologyReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_NRLlabA4Microbiology.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_NRLlabA4Microbiology.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_NRLlabA4Microbiology.QRPrinter.PageCount);
    ...
    //                                          QRImage_Patan.Top:=45;
                             ...
                             SaveQrAsPdf(Form_QrDeptWiseNRLA4MicrobiologyReport.Qr_NRLlabA4Microbiology, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
               ...
               begin
                    try
                         ...
                         with Form_QrFindingNRLLabReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_NRLlabFinding.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_NRLlabFinding.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_NRLlabFinding.QRPrinter.PageCount);
                             ...
                             SaveQrAsPdf(Form_QrFindingNRLLabReport.Qr_NRLlabFinding, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
          ...
          begin
               ...
               Try
                    ...
                    with Form_NRLHistoQrPathFinding do
                    begin
                         //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                         Qr_NRLlabHistorFinding.Prepare;
                         lbl_totpage.Caption := IntToStr(Qr_NRLlabHistorFinding.QRPrinter.PageCount);
                         lbl_totpageh.Caption := IntToStr(Qr_NRLlabHistorFinding.QRPrinter.PageCount);
                        ...
                        SaveQrAsPdf(Form_nrlHistoQrPathFinding.Qr_nrllabHistorFinding, gs_temppath + '\InvRep');
                        SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                        DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                        ShowDoneMessage;
      ...
      else if (gi_compileValue=25) then  //Green Medical Center
     begin
          // depid:= Form_Verification.Table_List.FieldByName('DepID').AsInteger;
          if Not IsClinicalDep(Gi_DepID) then
            begin
               ...
               begin
                    Try
                         ...
                         with Form_QrDeptWiseGMCA4MicrobiologyReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_GMClabA4Microbiology.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_GMClabA4Microbiology.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_GMClabA4Microbiology.QRPrinter.PageCount);
    ...
    //                                          QRImage_Patan.Top:=45;
                             ...
                             SaveQrAsPdf(Form_QrDeptWiseGMCA4MicrobiologyReport.Qr_GMClabA4Microbiology, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
               ...
               begin
                    try
                         ...
                         with Form_QrFindingGMCLabReport do
                         begin
                              //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                              Qr_GMClabFinding.Prepare;
                              lbl_totpage.Caption := IntToStr(Qr_GMClabFinding.QRPrinter.PageCount);
                              lbl_totpageh.Caption := IntToStr(Qr_GMClabFinding.QRPrinter.PageCount);
                             ...
                             SaveQrAsPdf(Form_QrFindingGMCLabReport.Qr_GMClabFinding, gs_temppath + '\InvRep');
                             SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                             DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                             ShowDoneMessage;
          ...
          begin
               ...
               Try
                    ...
                    with Form_GMCHistoQrPathFinding do
                    begin
                         //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                         Qr_GMClabHistorFinding.Prepare;
                         lbl_totpage.Caption := IntToStr(Qr_GMClabHistorFinding.QRPrinter.PageCount);
                         lbl_totpageh.Caption := IntToStr(Qr_GMClabHistorFinding.QRPrinter.PageCount);
                        ...
                        SaveQrAsPdf(Form_GMCHistoQrPathFinding.Qr_GMClabHistorFinding, gs_temppath + '\InvRep');
                        SendMailInvResultAsPdf(gi_PatientID, Gs_BillNo);
                        DeleteFile(gs_temppath + '\InvRep\' +gs_patientNameForemail+'-'+ IntToStr(gi_PatientID) + '-' + FormatDateTime('yyyymmdd', date) + '.pdf');
                        ShowDoneMessage;
     ...
     begin
          ...
          begin
               try
                    ...
                    with Form_QrDeptWiseINTREPIDA4MicrobiologyReport do
               begin
                    //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                    Qr_INTREPIDA4Microbiology.Prepare;
                    lbl_totpage.Caption := IntToStr(Qr_INTREPIDA4Microbiology.QRPrinter.PageCount);
                    lbl_totpageh.Caption := IntToStr(Qr_INTREPIDA4Microbiology.QRPrinter.PageCount);
                    ...
                    SaveQrAsBmp(Form_QrDeptWiseINTREPIDA4MicrobiologyReport.Qr_INTREPIDA4Microbiology, gs_temppath + '\InvRep');
                    for i := 1 to Qr_INTREPIDA4Microbiology.QRPrinter.PageCount do
                    begin
                         BmpImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.bmp';
                         JpgImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.jpg';
                         BMPtoJPG(BmpImage, JpgImage);
     ...
     else if gi_compileValue=27 then           //KPL
     begin
          ...
          begin
               try
                    ...
                    with Form_QrDeptWiseGMCA4MicrobiologyReport_kpl do
               begin
                    //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                    Qr_GMClabA4Microbiology.Prepare;
                    lbl_totpage.Caption := IntToStr(Qr_GMClabA4Microbiology.QRPrinter.PageCount);
                    ...
                    SaveQrAsBmp(Form_QrDeptWiseGMCA4MicrobiologyReport_kpl.Qr_GMClabA4Microbiology, gs_temppath + '\InvRep');
                    for i := 1 to Qr_GMClabA4Microbiology.QRPrinter.PageCount do
                    begin
                         BmpImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.bmp';
                         JpgImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.jpg';
                         BMPtoJPG(BmpImage, JpgImage);
          ...
          begin
               ...
               with Form_QrFindingGMCLabReport_kpl do
               begin
                    //lbl_verifiedby.Caption := Form_Verification.Query_SampleCollected.FieldByName('CollectedBy').AsString;
                    Qr_GMClabFinding.Prepare;
                    lbl_totpage.Caption := IntToStr(Qr_GMClabFinding.QRPrinter.PageCount);
                    ...
                    SaveQrAsBmp(Form_QrFindingGMCLabReport_kpl.Qr_GMClabFinding, gs_temppath + '\InvRep');
                    for i := 1 to Qr_GMClabFinding.QRPrinter.PageCount do
                    begin
                         BmpImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.bmp';
                         JpgImage := gs_temppath + '\InvRep\' + IntToStr(gi_PatientID) + '-' + IntToStr(i) + '.jpg';
                         BMPtoJPG(BmpImage, JpgImage);
