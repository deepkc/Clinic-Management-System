...
Uses
  ...
  StdCtrls, Grids, DBGrids,QuickRpt,Qrctrls,DateEditXControl_TLB, Db,ComObj,ExtCtrls,DBTables, DBAccess, Ora, OraSmart, MemDS, OraError;
...
Procedure CreateQuery;
begin
     QueryTemp:=TOraQuery.Create(nil);
     QueryTemp.Session:=DM_Hospital.DB;
...
Function TodaysDate:String;Stdcall;
Var Qry_Date : TOraQuery;
Begin
     Qry_Date := TOraQuery.Create(nil);
     With Qry_Date Do
     Begin
          Close;
          //Session:=Dm_Hospital.Db;
