object Form_DoctorIncomeCorrect: TForm_DoctorIncomeCorrect
  Left = 312
  Top = 174
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Doctor Income Correction'
  ClientHeight = 511
  ClientWidth = 751
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object DateEditXPaymentDate: TDateEditX
      Left = 114
      Top = 12
      Width = 93
      Height = 21
      TabOrder = 0
      ControlData = {
        545046300A5444617465456469745200044C656674027203546F70020C057769
    ...
    object DBLCB_DeservedDoctor: TDBLookupComboBox
      Left = 113
      Top = 344
      Width = 347
      Height = 21
      ...
      ParentFont = False
      TabOrder = 4
      OnKeyPress = DBLCB_DeservedDoctorKeyPress
    end
    ...
    object Edit_PatientId: TEdit
      ...
      ParentFont = False
      TabOrder = 2
      OnExit = Edit_PatientIdExit
      OnKeyPress = Edit_PatientIdKeyPress
    end
  end
  object Query_PrevDoctor: TOraQuery
    SQL.Strings = (
  ...
  object QueryDoctorBill: TOraQuery
    SQL.Strings = (
      
        'Select bide_BillNo billno,bide_BillDate billdate,bide_PatientId ' +
        'patientid,bide_PayType paytype,bide_BillType billtype,bide_docco' +
        'de doccode,'
      
        'Sum((bide_Qty*bide_Amount)+bide_VatAmt-(bide_Qty*bide_Amount*bid' +
        'e_Disper/100)) as TotalAmt From hs_bide_BIllDetail'
      'where bide_BillNo In (Select bide_BillNo From hs_bide_BillDetail'
      
        'where bide_DocId=:DocCode) Group By bide_BillNo,bide_BillDate,bi' +
        'de_PatientId,bide_PayType,bide_BillType,bide_doccode'
      'Order By bide_BillDate Desc ,bide_BillNo Desc')
    Left = 376
    Top = 5
    ParamData = <
      item
  ...
  object DSDoctorBill: TDataSource
    DataSet = QueryDoctorBill
    Left = 317
    Top = 4
  end
  object Query_Department: TOraQuery
    SQL.Strings = (
      'Select * From Department where  IsClinicalDep='#39'Y'#39
      'Order By DepName ')
    Left = 504
    Top = 325
  end
  ...
  object Query_ActualDept: TOraQuery
    SQL.Strings = (
      'Select * From Department where  IsClinicalDep='#39'Y'#39
      'Order By DepName ')
    Left = 647
  ...
  object DS_ActualDept: TDataSource
    DataSet = Query_ActualDept
    Left = 654
    Top = 403
  end
