object Form_MasterSetup: TForm_MasterSetup
  Left = 0
  Top = 0
  ...
  object PageControl_MasterSetup: TPageControl
    Left = 8
    Top = 47
    Width = 583
    Height = 333
    ...
    TabOrder = 1
    OnChange = PageControl_MasterSetupChange
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'NAME'
            Title.Caption = 'Setup Name'
            Width = 180
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'MASE_MASTERSETUPTYPE'
            Title.Caption = 'Setup Type'
            Width = 180
            Visible = True
          end>
      end
    ...
    object TabSheet_New: TTabSheet
      ...
      object Panel_New: TPanel
        ...
        object Edit_MasterSetupName: TEdit
          Left = 211
          Top = 69
          Width = 201
          Height = 21
        ...
        object ComboBox_SetupType: TComboBox
          Left = 210
          Top = 117
          Width = 201
          Height = 21
  ...
  object OraQuery_name: TOraQuery
    SQL.Strings = (
  ...
  object OraDataSource_name: TOraDataSource
    DataSet = OraQuery_name
    Left = 248
    Top = 232
  end
