unit Unit_FindingCompletedReport;
...
type
  TForm_FindingCompletedReport = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_FindingCompletedReport: TForm_FindingCompletedReport;

implementation
       uses Unit_qrFindingCompletedReport,UnitSendToExcel;
{$R *.dfm}

procedure TForm_FindingCompletedReport.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_FindingCompletedReport.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrFindingCompletedReport do
     begin
...
procedure TForm_FindingCompletedReport.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_FindingCompletedReport.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_FindingCompletedReport.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_FindingCompletedReport.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_FindingCompletedReport.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrfindingCompletedReport,Form_qrfindingCompletedReport);
end;

procedure TForm_FindingCompletedReport.FormDestroy(Sender: TObject);
begin
     Form_qrfindingCompletedReport.Free;
end;

procedure TForm_FindingCompletedReport.FormKeyDown(Sender: TObject;
...
procedure TForm_FindingCompletedReport.FormShow(Sender: TObject);
begin
...
procedure TForm_FindingCompletedReport.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_FindingCompletedReport.SpeedButton2Click(
  Sender: TObject);
begin
