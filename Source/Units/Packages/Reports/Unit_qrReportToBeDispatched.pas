unit Unit_qrReportToBeDispatched;
...
type
  TForm_qrReportToBeDispatched = class(TForm)
...
var
  Form_qrReportToBeDispatched: TForm_qrReportToBeDispatched;

implementation

{$R *.dfm}

procedure TForm_qrReportToBeDispatched.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrReportToBeDispatched.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
