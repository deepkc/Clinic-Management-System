unit Unit_qrSampleCollectedReport;
...
type
  TForm_qrSampleCollectedReport = class(TForm)
...
var
  Form_qrSampleCollectedReport: TForm_qrSampleCollectedReport;

implementation

{$R *.dfm}

procedure TForm_qrSampleCollectedReport.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrSampleCollectedReport.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
