unit Unit_qrFindingCompletedReport;
...
type
  TForm_qrFindingCompletedReport = class(TForm)
...
var
  Form_qrFindingCompletedReport: TForm_qrFindingCompletedReport;

implementation

{$R *.dfm}

procedure TForm_qrFindingCompletedReport.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrFindingCompletedReport.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
