unit Unit_ReportToBeDispatched;
...
type
  TForm_ReportToBeDispatched = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_ReportToBeDispatched: TForm_ReportToBeDispatched;

implementation
       uses Unit_qrReportToBeDispatched,UnitSendToExcel;
{$R *.dfm}

procedure TForm_ReportToBeDispatched.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_ReportToBeDispatched.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrReportToBeDispatched do
     begin
...
procedure TForm_ReportToBeDispatched.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_ReportToBeDispatched.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_ReportToBeDispatched.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_ReportToBeDispatched.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_ReportToBeDispatched.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrReportToBeDispatched,Form_qrReportToBeDispatched);
end;

procedure TForm_ReportToBeDispatched.FormDestroy(Sender: TObject);
begin
     Form_qrReportToBeDispatched.Free;
end;

procedure TForm_ReportToBeDispatched.FormKeyDown(Sender: TObject;
...
procedure TForm_ReportToBeDispatched.FormShow(Sender: TObject);
begin
...
procedure TForm_ReportToBeDispatched.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_ReportToBeDispatched.SpeedButton2Click(
  Sender: TObject);
begin
