unit Unit_QRCashCreditSalesTest;
...
type
  TForm_QRCashCreditSalesTest = class(TForm)
...
var
  Form_QRCashCreditSalesTest: TForm_QRCashCreditSalesTest;
...
procedure TForm_QRCashCreditSalesTest.QRExpr10Print(sender: TObject;
  var Value: string);
begin
     pf_Discount:=strtofloat(Value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr11Print(sender: TObject;
  var Value: string);
begin
     pf_refundedamount:=StrToFloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr16Print(sender: TObject;
  var Value: string);
begin
     pf_RefDiscount:=StrToFloat(Value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr17Print(sender: TObject;
  var Value: string);
begin
     pf_refgross:=StrToFloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr1Print(sender: TObject;
  var Value: string);
begin
     pf_hst:=strtofloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr23Print(sender: TObject;
  var Value: string);
begin
     pf_refhst:=strtofloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr24Print(sender: TObject;
  var Value: string);
begin
     pf_reftotal:=strtofloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr2Print(sender: TObject;
  var Value: string);
begin
     pf_amount:=StrToFloat(Value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr3Print(sender: TObject;
  var Value: string);
begin
     pf_gross:=StrToFloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr4Print(sender: TObject;
  var Value: string);
begin
     pf_Total:=strtofloat(value);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr5Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr(pf_amount-pf_refundedamount);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr6Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr(pf_Discount-pf_refdiscount);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr7Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr(pf_gross-pf_refgross);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr8Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr(pf_hst-pf_refhst);
end;

procedure TForm_QRCashCreditSalesTest.QRExpr9Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr(pf_total-pf_reftotal);
end;

procedure TForm_QRCashCreditSalesTest.QRLabel16Print(sender: TObject;
  var Value: string);
begin
     value:= gs_HospitalName;
end;

procedure TForm_QRCashCreditSalesTest.QRLabel40Print(sender: TObject;
  var Value: string);
begin
     Value := '';
end;

procedure TForm_QRCashCreditSalesTest.QRLabel_AddPrint(sender: TObject;
  var Value: string);
begin
