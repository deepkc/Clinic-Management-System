unit Unit_SampleCollectedReport;
...
type
  TForm_SampleCollectedReport = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_SampleCollectedReport: TForm_SampleCollectedReport;

implementation
       uses Unit_qrSampleCollectedReport,UnitSendToExcel;
{$R *.dfm}

procedure TForm_SampleCollectedReport.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_SampleCollectedReport.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrSampleCollectedReport do
     begin
...
procedure TForm_SampleCollectedReport.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_SampleCollectedReport.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_SampleCollectedReport.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_SampleCollectedReport.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_SampleCollectedReport.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrSampleCollectedReport,Form_qrSampleCollectedReport);
end;

procedure TForm_SampleCollectedReport.FormDestroy(Sender: TObject);
begin
     Form_qrSampleCollectedReport.Free;
end;

procedure TForm_SampleCollectedReport.FormKeyDown(Sender: TObject;
...
procedure TForm_SampleCollectedReport.FormShow(Sender: TObject);
begin
...
procedure TForm_SampleCollectedReport.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_SampleCollectedReport.SpeedButton2Click(
  Sender: TObject);
begin
