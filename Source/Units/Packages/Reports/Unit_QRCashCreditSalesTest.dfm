object Form_QRCashCreditSalesTest: TForm_QRCashCreditSalesTest
  Left = 0
  Top = 0
  Caption = 'Cash Credit Sales'
  ClientHeight = 742
  ClientWidth = 1196
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qr_cashCreditSales: TQuickRep
    Left = -210
    Top = 8
    Width = 1344
    Height = 816
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabelReportTitle: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Cash Credit Sales Detail'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Master = qr_cashCreditSales
      DataSet = Query_CashCredit
      FooterBand = SummaryBand1
      PrintBefore = False
      PrintIfEmpty = True
      object dbsno: TQRDBText
        Left = 2
        Top = 3
        Width = 13
        Height = 17
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum((Query_CashCredit.Amount))'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.Discount)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.hst)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr13: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.Paid)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr14: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.Due)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.GrossAmount)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_CashCredit.Total)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
    ...
    object SubDetail3: TQRSubDetail
      Left = 10
      Top = 287
      Width = 1325
      Height = 21
    ...
    object Band2: TQRBand
      ...
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Refund.GROSS)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr16: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Refund.Discount)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr17: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Refund.SubTotal)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr23: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Refund.hst)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
      ...
      object QRExpr24: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Refund.NETTOTAL)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashCredit.Amount-Query_Refund.GROSS)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 6
  ...
  object Query_CashCredit: TOraQuery
    FetchRows = 5000
    Left = 680
    Top = 16
  end
  object Query_Refund: TOraQuery
    SQL.Strings = (
      
        'select ROWNUM AS SN,refunddate,billno,refundtime,refundby,refera' +
        'ldoc,patientid,patientname,gross,discount,subtotal,hst,nettotal,' +
        'Remarks from VW_REFUNDDETAIL RD'
      'where 39=39'
      'and 39=39'
      'and 39=39'
      'order by sn')
