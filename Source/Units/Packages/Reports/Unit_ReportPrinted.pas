...
type
  TForm_ReportPrinted = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_ReportPrinted: TForm_ReportPrinted;

implementation
       uses Unit_qrReportPrinted,UnitSendToExcel;
{$R *.dfm}

procedure TForm_ReportPrinted.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_ReportPrinted.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrReportPrinted do
     begin
...
procedure TForm_ReportPrinted.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_ReportPrinted.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_ReportPrinted.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_ReportPrinted.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_ReportPrinted.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrReportPrinted,Form_qrReportPrinted);
end;

procedure TForm_ReportPrinted.FormDestroy(Sender: TObject);
begin
     Form_qrReportPrinted.Free;
end;

procedure TForm_ReportPrinted.FormKeyDown(Sender: TObject;
...
procedure TForm_ReportPrinted.FormShow(Sender: TObject);
begin
...
procedure TForm_ReportPrinted.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_ReportPrinted.SpeedButton2Click(
  Sender: TObject);
begin
