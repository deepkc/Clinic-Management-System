object Form_Medicare_GovtSvrTaxReportSummary: TForm_Medicare_GovtSvrTaxReportSummary
  Left = 0
  Top = 0
  Caption = 'Form_Medicare_GovtSvrTaxReportSummary'
  ClientHeight = 451
  ClientWidth = 1092
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.Discount)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.SUBTOTAL)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      object QRExpr16: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.NetTotalL)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      object QRExpr17: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.NONTAXABLETOTAL)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      object QRExpr18: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.5%HST)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr15: TQRExpr
        ...
        WordWrap = True
        Expression = 
          '0-QueryTotalCancelledBills.CANCELLEDTOTAL +QueryTotalCancelledBi' +
          'lls.TOTALDISCOUNT'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
    ...
    object QRSubDetail2: TQRSubDetail
      ...
      object QRExpr12: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = '0-(QueryCancelDetail.Total)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 10
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel_TaxAmt: TQRLabel
        Left = 847
        Top = 83
        Width = 43
        Height = 16
    ...
    object SummaryBand2: TQRBand
      ...
      object QRExpr20: TQRExpr
        ...
        Color = clWhite
        Master = QRSubDetail1
        OnPrint = QRExpr20Print
        ParentFont = False
        ResetAfterPrint = False
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.Gross)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      ...
      object QRExpr23: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Detail.NetTotal)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'Query_Master.BillDate'
  ...
  object Query_Master: TQuery
    SQL.Strings = (
      'Select Distinct BillDate From Tax.db Order by BillDate')
    Left = 176
    Top = 48
  end
  object Query_Detail: TQuery
    ...
    SQL.Strings = (
      'Select  *  From Tax.db where BillDate=:BillDate'
      'Order by BillDate')
    Left = 312
    Top = 32
    ParamData = <
  ...
  object Query_SummaryCash1: TOraQuery
    SQL.Strings = (
  ...
  object Query_RefundSummary1: TOraQuery
    SQL.Strings = (
