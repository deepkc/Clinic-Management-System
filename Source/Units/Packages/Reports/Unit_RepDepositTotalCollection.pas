unit Unit_RepDepositTotalCollection;
...
type
  TForm_RepDepositTotalCollection = class(TForm)
    QuickRep_DepositTotalcollection: TQuickRep;
    ...
    procedure QuickRep_DepositTotalcollectionBeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
    procedure QRDBText64Print(sender: TObject; var Value: string);
    procedure QRDBText74Print(sender: TObject; var Value: string);
    procedure QuickRep_DepositTotalcollectionAfterPrint(Sender: TObject);
...
var
  Form_RepDepositTotalCollection: TForm_RepDepositTotalCollection;

implementation

{$R *.dfm}

procedure TForm_RepDepositTotalCollection.FormCreate(Sender: TObject);
begin
//          lbl_hosname.Caption:=gs_HospitalName;
     lbl_Address.Caption:=gs_HospitalAddress;
end;

procedure TForm_RepDepositTotalCollection.QRDBText64Print(sender: TObject;
  var Value: string);
begin
     c:=c+1;
...
procedure TForm_RepDepositTotalCollection.QRDBText74Print(sender: TObject;
  var Value: string);
begin
     d:=d+1;
...
procedure TForm_RepDepositTotalCollection.QRExpr16Print(sender: TObject; var Value: string);
begin
     Pf_Refund:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Refund);
end;

procedure TForm_RepDepositTotalCollection.QRExpr17Print(sender: TObject; var Value: string);
begin
     Pf_Deposit:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',Pf_Deposit);
end;

procedure TForm_RepDepositTotalCollection.QRExpr28Print(sender: TObject; var Value: string);
begin
      Value:=FormatFloat('#0,0.00',pf_Collection-Pf_Refund+Pf_Deposit-Pf_DepositRefund);
end;

procedure TForm_RepDepositTotalCollection.QRExpr32Print(sender: TObject; var Value: string);
begin
      Pf_DepositRefund:=StrToFloat(value);
      Value:=FormatFloat('#0,0.00',Pf_DepositRefund);
end;

procedure TForm_RepDepositTotalCollection.QRExpr3Print(sender: TObject; var Value: string);
begin
     pf_Collection:=StrToFloat(value);
     Value:=FormatFloat('#0,0.00',pf_Collection);
end;

procedure TForm_RepDepositTotalCollection.QRLabel_HosNamePrint(sender: TObject;
  var Value: string);
begin
     Value:=gs_HospitalName;
end;

procedure TForm_RepDepositTotalCollection.QuickRep_DepositTotalcollectionAfterPrint(Sender: TObject);
begin
     a:=0;
     b:=0;
     c:=0;
...
procedure TForm_RepDepositTotalCollection.QuickRep_DepositTotalcollectionBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
     a:=0;
     b:=0;
