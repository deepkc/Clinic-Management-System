...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Buttons, DBCtrls, OleCtrls, DateEditXControl_TLB,Unit_QrCreditDiscountReport,
...
begin
    ...
    begin
         ...
         begin
              ...
              SQL[10]:='and BillDate>=' + #39 + gs_From + #39 + ' And BillDate<=' + #39 + gs_to + #39;
         ...
         begin
             SendToExcelsMultiQuery(QueryDue,NIL,Nil,Nil,Nil,nil,
                         'Credit Discount Report','','','','','',TodaysDate,'',gs_HospitalName,gs_HospitalAddress,1,6);
              pb_ToXl:=False;
              exit;
         end;
