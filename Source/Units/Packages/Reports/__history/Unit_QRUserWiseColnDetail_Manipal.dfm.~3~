object Form_QRUserWiseCollnDetail_Manipal: TForm_QRUserWiseCollnDetail_Manipal
  Left = 0
  Top = 165
  ...
  object QuickRep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel_TotalPage: TQRLabel
        Left = 907
        Top = 65
        Width = 12
        Height = 14
    ...
    object QRBand6: TQRBand
      ...
      object QRLabel40: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Receipt Refund / Community Refund'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object QRSubDetail_ReceiptRefund: TQRSubDetail
      Left = 48
      Top = 605
      Width = 960
      Height = 20
    ...
    object QRSubDetail_CreditBillRefund: TQRSubDetail
      ...
      PrintBefore = False
      PrintIfEmpty = True
      object QRLabel_CrReundNo: TQRLabel
        Left = 2
        Top = 2
        Width = 42
        Height = 15
        ...
        Font.Name = 'Verdana'
        Font.Style = []
        OnPrint = QRLabel_CrReundNoPrint
        ParentFont = False
        Transparent = False
        WordWrap = True
        ExportAs = exptText
    ...
    object QRBand7: TQRBand
      ...
      object QRExpr23: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashBillIP.GROSS)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr24: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashBillIP.SVRTAX)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr25: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashBillIP.DISCOUNT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr26: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashBillIP.NETTOTAL)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      ...
      object QRExpr27: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_CashBillIP.SUBTOTAL)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRBand8: TQRBand
      ...
      object QRExpr29: TQRExpr
        ...
        Font.Style = [fsBold]
        Color = clWhite
        Master = QRSubDetail_ReceiptRefund
        OnPrint = QRExpr29Print
        ParentFont = False
        ResetAfterPrint = False
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_ReceiptRefund.RECEIPTAMOUNT)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
    ...
    object QRSubDetail_ServiceTPBill: TQRSubDetail
      Left = 48
      Top = 834
      Width = 960
      Height = 23
      ...
      KeepOnOnePage = False
      Master = QuickRep1
      DataSet = Query_ServiceTPBill
      FooterBand = QRFooter_ServiceTPBill
      PrintBefore = False
      PrintIfEmpty = True
      object QRLabel_ServiceTPNo: TQRLabel
        Left = 2
        Top = 1
        Width = 42
        Height = 16
    ...
    object QRFooter_ServiceTPBill: TQRBand
      Left = 48
      Top = 857
      Width = 960
      Height = 24
      ...
      object QRExpr28: TQRExpr
        ...
        Font.Style = []
        Color = clWhite
        Master = QRSubDetail_ServiceTPBill
        ParentFont = False
        ResetAfterPrint = False
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_ServiceTPBill.GROSS)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr31: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_ServiceTPBill.SVRTAX)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr33: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_ServiceTPBill.DISCOUNT)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr34: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_ServiceTPBill.SUBTOTAL)'
        Mask = '#0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr35: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_ServiceTPBill.NETTOTAL)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object Query_CashBill: TOraQuery
    SQL.Strings = (
      
        'Select * From VW_hs_SalesBook_Detail where BillNo Like '#39'%CS%'#39'  a' +
        'nd billtype<>'#39'IP'#39
      'where 1=1'
      'Order by BillNo')
    Left = 240
    Top = 11
  end
  object Query_CashRefund: TOraQuery
    SQL.Strings = (
      
        'SELECT   BillDate,BillTime,BillNo,PATIENTID,PrevBillNo,(Select P' +
        'AMA_PatientName From HS_PAMA_PatientMain where PAMA_PatientId=R.' +
        'PatientId) as Name,'
      ...
      'From ('
        ...
        'Select REDE_RefundDate AS BillDate,REDE_RefundTime as BillTime,R' +
        'EDE_REFUNDBILLNO BillNo,REDE_PatientId PATIENTID,REDE_RefundBy A' +
        'S BillBy,'
      ...
      ') R'
      'GROUP BY BillDate,BillTime,BillNo,PatientId,PrevBillNo,BillBy'
      'Order by BillNo')
    Left = 704
    Top = 4
  end
  object Query_CreditBill: TOraQuery
    SQL.Strings = (
  ...
  object Query_Deposit: TOraQuery
    SQL.Strings = (
        ...
        'ositNo DepositNo,DEPO_DrAmount as DepositAmt,'
      
        'Case When Trim(DEPO_REFERENCETYPE) Is Not Null Then DEPO_REFEREN' +
        'CETYPE Else DEPO_DepositType End DepositType,DEPO_ReferenceNo as' +
        ' ReferenceNo'
  ...
  object Query_AdjustedDeposit: TOraQuery
    SQL.Strings = (
      'select * from ('
      ...
      'From HS_DEPO_Deposit '
        ...
        'where DEPO_DrAmount=0 and NVL (SubStr(DEPO_ReferenceNo,1,2), '#39'CS' +
        #39') Not In ('#39'CR'#39','#39'ME'#39') and DEPO_DEPOSITTYPE ='#39'DIS ADJ DEP REFUND'#39
      'and DEPO_DepositDate>=:DepositDate'
      'Union'
        ...
        'Case When Trim(DEPO_REFERENCETYPE) Is Not Null Then '#39'EXCESS PAID' +
        ' AMOUNT REFUNDED'#39' Else DEPO_DepositType End DepositType,DEPO_Ref' +
        'erenceNo as ReferenceNo'
      'From HS_DEPO_Deposit '
  ...
  object Query_CreditRefund: TOraQuery
    SQL.Strings = (
  ...
  object Query_ReceiptColn: TOraQuery
    SQL.Strings = (
      
        'Select ReceiptNo, Amount ReceiptAmount,DataPostDate RECEIPTDATE ' +
        ',DataPostTime RECEIPTTIME ,'
      
        '(Select SCHE_Scheme From HS_SCHE_SCHEME where SCHE_SchemeId=CPM.' +
        'SchemeId) as Scheme,PatientId,'
      
        '(Select InitCap(pama_PatientName) from hs_pama_patientmain where' +
        ' pama_patientid=CPM.PatientId)Name,CrBillNo as ReferenceNo'
      'From CreditPaymentDetail CPM where 0=0'
      ''
      'Order by ReceiptNo')
    Left = 48
    Top = 20
  end
  object Query_CashBillIP: TOraQuery
    SQL.Strings = (
      
        'Select * From VW_hs_SalesBook_Detail where BillNo Like '#39'%CS%'#39'  a' +
        'nd billtype In ('#39'IP'#39','#39'A'#39')'
      'where 1=1'
      'Order by BillNo')
    Left = 472
    Top = 3
  end
  object Query_ReceiptRefund: TOraQuery
    SQL.Strings = (
      'select * from '
      
        '(Select ReceiptNo,(RECEIVEDAMOUNT-COPAYDISPER/100*RECEIVEDAMOUNT' +
        ') ReceiptAmount,RECEIPTDATE ,RECEIPTTIME ,'
      
        '(Select SCHE_Scheme From HS_SCHE_SCHEME where SCHE_SchemeId=CPM.' +
        'SchemeId) as Scheme,PatientId,'
      
        '(Select pama_PatientName from hs_pama_patientmain where pama_pat' +
        'ientid=CPM.PatientId)Name,CrBillNo as ReferenceNo'
      'From CreditPayment CPM where Paytype='#39'REFUND'#39
      'and 1=1'
      'union'
      
        'Select BILLNO ReceiptNo, AMOUNT ReceiptAmount,BILLDATE RECEIPTDA' +
        'TE ,BILLTIME RECEIPTTIME ,'
      
        '(Select SCHE_Scheme From HS_SCHE_SCHEME where SCHE_SchemeId=CPM.' +
        'SchemeId) as Scheme,PatientId,'
      
        '(Select pama_PatientName from hs_pama_patientmain where pama_pat' +
        'ientid=CPM.PatientId)Name,REFBIllNo as ReferenceNo'
      'From CommunityRefund CPM'
      'where 1=1'
      ') Order by ReceiptNo')
    Left = 320
    Top = 65524
  ...
  object Query1: TOraQuery
    SQL.Strings = (
      ...
      'Union'
        ...
        'Select ReceiptId as DepositId,PatientId,(Select NOPA_PatientName' +
        ' From HS_NOPA_NonPatient where NOPA_NonPatientId=CRM.PatientId) ' +
        'as Name,'
      ...
      'Union'
        ...
        'e From HS_PAMA_PatientMain where PAMA_NonPatientId=CRM.PatientId' +
        ') as Name,'
  ...
  object Query_ServiceTPBill: TOraQuery
    SQL.Strings = (
      
        'Select SEBD_BillNo as BillNo,SEBD_BillDate BillDate,SEBD_BillTim' +
        'e BillTime,SEBD_PatientId as PatientId,SEBD_InPatientId as InPat' +
        'ientId,'
      
        '(Select PAMA_PatientName From HS_PAMA_PatientMain where PAMA_Pat' +
        'ientId=SEBD_PatientId) as Name,'
      
        'Sum(SEBD_Amount*SEBD_Qty) as Gross,Sum((SEBD_Amount*SEBD_Qty)-(S' +
        'EBD_Amount*SEBD_Qty*SEBD_DisPer/100)) as Discount,Sum(SEBD_Amoun' +
        't*SEBD_Qty) as SubTotal,'
      
        'Sum(SEBD_VatAmt) as SvrTax,Sum((SEBD_Amount*SEBD_Qty)+SEBD_VatAm' +
        't-(SEBD_Amount*SEBD_Qty*SEBD_DisPer/100)) as NetTotal,'
      
        'NVL((Select Depo_DrAmount From HS_DEPO_Deposit where DEPO_Refere' +
        'nceNo=SEBD_BillNo and DEPO_DrAmount >0),0) as AdvanceAmount '
      'From HS_SEBD_ServiceBillDetail where SEBD_BILLTYPE In ('#39'A'#39','#39'IP'#39')'
      'and SEBD_BillDate='#39'2014/07/17'#39
      
        'Group By SEBD_BillNo,SEBD_BillDate,SEBD_BillTime,SEBD_PatientId,' +
        'SEBD_InPatientId'
      'Order by SEBD_BillDate,SEBD_BillNo')
    Left = 368
    Top = 12
  end
end
