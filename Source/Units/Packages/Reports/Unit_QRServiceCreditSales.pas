unit Unit_QRServiceCreditSales;
...
type
  TForm_QRServiceCreditSales = class(TForm)
...
var
  Form_QRServiceCreditSales: TForm_QRServiceCreditSales;
...
procedure TForm_QRServiceCreditSales.QRExpr10Print(sender: TObject;
  var Value: string);
begin
     pf_Discount:=strtofloat(Value);
end;

procedure TForm_QRServiceCreditSales.QRExpr11Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr16Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr17Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr1Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr23Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr24Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr2Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr3Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr4Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr5Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr6Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr7Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr8Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRExpr9Print(sender: TObject;
  var Value: string);
begin
     if value<>'' then
...
procedure TForm_QRServiceCreditSales.QRLabel16Print(sender: TObject;
  var Value: string);
begin
     value:= gs_HospitalName;
end;

procedure TForm_QRServiceCreditSales.QRLabel26Print(sender: TObject;
  var Value: string);
begin
     pi_sn:=pi_sn+1;
...
procedure TForm_QRServiceCreditSales.QRLabel40Print(sender: TObject;
  var Value: string);
begin
     Value := '';
end;

procedure TForm_QRServiceCreditSales.QRLabel_AddPrint(sender: TObject;
  var Value: string);
begin
