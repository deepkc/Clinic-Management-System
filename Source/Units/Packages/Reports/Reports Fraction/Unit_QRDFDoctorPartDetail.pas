...
uses
  ...
  ExtCtrls, QuickRpt, Qrctrls, Db, DBTables, Grids, DBGrids, Fxn;
...
type
  TForm_QRDFDoctorPartDetail = class(TForm)
    ...
    QryOPDRefund: TQuery;
    QryOPDDetail: TQuery;
    QryOPDDetailBillDate: TStringField;
    QryOPDDetailPCount: TIntegerField;
    QryOPDDetailNetAmount: TFloatField;
    QryOPDDetailDrAmount: TFloatField;
    QryOPDDetailTDS: TFloatField;
    QryOPDDetailNetDrAmount: TFloatField;
    QryOPDProcedure: TQuery;
    FloatField1: TFloatField;
    FloatField2: TFloatField;
    FloatField3: TFloatField;
    FloatField4: TFloatField;
    QryOPDProcedureService: TStringField;
    QryOPDProcedurePCount: TFloatField;
    QryOPDProcedureRefund: TQuery;
    ...
    QryInPTDetailDocCode: TStringField;
    QryInPTDetailDocName: TStringField;
    QryInPTDetailBillDate: TStringField;
    QryInPTDetailPayType: TStringField;
    QryInPTDetailBillNo: TStringField;
    QryInPTDetailBillType: TStringField;
    QryInPTDetailPatientId: TIntegerField;
    QryInPTDetailInPatientId: TIntegerField;
    QryInPTDetailPatientName: TStringField;
    QryInPTDetailService: TStringField;
    QryInPTDetailDocDept: TStringField;
    QryInPTDetailDepartment: TStringField;
    QryInPTDetailOPDAmount: TFloatField;
    QryInPTDetailIPDAmount: TFloatField;
    QryInPTDetailBillAmount: TFloatField;
    QryInPTDetailDiscount: TFloatField;
    QryInPTDetailNetAmount: TFloatField;
    QryInPTDetailDrAmount: TFloatField;
    QryInPTDetailTDS: TFloatField;
    QryInPTDetailNetDrAmount: TFloatField;
    QryInPTDetailHospital: TFloatField;
    QryInPTDetailRemarks: TStringField;
    QryInPTDetailISOT: TStringField;
...
procedure TForm_QRDFDoctorPartDetail.QRLabel28Print(sender: TObject;
  var Value: string);
begin
     Value:=FloatToStr((pf_FS_OPDShare+pf_FS_OPDProc_Share+pf_FS_IPDProc_Share+pf_FS_IPDOT_Share-pf_TDSTotal));
end;
...
procedure TForm_QRDFDoctorPartDetail.QRLabel16Print(sender: TObject;
  var Value: string);
begin
     pf_TDSTotal:=((pf_FS_OPDShare+pf_FS_OPDProc_Share+pf_FS_IPDProc_Share+pf_FS_IPDOT_Share)*gf_TDSPercent/100);
     value:=FormatFloat('#,##0.00',((pf_FS_OPDShare+pf_FS_OPDProc_Share+pf_FS_IPDProc_Share+pf_FS_IPDOT_Share)*gf_TDSPercent/100));
end;
...
begin
{
     ...
     Value:=FormatFloat('#,##0.00',StrToFloat(Value));}
     {
     Value:=FloatToStr(pf_TotalAmount*gf_TDSPercent/100);
     pf_TDS:=pf_TotalAmount*gf_TDSPercent/100;    }
...
procedure TForm_QRDFDoctorPartDetail.QRExpr12Print(sender: TObject;
  var Value: String);
begin
     Value:=FormatFloat('#,##0.00',(pf_GrandTotAmt-pf_TDS));
end;
