object FormReportBillCancel: TFormReportBillCancel
  Left = 323
  Top = 162
  Caption = 'FormReportBillCancel'
  ClientHeight = 579
  ClientWidth = 1002
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QueryMaster.Amount-QueryMaster.FreeCon'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
    ...
    object SummaryBand2: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryMaster.AMOUNT)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryMaster.FREECON)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryMaster.Amount-QueryMaster.FreeCon)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(QueryMaster.SVRTAX)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
