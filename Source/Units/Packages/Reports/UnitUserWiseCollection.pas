...
uses UnitRepUserWiseCollection, UnitRepUserWiseDetail, UnitDeptWiseReport,
     UnitRepDetailUserWise, UnitNoofTestDone,UnitSendToExcel;
{$R *.dfm}
...
begin
     ps_FromDate:=DateEditxFrom.text;
     ps_ToDate:=DateEditxTo.text;
          ...
          try
               ...
               begin
                    ...
                    begin
                         ...
                         SQL.ADD(' ,SUM(RECEIPTAMOUNT-RECEIPTREFUND) TOTALRECEIPT ');
                    ...
                    lbl_From.caption:=ps_FromDate;
                    lbl_To.caption:=ps_ToDate;

                    if pb_IsSendToExcel=True then
                    begin
                         SendtoExcels(QueryMain,nil,'User Wise Collection(Summary)',DateEditxFrom.text+'-'+DateEditXTo.text,'Generated Date/Time/By :'+TodaysDate+'/'+TodaysTime+'/'+gs_UserName,
     ...
     begin
          try
               ...
               Begin
                    ...
                    Date1.Caption := ps_FromDate;
                    Date2.Caption := ps_ToDate;

                   { if pb_IsSendToExcel=True then
                    begin
                    SendToExcelsMultiQuery_UserColnDetail(QueryCollection,nil,QueryRefund,QueryDeposit,nil,
                              nil,nil,QueryCredit,nil,nil,Nil,
                              'User Wise Collection(Summary)','','','','','','','','','','',DateEditxFrom.text+'-'+DateEditxTo.text,
...
procedure TFormUserWiseCollection.BitBtn1Click(Sender: TObject);
begin
     Try
...
procedure TFormUserWiseCollection.BitBtnCancelClick(Sender: TObject);
begin
     close;
end;
