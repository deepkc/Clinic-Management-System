object Form_Medicare_GovtSvrTaxReport: TForm_Medicare_GovtSvrTaxReport
  Left = 0
  Top = 0
  Caption = 'Form_Medicare_GovtSvrTaxReport'
  ClientHeight = 431
  ClientWidth = 1104
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum((Query_Cash.GROSS))'
        ExportAs = exptText
      ...
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Cash.Discount)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Cash.SubTotal)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
      ...
      object QRExpr14: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(Query_Cash.NETTOTAL)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
  ...
  object Query_Cash: TOraQuery
    SQL.Strings = (
      
        'select SB.*,SUBSTR(SB.BILLNO,9,15)SERIAL from vw_salesbookCash S' +
        'B'
      'where 39=39'
      'and 39=39'
      'AND 1=1'
  ...
  object Query_Refund: TOraQuery
    SQL.Strings = (
      'select * from vw_salesbookrefund sb'
      'where 39=39'
      'and 39=39')
    FetchRows = 2500
    Left = 98
