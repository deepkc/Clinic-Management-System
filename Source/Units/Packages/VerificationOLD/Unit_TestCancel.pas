...
var
  Form_TestCancel: TForm_TestCancel;
...
procedure TForm_TestCancel.BB_CloseClick(Sender: TObject);
begin
   Close;
end;

procedure TForm_TestCancel.BB_SaveClick(Sender: TObject);
var
    i,j:Integer;
begin
...
procedure TForm_TestCancel.chklst_testnameClickCheck(Sender: TObject);
begin
...
procedure TForm_TestCancel.chk_allClick(Sender: TObject);
var
    li_check:Integer;
begin
     Li_check := 0;
...
procedure TForm_TestCancel.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TForm_TestCancel.FormShow(Sender: TObject);
begin
    LoadCanceltest;
end;

procedure TForm_TestCancel.LoadCanceltest;
var
  k:Integer;
begin
     with Query_Blank do
     begin
          Close;
          Sql.Clear;
          Sql.Add('Select patienttestid,(select tena_testname from hs_tena_testname t where testnameid=PT.TESTNAMEID)testname,CancelRemarks,CancelDate,CancelTime');
