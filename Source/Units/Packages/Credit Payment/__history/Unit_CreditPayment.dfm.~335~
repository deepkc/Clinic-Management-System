object Frame_CreditPayment: TFrame_CreditPayment
  ...
  object Query_AccountHead: TOraQuery
    SQL.Strings = (
  ...
  object QryCreditBill: TOraQuery
    SQL.Strings = (
  ...
  object QryReceiptPrint: TOraQuery
    SQL.Strings = (
  ...
  object UpdateSQL2: TOraUpdateSQL
    InsertSQL.Strings = (
      'insert into acctree'
      '  (STATE)'
      'values'
  ...
  object qry_updatestate: TOraQuery
    SQL.Strings = (
      'select * from acctree')
    Left = 624
    Top = 192
