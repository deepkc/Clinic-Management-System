...
var
     Form_QRCard_PPL: TForm_QRCard_PPL;

implementation

{$R *.dfm}

procedure TForm_QRCard_PPL.FormCreate(Sender: TObject);
begin
...
procedure TForm_QRCard_PPL.lbl_agegenderPrint(sender: TObject; var Value: string);
begin
     //Value:=Gs_CurrentAgeGender;
end;

procedure TForm_QRCard_PPL.QRLabel_ContactNoPrint(sender: TObject; var Value: string);
begin
     if trim(Value)='' then
          Value:='N/A';
end;

procedure TForm_QRCard_PPL.QRLabel_HosNoCapPrint(sender: TObject; var Value: string);
begin
