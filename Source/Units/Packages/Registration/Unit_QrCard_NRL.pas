...
var
     Form_QRCard_NRL: TForm_QRCard_NRL;

implementation

{$R *.dfm}

procedure TForm_QRCard_NRL.FormCreate(Sender: TObject);
begin
...
procedure TForm_QRCard_NRL.lbl_agegenderPrint(sender: TObject; var Value: string);
begin
     //Value:=Gs_CurrentAgeGender;
end;

procedure TForm_QRCard_NRL.qrimBeforePrint(Sender: TQRCustomBand;
...
procedure TForm_QRCard_NRL.QRLabel_ContactNoPrint(sender: TObject; var Value: string);
begin
     if trim(Value)='' then
          Value:='N/A';
end;

procedure TForm_QRCard_NRL.QRLabel_HosNoCapPrint(sender: TObject; var Value: string);
begin
