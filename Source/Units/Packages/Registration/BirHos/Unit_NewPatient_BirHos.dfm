object Form_NewPatient_BIRHOS: TForm_NewPatient_BIRHOS
  Left = 0
  Top = 0
  ClientHeight = 651
  ClientWidth = 904
  ...
  object PageControl1: TPageControl
    ...
    Width = 904
    Height = 651
    ActivePage = TS_Registration
    Align = alClient
    TabOrder = 0
    object TS_Registration: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object Label_Charge: TLabel
          ...
          Caption = 'Today'#39's new patient'
          Color = clBtnFace
        ...
        object GB_BasicInformation: TGroupBox
          ...
          object SPB_DOB: TSpeedButton
            Left = 147
            Top = 111
            Width = 23
            Height = 22
            OnClick = SPB_DOBClick
          end
          ...
          object Dex_Dob: TDateEditX
            ...
            TabOrder = 6
            OnExit = Dex_DobExit
            OnKeyPress = Dex_DobKeyPress
            ControlData = {
              545046300A5444617465456469745200044C656674025103546F70026F0B4461
          ...
          object DBLCB_Religion: TDBLookupComboBox
            ...
            OnKeyPress = DBLCB_ReligionKeyPress
          end
          object DBLCB_title: TDBLookupComboBox
            ...
            ListSource = DSTitle
            TabOrder = 0
            OnClick = DBLCB_titleClick
            OnKeyDown = DBLCB_titleKeyDown
          end
          ...
          object CB_MaritalStatus: TComboBox
            ...
            Style = csOwnerDrawFixed
            TabOrder = 9
            OnKeyPress = CB_MaritalStatusKeyPress
            Items.Strings = (
              'MARRIED'
              'UNMARRIED')
          end
          object DBLCB_Ethnicity: TDBLookupComboBox
            ...
            ListField = 'ETHNICITY'
            ListSource = DS_Ethinicity
            NullValueKey = 46
            TabOrder = 10
            OnKeyPress = DBLCB_EthnicityKeyPress
          end
          ...
          object Le_LName: TComboBoxEx
            ...
            ItemsEx = <>
            TabOrder = 2
            OnKeyPress = Le_LNameKeyPress
          end
          object CB_IsRealDOB: TCheckBox
            Left = 203
            Top = 113
            Width = 97
            Height = 17
        ...
        object GB_Address: TGroupBox
          ...
          object DBLCB_Country: TDBLookupComboBox
            ...
            TabOrder = 0
            OnClick = DBLCB_CountryClick
            OnKeyPress = DBLCB_CountryKeyPress
          end
          object DBLCB_District: TDBLookupComboBox
            ...
            TabOrder = 1
            OnClick = DBLCB_DistrictClick
            OnKeyPress = DBLCB_DistrictKeyPress
          end
          ...
          object Le_PhoneNo: TLabeledEdit
            ...
            NumbersOnly = True
            TabOrder = 6
            OnExit = Le_PhoneNoExit
            OnKeyPress = Le_PhoneNoKeyPress
          end
          object Le_MobileNo: TLabeledEdit
            ...
            NumbersOnly = True
            TabOrder = 5
            OnExit = Le_MobileNoExit
            OnKeyPress = Le_MobileNoKeyPress
          end
        ...
        object GB_Others: TGroupBox
          ...
          object Le_Relative: TLabeledEdit
            ...
            EditLabel.Width = 63
            EditLabel.Height = 13
            EditLabel.Caption = 'Pt. Relative :'
            LabelPosition = lpLeft
            TabOrder = 2
            OnKeyPress = Le_RelativeKeyPress
          end
          object DBLCB_Occupation: TDBLookupComboBox
            ...
            OnKeyPress = DBLCB_OccupationKeyPress
          end
          object DBLCB_Education: TDBLookupComboBox
            ...
            OnKeyPress = DBLCB_EducationKeyPress
          end
          ...
          object DBLCB_Relation: TDBLookupComboBox
            ...
            OnKeyPress = DBLCB_RelationKeyPress
          end
          ...
          object Memo_Remarks: TMemo
            ...
            OnKeyPress = Memo_RemarksKeyPress
          end
        ...
        object GroupBox_VisitHistory: TGroupBox
          Left = 6
          Top = 558
          Width = 720
          Height = 50
          ...
          object LabelLastVisitDate: TLabel
            Left = 639
            Top = 28
            Width = 31
            Height = 13
          ...
          object LabelVisitGapDays: TLabel
            Left = 471
            Top = 3
            Width = 31
            Height = 13
          ...
          object LabelLastBillDate: TLabel
            Left = 639
            Top = 3
            Width = 31
            Height = 13
          ...
          object LabelPaymentGapDays: TLabel
            Left = 471
            Top = 28
            Width = 31
            Height = 13
          ...
          object LblMscNoCap: TLabel
            Left = 575
            Top = 34
            Width = 90
            Height = 13
            Caption = 'MSC Member No. :'
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlack
            Font.Height = -11
        ...
        object GroupBox_DoctorDepartment: TGroupBox
          Left = 8
          Top = 61
          Width = 346
          Height = 142
          ...
          object le_Diagnosis: TComboBoxEx
            Left = 80
            Top = 77
            Width = 260
            Height = 22
            ...
            ItemsEx = <>
            TabOrder = 4
            OnKeyPress = le_DiagnosisKeyPress
          end
        ...
        object GroupBox_DiscountPolicy: TGroupBox
          Left = 359
          Top = 334
          Width = 370
          Height = 77
          ...
          object DBLCB_REFBYTYPE: TDBLookupComboBox
            ...
            TabOrder = 2
            OnKeyPress = DBLCB_REFBYTYPEKeyPress
          end
        ...
        object GB_EmergencyCase: TGroupBox
          Left = 360
          Top = 91
          Width = 215
          Height = 80
          Caption = 'EMR. Case Type'
          Enabled = False
          TabOrder = 9
          Visible = False
          ...
          object CB_EMERTYPE: TComboBox
            ...
            Style = csOwnerDrawFixed
            TabOrder = 0
            OnChange = CB_EMERTYPEChange
            OnClick = CB_EMERTYPEClick
            OnKeyPress = CB_EMERTYPEKeyPress
            Items.Strings = (
              'GENERAL'
              'POLICE')
          end
          object DBLCB_EMERCASE: TDBLookupComboBox
            Left = 42
            Top = 43
            Width = 168
            Height = 21
            ...
            ListField = 'EMCA_CASE'
            ListFieldIndex = 1
            ListSource = DS_EMERCASE
            TabOrder = 1
            OnKeyPress = DBLCB_EMERCASEKeyPress
          end
        end
      end
...
object DSReligion: TDataSource
    ...
    SQL.Strings = (
            'Select * From HS_Country Order by Decode(IsSaarcCountry,'#39'Y'#39',1,2)'
            ' ')
    Left = 616
    Top = 216
  end
...
object DS_Relation: TDataSource
  ...
  object ImageList1: TImageList
    ...
    Top = 400
    Bitmap = {
      494C010102003C00180710001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object DS_Ethinicity: TDataSource
    DataSet = Query_Ethinicity
    Left = 736
    Top = 184
  end
    object Query_Ethinicity: TOraQuery
    SQL.Strings = (
            'Select * from HS_Ethnicity '
            'order by Ethnicity')
    Left = 808
    Top = 240
  end
  object Query_Category: TOraQuery
    SQL.Strings = (
            'Select * From HS_paty_PatientType'
            'Order By PATY_DisplayOrder,PATY_PatientType')
    Left = 816
    Top = 224
  end
object DS_Category: TDataSource
    DataSet = Query_Category
    Left = 824
    Top = 224
  end
  ...
  object QueryCheckFileStatus: TOraQuery
    SQL.Strings = (
              ...
              'Select FIST_CurStatus CurStatus,FIST_Status Status,FIST_RackNo R' +
              'ackNo,FIST_FileMemberId FileMemberId,FIST_FILEID as FileId From ' +
              'HS_FIST_FileStatus '
            
              'Where FIST_FILEID In (Select Max(FIST_FILEID) FIST_FILEID From H' +
              'S_FIST_FileStatus '
...
object Timer_DisplayChargeInfo: TTimer
    Enabled = False
    Interval = 700
    OnTimer = Timer_DisplayChargeInfoTimer
    Left = 224
    Top = 576
  end
  object ActionList1: TActionList
    ...
    SQL.Strings = (
              ...
              'e,DEPT_REPORTTITLE REPORTTITLE ,Dept_DepType DepType,DEPT_IsFemi' +
              'nineDept  IsFeminineDept'
...
object DS_RefByDocHos: TDataSource
    ...
    SQL.Strings = (
              ...
              '('#39'GEN'#39','#39'NSS'#39','#39'NSI'#39','#39'ECG'#39','#39'ECS'#39','#39'ECP'#39')'
...
object Timer3: TTimer
    ...
    object Query_EmerCase: TOraQuery
    SQL.Strings = (
            'Select * from hs_EMCA_EMERGENCYCASE'
            'WHERE 1=1'
            'Order By EMCA_CASE')
    Left = 269
    Top = 16
  end
object DS_EMERCASE: TDataSource
    DataSet = Query_EmerCase
    Left = 344
    Top = 16
  end
end
