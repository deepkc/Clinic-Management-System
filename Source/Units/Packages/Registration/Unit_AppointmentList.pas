...
type
     ...
     type
          TFrame_AppointmentList = class(TFrame)
...
procedure TFrame_AppointmentList.BB_StatusClick(Sender: TObject);
var
...
begin
     ...
     Begin
          ...
          if TT_Appoinment.FieldByName(Ls_Patienttype).AsString = 'Non' then
               SQL.Add('select * from nonpatient where nonpatientid=' + inttostr(TT_Appoinment.FieldByName(Ls_Patientid).AsInteger))
...
procedure TFrame_AppointmentList.BB_ViewClick(Sender: TObject);
var
          ...
          Begin
               ...
               Begin
                    ...
                    SQL.Add('select * from doctorscheduledetail where doctorscheduleid in (select doctorscheduleid from doctorschedule where docid='
                           + Arr_CLB_DoctorID[Li_check, 0] + ' and EngDate=''' + DEX_AppDate.ADDateAsText + ''') order by serialorderno');
                    // SQL.Add('Select * from appointment where appdate='+#39+DEX_AppDate.text+#39+' and doccode in (Select doccode from doctor where docid='+Arr_CLB_DoctorID[LI_check,0]+') order by QueNo');
                    Open;
               End;
               ...
               Begin
                    ...
                    SQL.Add('select isonleave from doctorschedule where docid=' + Arr_CLB_DoctorID[Li_check, 0]
                           + ' and EngDate=' + #39 + DEX_AppDate.ADDateAsText + #39);
                    Open;
               End;
...
procedure TFrame_AppointmentList.btn_CloseClick(Sender: TObject);
begin
     Self.Free;
end;

procedure TFrame_AppointmentList.btn_SaveClick(Sender: TObject);
var
...
procedure TFrame_AppointmentList.DBLCB_ShiftClick(Sender: TObject);
var
     Li_check, Li_loop, Li_Serial, Li_Count, Li_num, Li_maxserial: Integer;
     ...
     Begin
          ...
          Begin
               ...
               Begin
                    ...
                    SQL.Clear;
                    SQL.Add('select * from doctorscheduledetail where doctorscheduleid in (select doctorscheduleid from doctorschedule where docid='
                           + Arr_CLB_DoctorID[Li_check, 0] + ' and EngDate=''' + DEX_AppDate.ADDateAsText + ''') and shift=' + #39 +
...
procedure TFrame_AppointmentList.CheckBox1Click(Sender: TObject);
var
     Li_check: Integer;
begin
     Li_check := 0;
...
procedure TFrame_AppointmentList.ClearFrame;
Var
     i: Integer;
begin
     try
...
constructor TFrame_AppointmentList.Create(Aowner: Tcomponent);
begin
     inherited;
     ...
     GridColumnWidth;
     DEX_AppDate.SystemOfDate := 1;
     DEX_AppDate.Text := TodaysDate;

     MonthlyCalendar.Date := DEX_AppDate.ADDateAsDate;
...
procedure TFrame_AppointmentList.DBGrid_AppoinmentDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn;
     State: TGridDrawState);
var
     Li_doccheck: Integer;
...
procedure TFrame_AppointmentList.DBGrid_PatientSearchDblClick(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.DBGrid_PatientSearchKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key = 13 then
     Begin
          Edit_SearchAppId.Text := Query_SearchApp.FieldByName('Appid').AsString;
...
procedure TFrame_AppointmentList.dblcb_departmentClick(Sender: TObject);
var
     Qry: TOraQuery;
     i: Integer;
begin
     ...
     begin
          ...
          DatabaseName := gs_DatabaseName;
          SQL.Clear;
          SQL.Add('Select InitCap(Docname)DocName,DocId from Doctor where DepId=' + inttostr(dblcb_department.KeyValue) + ' Order by DocName');
          Open;
...
procedure TFrame_AppointmentList.Edit_SearchAppIdChange(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.Edit_SearchAppIdClick(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.Edit_SearchAppIdEnter(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.Edit_SearchAppIdExit(Sender: TObject);
begin
     // DBGrid_PatientSearch.Visible:=False;
end;

procedure TFrame_AppointmentList.Edit_SearchAppIdKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TFrame_AppointmentList.Edit_SearchPatientIdChange(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.Edit_SearchPatientIdClick(Sender: TObject);
begin
     if DBGrid_PatientSearch.Visible = True then
          DBGrid_PatientSearch.Visible := false
     Else
...
procedure TFrame_AppointmentList.Edit_SearchPatientIdEnter(Sender: TObject);
begin
     // DBGrid_PatientSearch.Visible:=True;
     Query_SearchApp.Close;
     Query_SearchApp.Open;
...
procedure TFrame_AppointmentList.Edit_SearchPatientIdExit(Sender: TObject);
begin
     // DBGrid_PatientSearch.Visible:=False;
end;

procedure TFrame_AppointmentList.Edit_SearchPatientIdKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key = 13 then
     Begin
...
procedure TFrame_AppointmentList.Edit_SearchPatientNameChange(Sender: TObject);
begin
...
procedure TFrame_AppointmentList.Edit_SearchPatientNameClick(Sender: TObject);
begin
     if DBGrid_PatientSearch.Visible = True then
          DBGrid_PatientSearch.Visible := false
     Else
...
procedure TFrame_AppointmentList.Edit_SearchPatientNameEnter(Sender: TObject);
begin
     // DBGrid_PatientSearch.Visible:=True;
     Query_SearchApp.Close;
     Query_SearchApp.Open;
...
procedure TFrame_AppointmentList.Edit_SearchPatientNameExit(Sender: TObject);
begin
     // DBGrid_PatientSearch.Visible:=False;
end;

procedure TFrame_AppointmentList.Edit_SearchPatientNameKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TFrame_AppointmentList.GridColumnWidth;
begin
     with DBGrid_Appoinment do
     Begin
          Columns[0].Width := 42;
...
procedure TFrame_AppointmentList.ImgClick(Sender: TObject);
begin
     DatePopUp(DEX_AppDate,Img,'');
end;

procedure TFrame_AppointmentList.MonthlyCalendarDblClick(Sender: TObject);
begin
     CalendarClick(DateXComp);
     //DEX_AppDate.ADDateAsDate := MonthlyCalendar.Date;
     //MonthlyCalendar.Visible := false;
end;

procedure TFrame_AppointmentList.new;
begin
     //
...
procedure TFrame_AppointmentList.SpeedButton1Click(Sender: TObject);
begin
     ChangeDateSystem(DEX_AppDate, SpeedButton1);
end;

procedure TFrame_AppointmentList.DatePopUp(DateX: TDateEditX; image: TImage;
  Pos: String);
Var Dex_TodayDate : TDateEditX;
begin
     ...
     begin
          ...
          MonthlyCalendar.Date:=Dex_TodayDate.ADDateAsDate;
          DateXComp:=DateX;
          MonthlyCalendar.Visible:=true;
          //MonthlyCalendar.Parent:=Form_Apppointment;
          MonthlyCalendar.BringToFront;
          MonthlyCalendar.Parent:=DateX.Parent;
          if pos='up' then
          MonthlyCalendar.Top:=DateX.Top-153
          else
          MonthlyCalendar.Top:=DateX.Top+20;
...
procedure TFrame_AppointmentList.CalendarClick(DateX: TDateEditX);
Var
   popupdate:Tdate;
begin
