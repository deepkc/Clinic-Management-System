object Form_DoctorIncomeCorrect: TForm_DoctorIncomeCorrect
  ...
  object Query_PrevDoctor: TQuery
  ...
  object QueryDoctorBill: TQuery
    DatabaseName = 'Hospital'
    SQL.Strings = (
      'Select BillNo,BillDate,PatientId,PayType,BillType,'
      
        'Sum((Qty*Amount)+VatAmt-(Qty*Amount*Dis/100)) as TotalAmt From B' +
        'IllDetail'
      'where BillNo In (Select BillNo From BillDetail'
      
        'where DocCode=:DocCode) Group By BillNo,BillDate,PatientId,PayTy' +
        'pe,BillType'
  ...
  object Query_ActualDept: TQuery
    DatabaseName = 'Hospital'
    SQL.Strings = (
      'Select * From Department where  IsClinicalDep='#39'Y'#39
      'Order By DepName ')
