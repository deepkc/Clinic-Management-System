object Form_PackageSetup: TForm_PackageSetup
  Left = 0
  Top = 0
  Caption = 'Alternate Worklist Setup'
  ClientHeight = 487
  ClientWidth = 878
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Dblcb_Package: TDBLookupComboBox
      Left = 59
      Top = 16
      Width = 262
      Height = 21
      KeyField = 'PackageID'
      ListField = 'PackageName'
      ListSource = DS_Package
      TabOrder = 0
      OnClick = Dblcb_PackageClick
    end
  end
  object Query_Package: TQuery
