object Form_Test1: TForm_Test1
  ...
  object Query_TestName: TQuery
    ...
    SQL.Strings = (
        ...
        'Select TestNameId,TestNameCode,Trim(TestName) TestName,DepId Fro' +
        'm TestName '
      
        'where DepId In (Select DepId From Department where Ispathologica' +
        'lDep='#39'Y'#39')'
      'and IsActive='#39'Y'#39' Order by Trim(TestName)')
    Left = 304
    Top = 272
  end
