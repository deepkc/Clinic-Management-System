object Form_ReportType: TForm_ReportType
  ...
  object Query_testname: TQuery
    ...
    SQL.Strings = (
      'select testname,testnameid from testname'
      'order by testnameid')
    Left = 136
    Top = 128
  end
  object Query_Listing: TQuery
    ...
    SQL.Strings = (
        ...
        'porttypeid from testname ts,clinical_reporttype rt'
  ...
  object Query_Blank: TQuery
    ...
    SQL.Strings = (
        ...
        'select ts.testname,rt.reporttype,rt.reporttypeid from testname t' +
        's,clinical_reporttype rt'
      'where TS.TESTNAMEID=RT.TESTNAMEID')
    Left = 368
    Top = 296
  end
