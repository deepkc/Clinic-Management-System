object Form_TestNameSetupNew: TForm_TestNameSetupNew
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object BitBtn_accIntegration: TBitBtn
      Left = 423
      Top = 0
      Width = 106
      Height = 33
      ...
      TabOrder = 4
      Visible = False
      OnClick = BitBtn_accIntegrationClick
    end
  end
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            ReadOnly = True
            Title.Alignment = taCenter
            Title.Caption = 'Is Fractionable Item'
            Width = 94
            Visible = True
          end
          item
          ...
          item
            Expanded = False
            FieldName = 'SAMPLESOURCE'
            ReadOnly = True
            Title.Alignment = taCenter
            Title.Caption = 'Sample Source'
            Width = 91
            Visible = True
          end
          item
      ...
      object CB_NonTaxableItem: TCheckBox
        Left = 358
        Top = 31
        Width = 104
        Height = 17
        Caption = 'Non Taxable Item'
        TabOrder = 6
        OnClick = CB_NonTaxableItemClick
      end
      ...
      object CB_InactiveItem: TCheckBox
        Left = 358
        Top = 47
        Width = 83
        Height = 17
      ...
      object DBGrid2: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Is Discountable'
            Width = 76
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'ISTESTPRICEEDITABLE'
            Title.Alignment = taCenter
            Title.Caption = 'Is Price Editable'
            Width = 81
            Visible = True
          end
          item
            ...
            FieldName = 'ISFRACTIONABLEITEM'
            Title.Alignment = taCenter
            Title.Caption = 'Is Fractionable'
            Width = 81
            Visible = True
          end>
      end
      object CB_ISECHSITEM: TCheckBox
        Left = 471
        Top = 47
        Width = 115
        Height = 17
        Caption = 'Display ECHS Item'
        TabOrder = 8
        OnClick = CB_InactiveItemClick
      end
    end
    object TabSheet2: TTabSheet
      ...
      object Label_MultiOrgBillCatCap: TLabel
        Left = 23
        Top = 185
        Width = 92
        Height = 13
        Alignment = taRightJustify
        Caption = 'Multi Bill Category :'
        Visible = False
      end
      object Label_ECHSCap: TLabel
        Left = 773
        Top = 0
        Width = 100
        Height = 19
      ...
      object CB_IsActiveTestName: TCheckBox
        Left = 119
        Top = 33
        Width = 119
        Height = 17
        Caption = 'Is Active Test Name'
        TabOrder = 4
      end
      ...
      object DBlcb_SampleSource: TDBLookupComboBox
        ...
        Width = 207
        Height = 21
        KeyField = 'SASO_SAMPLESOURCEID'
        ListField = 'SASO_SAMPLESOURCE'
      ...
      object GroupBox2: TGroupBox
        ...
        object RB_None: TRadioButton
          ...
          Caption = 'None'
          TabOrder = 0
          OnClick = RB_NoneClick
        end
        object RB_IsOt: TRadioButton
          Left = 8
          Top = 40
          Width = 113
          Height = 17
          Caption = 'Is OT (Surgery)'
          TabOrder = 1
          OnClick = RB_IsOtClick
        end
        object RB_IsProcedure: TRadioButton
          Left = 8
          Top = 61
          Width = 113
          Height = 17
          Caption = 'Is Procedure'
          TabOrder = 2
          OnClick = RB_IsProcedureClick
        end
        object RB_IsImplant: TRadioButton
          Left = 8
          Top = 81
          Width = 113
          Height = 17
          Caption = 'Is Implant'
          TabOrder = 3
          OnClick = RB_IsImplantClick
        end
      end
      object Cb_IsPackageTestName: TCheckBox
        Left = 252
        Top = 33
        Width = 133
        Height = 17
        Caption = 'Is Package Test Name'
        TabOrder = 5
      end
      object CMBOTType: TComboBox
        Left = 541
        Top = 158
        Width = 127
        Height = 19
      ...
      object GroupBox3: TGroupBox
        ...
        object CB_AutoFormulaOn: TCheckBox
          Left = 290
          Top = 53
          Width = 252
          Height = 17
          Caption = 'Apply Formula for Other Test Price Category (F1)'
          Enabled = False
          TabOrder = 4
          Visible = False
          OnClick = CB_AutoFormulaOnClick
        end
        object CB_IsFractionableItem: TCheckBox
          Left = 8
          Top = 48
          Width = 140
          Height = 17
      ...
      object CB_Enable: TCheckBox
        ...
        Caption = 'Enable'
        TabOrder = 2
        OnClick = CB_EnableClick
      end
      object DBLCB_MultiBillCategory: TDBLookupComboBox
        Left = 119
        Top = 183
        Width = 207
        Height = 21
        KeyField = 'ORBC_ORGBILLCATEGORYCODE'
        ListField = 'ORBC_ORGBILLCATEGORY'
        ListSource = DS_MultiBillCategory
        TabOrder = 14
        Visible = False
        OnKeyDown = Dblcb_TestNameCategoryKeyDown
      end
      object CB_ECHSItem: TCheckBox
        Left = 408
        Top = 185
        Width = 88
        Height = 17
        Caption = 'Is ECHS Item'
        TabOrder = 16
        Visible = False
      end
      ...
      object DBLCB_AccheadIp: TDBLookupComboBox
        Left = 119
        Top = 240
        Width = 207
        Height = 21
        KeyField = 'Id'
        ListField = 'Name'
        ListSource = Ds_accheadIp
        TabOrder = 18
        Visible = False
        OnKeyDown = Dblcb_TestNameCategoryKeyDown
      end
      object CB_BLKInvestigation: TCheckBox
        Left = 565
        Top = 247
        Width = 104
        Height = 17
        Caption = 'BLK Investigation'
        TabOrder = 19
      end
      object CB_SpecialTest: TCheckBox
        Left = 382
        Top = 33
        Width = 97
        Height = 17
        Caption = 'Is Default Footer'
        TabOrder = 20
      end
      object CB_isBlockTest: TCheckBox
        Left = 382
        Top = 56
        Width = 97
        Height = 17
        Caption = 'Is Block Test'
        TabOrder = 21
      end
    end
  end
  ...
  object DS_Process: TDataSource
    DataSet = Query_Process
    Left = 360
  end
  object DS_TestNamePrice: TDataSource
    DataSet = TBL_TestNamePrice
    Left = 80
    Top = 392
  end
  object Query_TestPriceList: TOraQuery
    SQL.Strings = (
      
        'Select TESTNAME,TESTPRICE,VATAMT,TESTPRICE+VATAMT as TOTALPRICE,' +
        'PATIENTTYPE,ISVATABLE,ISDISCOUNTABLE,ISTESTPRICEEDITABLE,ISFRACT' +
        'IONABLEITEM,CURRENCYTYPE From VW_HS_SETUP_TESTNAMEPRICE'
      'Where TestNameId=:TestNameId'
      'Order by PATIENTTYPEORDER')
    Left = 800
    Top = 216
    ParamData = <
      item
  ...
  object DS_TestPriceList: TDataSource
    DataSet = Query_TestPriceList
    Left = 832
    Top = 208
  end
  object qry_MultiBillCategory: TOraQuery
    SQL.Strings = (
      'Select * From HS_ORBC_ORGBILLCATEGORY')
    Left = 712
    Top = 216
  end
  object DS_MultiBillCategory: TDataSource
    DataSet = qry_MultiBillCategory
    Left = 728
    Top = 224
  end
  ...
  object Query_AccountHead: TOraQuery
    SQL.Strings = (
      'Select ID,ParentId,Name From nch_acc.Acctree where ParentID=37'
      'Order by Name')
    Left = 750
    Top = 348
  end
  ...
  object Query_accheadIp: TOraQuery
    SQL.Strings = (
      'Select ID,ParentId,Name From nch_acc.Acctree where ParentID=36'
      'Order by Name')
    Left = 734
    Top = 300
  end
  object Ds_accheadIp: TDataSource
    DataSet = Query_accheadIp
    Left = 790
    Top = 300
  end
  ...
  object TBL_TestNamePrice: TTable
    Left = 48
    Top = 336
  end
