...
type
     TForm_TestNameSetupNew = class(TForm)
          Panel2: TPanel;
          BB_Save: TBitBtn;
          BB_Close: TBitBtn;
          BB_New: TBitBtn;
    ...
    BitBtn1: TBitBtn;
    BitBtn_accIntegration: TBitBtn;
    Query_Save: TOraQuery;
    CB_BLKInvestigation: TCheckBox;
    ...
    procedure BitBtn_accIntegrationClick(Sender: TObject);
     private
...
var
     Form_TestNameSetupNew: TForm_TestNameSetupNew;

implementation

uses  Unit_TNCategorySetup, Unit_TestNameSetup,
  Unit_TestNameRateChange,Unit_IntegrationSetup;

{$R *.dfm}

procedure TForm_TestNameSetupNew.BB_CloseClick(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.BB_NewClick(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.LoadTestNamePrice;
begin
     ...
     begin
          ...
          Begin
               ...
               SQL.Add(' ''N'' as ISCHARGEWITHSVRTAX, PATY_CURRENCYTYPE  CURRENCYTYPE, 0 TESTPRICE,0 VATAMT');
          ...
          begin
               ...
               Begin
                    ...
                    FieldByName('TESTPRICENEW').AsFloat:=Query_Process.FieldByName('TESTPRICE').AsFloat;
...
procedure TForm_TestNameSetupNew.BB_SaveClick(Sender: TObject);
Var
          ...
          begin
               ...
               begin
                    ...
                    SaveTestNamePrice(TBL_TestNamePrice.FieldByName('PATIENTTYPECODE').AsString,TBL_TestNamePrice.FieldByName('CURRENCYTYPE').AsString,
                              ...
                              TBL_TestNamePrice.FieldByName('TESTPRICENEW').AsFloat,TBL_TestNamePrice.FieldByName('VATAMT').AsFloat);
               end
               else
               begin
                    ...
                    Begin
                         ...
                         UpdateTestNamePrice(TBL_TestNamePrice.FieldByName('PATIENTTYPECODE').AsString,TBL_TestNamePrice.FieldByName('CURRENCYTYPE').AsString,
                    ...
                    if Trim(TBL_TestNamePrice.FieldByName('PATIENTTYPECODE').AsString)='GEN' then
                    Begin
                         UpdateFraction;
                    End;
...
procedure TForm_TestNameSetupNew.BitBtn1Click(Sender: TObject);

begin
     Form_TestNameRateChange:=TForm_TestNameRateChange.Create(Nil);
     Try
          Form_TestNameRateChange.ShowModal;
     Finally
          Form_TestNameRateChange.Free;
     End;
end;

procedure TForm_TestNameSetupNew.BitBtn_accIntegrationClick(Sender: TObject);
begin
     Form_InregrationSetup:=TForm_InregrationSetup.create(nil);
     Try
          Form_InregrationSetup.showmodal;
     Finally
          Form_InregrationSetup.Free;
     End;
end;

procedure TForm_TestNameSetupNew.Btn_ApproveClick(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.CB_AutoFormulaOnClick(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.CB_EnableClick(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.CB_GlobalSearchClick(Sender: TObject);
Var Column : TColumn;
begin
...
procedure TForm_TestNameSetupNew.CB_InactiveItemClick(Sender: TObject);
Var Column : TColumn;
begin
...
procedure TForm_TestNameSetupNew.CB_NonTaxableItemClick(Sender: TObject);
Var Column : TColumn;
begin
     With Query_list do
     Begin
...
procedure TForm_TestNameSetupNew.CMBOTTypeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key=8 then
     CMBOTType.ItemIndex:=-1;
end;

procedure TForm_TestNameSetupNew.DBEdit1Exit(Sender: TObject);
begin
     CalculateVatTaxAmt;
end;

procedure TForm_TestNameSetupNew.DBEdit1KeyPress(Sender: TObject; var Key: Char);
begin
...
Procedure TForm_TestNameSetupNew.CalculateVatTaxAmt;
Var
     lf_TestPrice,lf_TestPriceNew, lf_VatAmt: Double;
...
begin
     ...
     begin
          ...
          DatabaseName:=gs_temppath;
          SQL.Clear;
          SQL.Add(' Update TestNamePrice.db Set TestPrice='+FloatToStr(lf_TestPrice)+',');
          SQL.Add(' TestPriceNew='+FloatToStr(lf_TestPriceNew)+' ,VatAmt='+FloatToStr(lf_VatAmt));
     ...
     Begin
          ...
          begin
               ...
               DatabaseName:=gs_temppath;
               sql.Clear;
               sql.add('Select * From HS_TENP_TestNamePrice where TENP_PatientTypeCode=''GEN''');
               Open;
          end;

          lf_TestPrice:=Query_TempProcess.FieldByName('TENP_TESTPRICE').AsFloat;
...
procedure TForm_TestNameSetupNew.DBGrid1CellClick(Column: TColumn);
begin
...
procedure TForm_TestNameSetupNew.DBGrid1DblClick(Sender: TObject);
begin
     if Query_list.FieldByName('TestNameId').AsInteger <=0 then
     begin
     ...
     begin
          ...
          if FieldByName('ISSPECIALTEST').AsString='Y' then
               CB_SpecialTest.Checked:=True
          else
               CB_SpecialTest.Checked:=False;

          if FieldByName('ISBLOCKTEST').AsString='Y' then
               CB_isBlockTest.Checked:=True
          else
               CB_isBlockTest.Checked:=False;
          ...
          if FieldByName('IsBLKService').AsString = 'Y' then
               CB_BLKInvestigation.Checked := true
          else
               CB_BLKInvestigation.Checked := False;
     ...
     Begin
          ...
          {if Fieldbyname('Isfractionable').AsString='Y' then
            CB_IsFractionableItem.Checked:=True
          Else
            CB_IsFractionableItem.Checked:=False;     }
...
procedure TForm_TestNameSetupNew.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
...
procedure TForm_TestNameSetupNew.DBLCB_DepClick(Sender: TObject);
Var Column :TColumn;
begin
     if Trim(DBLCB_Dep.Text)<>'' then
     Begin
...
procedure TForm_TestNameSetupNew.Dblcb_DepNewClick(Sender: TObject);
begin
     {if pb_isnew then
          GetAutoTestNameCode;  }
end;

procedure TForm_TestNameSetupNew.DBlcb_SampleSourceKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key = 8 then
     DBlcb_SampleSource.KeyValue := -1;
end;

procedure TForm_TestNameSetupNew.Dblcb_TestNameCategoryKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key = 8 then
     Dblcb_TestNameCategory.KeyValue := -1;
end;

procedure TForm_TestNameSetupNew.Edit_SearchChange(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.FormCreate(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     if Key = VK_F1 then
...
procedure TForm_TestNameSetupNew.FormKeyPress(Sender: TObject; var Key: Char);
begin
     if Key = #13 then
          keybd_event(9, 13, 0, 0);
end;

procedure TForm_TestNameSetupNew.FormShow(Sender: TObject);
begin
     PageControl1.ActivePageIndex := 0;
     ...
     begin
          ...
          CB_BLKInvestigation.Visible :=False;
          CB_BLKInvestigation.Checked := False;
...
procedure TForm_TestNameSetupNew.CreateTableTestNamePrice;
Begin
     TBL_TestNamePrice.Close;
     IF FileExists(gs_temppath + '\TestNamePrice.db') Then
          DeleteFile(gs_temppath + '\TestNamePrice.db');
...
procedure TForm_TestNameSetupNew.LoadTestPriceCategoryRatio;
Begin
     With Query_Process do
     Begin
          Close;
...
procedure TForm_TestNameSetupNew.Le_TestPriceGKeyPress(Sender: TObject; var Key: Char);
begin
     if not(Key in [#8, '0' .. '9', '-', DecimalSeparator]) then
          Key := #0
...
procedure TForm_TestNameSetupNew.PageControl1Change(Sender: TObject);
begin
     if PageControl1.ActivePageIndex = 1 then
          PageControl1.ActivePageIndex := 0
     else
...
procedure TForm_TestNameSetupNew.RB_IsImplantClick(Sender: TObject);
begin
     DisplayOTType;
end;

procedure TForm_TestNameSetupNew.RB_IsOtClick(Sender: TObject);
begin
     DisplayOTType;
end;

procedure TForm_TestNameSetupNew.RB_IsProcedureClick(Sender: TObject);
begin
     DisplayOTType;
end;

procedure TForm_TestNameSetupNew.RB_NoneClick(Sender: TObject);
begin
     DisplayOTType;
end;

procedure TForm_TestNameSetupNew.DisplayOTType;
Begin
     if RB_IsOt.Checked=True then
     Begin
...
procedure TForm_TestNameSetupNew.SpeedButton1Click(Sender: TObject);
begin
...
procedure TForm_TestNameSetupNew.SpeedButton2Click(Sender: TObject);
Var
     DBGrid: TDBGrid;
...
begin
     ...
     Begin
          Close;
          SQL.Clear;
          SQL.add(' Select depname,testnamecode,testname,sum(generalrate)generalrate,sum(generalvatamt)generalvatamt,sum(generaltestprice)generaltestprice,');
          SQL.add('sum(SpecialRate)SpecialRate,sum(SPECIALVATAMT)SPECIALVATAMT,sum(SPECIALTESTPRICE)SPECIALTESTPRICE,');
          SQL.add('sum(PRIVATERATE)PRIVATERATE,sum(PRIVATEVATAMT)PRIVATEVATAMT,sum(PRIVATETESTPRICE)PRIVATETESTPRICE,');
          SQL.add('sum(FOREIGNERRATE)FOREIGNERRATE,sum(FOREIGNERVATAMT)FOREIGNERVATAMT,sum(FOREIGNERTESTPRICE)FOREIGNERTESTPRICE,');
          SQL.add('IsVatable,IsDiscountable,IsFractionableItem from');
          SQL.add('(Select  DepName,TestNameCode,TestName,TestPrice as GeneralRate,VATAMT as GeneralVatAmt,TOTALPRICE As GeneralTestPrice,');
          SQL.add('0 as Specialrate, 0 as Specialvatamt,0 as SpecialTestPrice,0 as Privaterate,0 as Privatevatamt,0 as PrivateTestPrice,');
          SQL.add('0 as ForeignerRate,0 as ForeignerVatamt,0 as ForeignerTestPrice,');
          SQL.add('IsVatable,IsDiscountable,IsFractionableItem From VW_HS_SETUP_TESTNAMEPRICE where  ISActive=''Y''');
          SQL.add('and PATIENTTYPECODE=''GEN''');
          if DBLCB_Dep.KeyValue <> NULL then
               SQL.add(' and DepId=' + IntToStr(DBLCB_Dep.KeyValue));
          SQL.add('UNION');
          SQL.add('Select  DepName,TestNameCode,TestName,0 as GeneralRate,0 as GeneralVatAmt,0 As GeneralTestPrice,');
          SQL.add('TestPrice as Specialrate,VATAMT as Specialvatamt,TOTALPRICE as SpecialTestPrice,');
          SQL.add('0 as Privaterate,0 as Privatevatamt,0 as PrivateTestPrice,');
          SQL.add('0 as ForeignerRate,0 as ForeignerVatamt,0 as ForeignerTestPrice,');
          SQL.add('IsVatable,IsDiscountable,IsFractionableItem From VW_HS_SETUP_TESTNAMEPRICE where  ISActive=''Y''');
          SQL.add('and PATIENTTYPECODE=''SPC''');
          if DBLCB_Dep.KeyValue <> NULL then
               SQL.add(' and DepId=' + IntToStr(DBLCB_Dep.KeyValue));
          SQL.add('UNION');
          SQL.add('Select  DepName,TestNameCode,TestName,0 as GeneralRate,0 as GeneralVatAmt,0 As GeneralTestPrice,');
          SQL.add('0 as Specialrate,0 as Specialvatamt,0 as SpecialTestPrice,');
          SQL.add('TestPrice as Privaterate,VATAMT as Privatevatamt,TOTALPRICE as PrivateTestPrice,');
          SQL.add('0 as ForeignerRate,0 as ForeignerVatamt,0 as ForeignerTestPrice,');
          SQL.add('IsVatable,IsDiscountable,IsFractionableItem From VW_HS_SETUP_TESTNAMEPRICE where  ISActive=''Y''');
          SQL.add('and PATIENTTYPECODE=''PVT''');
          if DBLCB_Dep.KeyValue <> NULL then
               SQL.add(' and DepId=' + IntToStr(DBLCB_Dep.KeyValue));
          SQL.add('UNION');
          SQL.add('Select  DepName,TestNameCode,TestName,0 as GeneralRate,0 as GeneralVatAmt,0 As GeneralTestPrice,');
          SQL.add('0 as Specialrate,0 as Specialvatamt,0 as SpecialTestPrice,');
          SQL.add('0 as Privaterate,0 as Privatevatamt,0 as PrivateTestPrice,');
          SQL.add('TestPrice as ForeignerRate,VATAMT as ForeignerVatamt,TOTALPRICE as ForeignerTestPrice,');
          SQL.add('IsVatable,IsDiscountable,IsFractionableItem From VW_HS_SETUP_TESTNAMEPRICE where  ISActive=''Y''');
          SQL.add('and PATIENTTYPECODE=''FRG''');
          if DBLCB_Dep.KeyValue <> NULL then
               SQL.add(' and DepId=' + IntToStr(DBLCB_Dep.KeyValue));
          SQL.add(')Group by DepName,TestName,IsVatable,IsDiscountable,IsFractionableItem,testnamecode');
     ...
     begin
          ExportDBGrid(Form_TestNameSetupNew, DBGrid, true, ls_ReportTitle, TodaysDateVS + ' BS -' + TodaysDate + ' AD');
     end;
end;

procedure TForm_TestNameSetupNew.SpeedButtonEduClick(Sender: TObject);
begin
     try
...
procedure TForm_TestNameSetupNew.UpdateFraction;
var lf_fractionamount:Double;
begin
     with Query_process do
     Begin
          close;
          Session:= DM_Hospital.DB;
          sql.clear;
          sql.Add('Select frac_fractionid,FRAC_FRACTIONRATE from hs_frac_fraction where frac_testnameid='+inttostr(pi_TestNameId));
          sql.Add('and frac_israteamt=''R''');
          Open;
          if FieldByName('Frac_fractionrate').AsFloat>0 then
          Begin
               lf_fractionamount:=(FieldByName('Frac_fractionrate').AsFloat*TBL_TestNamePrice.FieldByName('TESTPRICENEW').AsFloat)/100;
               with Query_save do
               Begin
                    Close;
                    Session:= DM_Hospital.DB;
                    Sql.Clear;
                    sql.Add('Update hs_frac_fraction set FRAC_FRACTIONAMOUNT='+floattostr(lf_fractionamount));
                    sql.Add('Where frac_fractionid='+inttostr(Query_process.FieldByName('frac_fractionid').asInteger));
                    ExecSql;
               End;
               With Query_tempprocess do
               Begin
                    ...
                    Sql.Clear;
                    sql.Add('select POWF_POSITIONWISEFRACTIONID,POWF_FRACTIONID,POWF_FRACTIONAMOUNT,POWF_FRACTIONRATE from hs_powf_positionwisefraction');
                    sql.Add('Where powf_fractionid='+inttostr(Query_process.FieldByName('frac_fractionid').asInteger));
                    Open;
                    first;
                    while not eof do
                    Begin
                         lf_fractionamount:=(Query_tempprocess.FieldByName('POWF_FRACTIONRATE').AsFloat*TBL_TestNamePrice.FieldByName('TESTPRICENEW').AsFloat)/100;
                         with Query_save do
                         Begin
                              close;
                              databasename:=gs_databasename;
                              sql.Clear;
                              sql.Add('Update hs_powf_positionwisefraction set powf_fractionamount='+Floattostr(lf_fractionamount));
                              sql.Add('where powf_positionwisefractionid='+inttostr(query_tempprocess.FieldByName('POWF_POSITIONWISEFRACTIONID').AsInteger));
                              ExecSql;
                         End;
                         next;
                    End;
...
procedure TForm_TestNameSetupNew.GetAutoTestNameCode;
Var
