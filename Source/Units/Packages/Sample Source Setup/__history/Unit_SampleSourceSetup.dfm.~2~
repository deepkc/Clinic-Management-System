object Form_SampleSourceSetup: TForm_SampleSourceSetup
  Left = 0
  Top = 0
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object le_SampleSource: TLabeledEdit
        Left = 117
        Top = 38
        Width = 284
        Height = 21
        EditLabel.Width = 77
        EditLabel.Height = 13
        EditLabel.Caption = 'Sample Source :'
  ...
  object Query_list: TOraQuery
    SQL.Strings = (
      'SELECT ROWNUM AS SN,SS.* FROM lb_saso_SAMPLESOURCE SS')
    Left = 232
    Top = 208
  end
