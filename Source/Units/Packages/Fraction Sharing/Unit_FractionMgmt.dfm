object Form_FractionMgmt: TForm_FractionMgmt
  Left = 297
  Top = 111
  ...
  object PC_BillDisplay: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object DateEditX_FromBillView: TDateEditX
        ...
        TabOrder = 0
        ControlData = {
          545046300A5444617465456469745200044C65667403410103546F7002070577
      ...
      object DateEditX_ToBillView: TDateEditX
        ...
        TabOrder = 1
        ControlData = {
          545046300A5444617465456469745200044C65667403410103546F70021E0577
          69647468025D0B4461746541442E5965617203D6070C4461746541442E4D6F6E
          746802010A4461746541442E44617902180B4461746556532E59656172030E08
          0C4461746556532E4D6F6E7468020A0A4461746556532E446179020B0000}
      end
      ...
      object DateEditX_TodayDate: TDateEditX
        ...
        ControlData = {
          ...
          740B466F6E742E48656967687402F509466F6E742E4E616D6506065461686F6D
          610A466F6E742E5374796C650B000A506172656E74466F6E74080000}
      end
      ...
      object DBLCB_TestName: TDBLookupComboBox
        ...
        ListField = 'tena_TESTNAMECODE;tena_TESTNAME'
        ListFieldIndex = 1
    ...
    object TS_Investigation: TTabSheet
        ...
        object TS_OperationCase: TTabSheet
          ...
          object DateEditX_AdjFrctDate: TDateEditX
            ...
            ControlData = {
              ...
              0C4461746556532E4D6F6E746802050A4461746556532E44617902110C466F6E
      ...
      object DateEditXIPDate: TDateEditX
        ...
        ControlData = {
          ...
          
          08526561644F6E6C79090000}
      end
  ...
  object Query_Doctor: TOraQuery
    SQL.Strings = (
        ...
        'e From '
      'hs_doct_Doctor Order By doct_DocName')
    Left = 564
    Top = 184
  end
  ...
  object QryTestName: TOraQuery
    SQL.Strings = (
        ...
        'Select Distinct TN.tena_TestNameId,TN.tena_DepId,TN.tena_TestNam' +
        'eCode,TN.tena_TestName From hs_frac_Fraction F,'
  ...
  object Query_GetBillList: TOraQuery
    SQL.Strings = (
        ...
        'Select bide_BillNo,bide_BillDATE,bide_BillTime,bide_PatientId,bi' +
        'de_PayType,bide_RateType,(Select pama_Title||'#39' '#39'||pama_PatientNa' +
        'me From hs_pama_PatientMain where pama_PatientId=hs_bide_BillDet' +
        'ail.bide_PatientId) as Name,'
      
        'Sum(bide_qty*bide_Amount) as Amount,sum((bide_qty*bide_Amount)*(' +
        'bide_Disper/100)) as Discount,Sum(bide_VatAmt) as SvrTax '
      
        ',Sum(((bide_Qty*bide_Amount)+bide_VatAmt)-(bide_Qty*bide_Amount*' +
        'bide_Disper/100)) as NetTotal'
      
        'From hs_bide_BillDetail Where (bide_BillType='#39'B'#39' OR bide_BillTyp' +
        'e='#39'O'#39') and '
      '(bide_BillDate>=:FromDate AND bide_BillDate<=:ToDate) '
      ''
      ''
      
        'Group by bide_BillNo,bide_BillDATE,bide_BillTime,bide_PatientId,' +
        'bide_PayType,bide_RateType order by bide_BillDate,bide_billNo')
    Left = 132
    Top = 271
    ParamData = <
      item
  ...
  object Query_PatientInfo: TOraQuery
    SQL.Strings = (
        ...
        'Select IPR.PatientId,IPR.InpatientId,IPR.InptDate,IPR.DisDate,IP' +
        'R.CommunityId,IPR.SchemeId,MemberNo,DisInDeposit,'
      
        '(Select PatientName From PatientMain where PatientId=IPR.Patient' +
        'Id) as PtName,DisInDeposit,Discharged,'
      
        '(Select SchemeName From Scheme where SchemeId=IPR.SchemeId) as S' +
        'cheme,DisInDepositDate'
  ...
  object Query_TestName: TOraQuery
    SQL.Strings = (
        ...
        'Select * From hs_tena_Testname where tena_IsActive='#39'Y'#39' Order By ' +
        'tena_TestName')
    Left = 492
    Top = 160
  end
