unit Unit_QRDischargeBill_Manipal;

interface

uses
     Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
     Dialogs, QRCtrls, qrBarcode, QuickRpt, ExtCtrls, DB, DBTables, Fxn_hos,
     Serverdate, dm, InWordsSu, Unit_Master_hos, pngimage,Ora, OraSmart, MemDS,
  DBAccess;

type
     TForm_QRDischargeBill_Manipal = class(TForm)
    ...
    QRLabel_TaxSystemCap: TQRLabel;
          ...
          QRLabel50: TQRLabel;
          lbl_Scheme: TQRLabel;
          Query_DischargeBill: TQuery;
    Query_TaxableTotal: TQuery;
          QRLabel12: TQRLabel;
...
var
     Form_QRDischargeBill_Manipal: TForm_QRDischargeBill_Manipal;

implementation

{$R *.dfm}

procedure TForm_QRDischargeBill_Manipal.lbl_headNamePrint(sender: TObject; var Value: string);
begin
     pi_Sno:=0;
...
procedure TForm_QRDischargeBill_Manipal.Lbl_HosNoPrint(sender: TObject; var Value: string);
begin
     pi_Sno:=0;
end;

procedure TForm_QRDischargeBill_Manipal.lbl_SchemePrint(sender: TObject; var Value: string);
begin
     if Length(Trim(Value)) = 0 then
          Value := 'N/A';
end;

Procedure TForm_QRDischargeBill_Manipal.LoadPatientInfo;
Var
     Qry: ToraQuery;
     ls_RefBillNo : String;
...
procedure TForm_QRDischargeBill_Manipal.QRDBText1Print(sender: TObject; var Value: string);
begin
...
procedure TForm_QRDischargeBill_Manipal.QRDBText2Print(sender: TObject; var Value: string);
begin
     pi_Sno := pi_Sno + 1;
...
procedure TForm_QRDischargeBill_Manipal.QRDBText3Print(sender: TObject; var Value: string);
begin
...
procedure TForm_QRDischargeBill_Manipal.QRDBText7Print(sender: TObject; var Value: string);
begin
...
procedure TForm_QRDischargeBill_Manipal.QRLabel70Print(sender: TObject; var Value: string);
begin
...
procedure TForm_QRDischargeBill_Manipal.QRLabel_HosAddressPrint(sender: TObject; var Value: string);
begin
     if gb_BillPrintInPrintedPaper=False then
...
procedure TForm_QRDischargeBill_Manipal.QRLabel_HosSloganTitlePrint(sender: TObject; var Value: string);
begin
     if gb_BillPrintInPrintedPaper=False then
     Begin
...
procedure TForm_QRDischargeBill_Manipal.QRLabel74Print(sender: TObject; var Value: string);
begin
     if gb_BillPrintInPrintedPaper=False then
     Value:=gs_TPINNOBill
     else
...
procedure TForm_QRDischargeBill_Manipal.QRLabel_PhoneNoPrint(sender: TObject; var Value: string);
begin
     (*if gb_BillPrintInPrintedPaper=False then
...
procedure TForm_QRDischargeBill_Manipal.Qr_DischargeBillAfterPrint(Sender: TObject);
begin
...
procedure TForm_QRDischargeBill_Manipal.Qr_DischargeBillBeforePrint(Sender: TCustomQuickRep; var PrintReport: Boolean);
var
...
Procedure TForm_QRDischargeBill_Manipal.BillHeaderInfo;
begin
