object Form_BloodBagRefund: TForm_BloodBagRefund
  Left = 416
  Top = 198
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PC_CommunityRefundEntry: TPageControl
    Left = 0
    Top = 39
    Width = 1061
    Height = 424
    ...
    object TabSheet1: TTabSheet
      ...
      object CmbCommunity: TDBLookupComboBox
        ...
        OnKeyPress = CmbCommunityKeyPress
      end
      ...
      object DateEditXRefundDate: TDateEditX
        ...
        TabOrder = 2
        ControlData = {
          
          644F6E6C79090000}
      end
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object DEX_Today: TDateEditX
          ...
          TabOrder = 3
          ControlData = {
            
            ...
            0A466F6E742E5374796C650B000A506172656E74466F6E740808526561644F6E
            6C79090000}
        end
        ...
        object DateEditX_To: TDateEditX
          ...
          TabOrder = 5
          ControlData = {
            545046300A5444617465456469745200044C65667403D30203546F70022C0577
        ...
        object DateEditX_From: TDateEditX
          ...
          TabOrder = 6
          ControlData = {
            545046300A5444617465456469745200044C65667403D30203546F7002150577
            69647468025A0B4461746541442E5965617203D3070C4461746541442E4D6F6E
            7468020B0A4461746541442E44617902030B4461746556532E59656172030C08
            0C4461746556532E4D6F6E746802070A4461746556532E44617902110000}
        end
  ...
  object Panel3: TPanel
    ...
    object QueryIPInfo: TOraQuery
    SQL.Strings = (
            
              'Select PM.Title||'#39' '#39'||PM.PatientName as Name,PM.DistrictName,PM.' +
              'VdcName,'
            
              'PM.PAddress,PM.WardNo,D.DepId,IPR.CommunityId,PM.Age||'#39' -'#39'||SubS' +
              'tr(PM.AgeType,1,1)||'#39'  / '#39'||SubStr(PM.Gender,1,1) as AgeSex,'
            
              'IPR.MemberNo,IPR.Discharged,IPR.DisDate,IPR.PatientId,IPR.InPati' +
              'entId'
            
              'From InpatientReg IPR,PatientMain PM,Department D where IPR.DepC' +
              'ode=D.DepCode and '
            'IPR.PatientId=PM.PatientId and IPR.InpatientId=:InpatientId'
            ' ')
    Left = 834
    Top = 296
    ParamData = <
  ...
  object Query_Community: TOraQuery
    SQL.Strings = (
              ...
              'ityId CommunityId From HS_SCHE_Scheme'
...
object DataSource_Community: TDataSource
    ...
    object QueryOPInfo: TOraQuery
    SQL.Strings = (
            'Select PatientId,Title||'#39' '#39'||FName||'#39' '#39'||LName as Name,'
            'MemberNo From PatientMain where PatientId=:PatientId')
    Left = 761
    Top = 296
    ParamData = <
            item
  ...
  object QueryName: TOraQuery
    SQL.Strings = (
              ...
              'Select (PM.Title || PM.FName ||'#39' '#39'|| PM.LName) as Name ,PM.Patie' +
              'ntId,PM.InPatientId,'
            
              'PM.Age||'#39' -'#39'||SubStr(PM.AgeType,1,1)||'#39'  / '#39'||SubStr(PM.Gender,1' +
              ',1) as AgeSex,'
            'PM.DepCode,PM.Paddress,PM.VdcName,PM.DistrictName,PM.MemberNo'
            ',PM.VDCName,PM.Remarks,PM.WardNo From PatientMain PM'
            'where (PM.patientID=:PatientId)'
            'order by PM.Patientid'
            ''
            ' ')
    Left = 960
    Top = 215
    ...
    object QueryNameNAME: TStringField
      FieldName = 'NAME'
      Size = 83
    end
    object QueryNamePATIENTID: TFloatField
      FieldName = 'PATIENTID'
    end
    object QueryNamePADDRESS: TStringField
      FieldName = 'PADDRESS'
      Size = 100
    end
    object QueryNameDISTRICTNAME: TStringField
      FieldName = 'DISTRICTNAME'
      Size = 70
    end
    object QueryNameDEPCODE: TStringField
      FieldName = 'DEPCODE'
      Size = 5
    end
    object QueryNameVDCNAME: TStringField
      FieldName = 'VDCNAME'
      Size = 70
    end
    object QueryNameREMARKS: TStringField
      FieldName = 'REMARKS'
      Size = 30
    end
    object QueryNameMEMBERNO: TStringField
      FieldName = 'MEMBERNO'
      Size = 8
    end
    object QueryNameWARDNO: TFloatField
      FieldName = 'WARDNO'
    end
    object QueryNameINPATIENTID: TFloatField
      FieldName = 'INPATIENTID'
    end
    object QueryNameAGESEX: TStringField
      FieldName = 'AGESEX'
      Size = 11
    end
  end
