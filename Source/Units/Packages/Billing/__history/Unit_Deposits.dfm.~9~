object Form_Deposits: TForm_Deposits
  Left = 0
  Top = 0
  Caption = 'Deposits'
  ClientHeight = 576
  ...
  object Panel1: TPanel
    ...
    object CB_OLDDeposit: TCheckBox
      Left = 789
      Top = 211
      Width = 87
      Height = 17
  ...
  object Panel3: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'DEPO_DEPOSITTYPE'
          Title.Caption = 'Deposit Type'
          Visible = True
        end
        item
          Expanded = False
  ...
  object Query_List: TOraQuery
    SQL.Strings = (
        ...
        'Select DP.*,(Select UserName From Lab_UserMain where UserId=DEPO' +
        '_DepositBy) as DepositBy from HS_DEPO_Deposit DP'
      'Where 1=1'
      'and NVL(Trim(DEPO_DEPOSITTYPE),'#39'NA'#39')<>'#39'DIS ADJ DEP REFUND'#39
      'Order by DEPO_DEPOSITDATE DESC')
    Left = 352
    Top = 296
  end
  ...
  object OraQueryCheck: TOraQuery
    Left = 224
    Top = 8
  end
end
