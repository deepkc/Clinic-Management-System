object Form_otherPatient: TForm_otherPatient
  Left = 0
  Top = 0
  Caption = 'Other Patient Information'
  ClientHeight = 427
  ClientWidth = 373
  Color = clBtnFace
  ...
  object GB_BasicInformation: TGroupBox
    ...
    object SPB_RegDate: TSpeedButton
      Left = 326
      Top = 8
      Width = 23
      Height = 22
      Caption = 'AD'
      OnClick = SPB_RegDateClick
    end
    ...
    object DEX_RegDate: TDateEditX
      ...
      TabOrder = 0
      ControlData = {
        545046300A5444617465456469745200044C65667403040103546F7002090B44
    ...
    object Dex_Dob: TDateEditX
      ...
      OnExit = Dex_DobExit
      ControlData = {
        545046300A5444617465456469745200044C656674030B0103546F700390000B
        4461746541442E5965617203DB070C4461746541442E4D6F6E746802090A4461
        746541442E44617902160B4461746556532E596561720314080C446174655653
        2E4D6F6E746802060A4461746556532E44617902050000}
    end
  ...
  object QueryVDC: TOraQuery
    SQL.Strings = (
      'Select VDCMCPTID VDCID,H.* from HS_VDCMCPT h'
      'Order by VDCName ')
    Left = 8
    Top = 264
  end
  object QueryTitle: TOraQuery
    SQL.Strings = (
        ...
        'Select TITL_TITLEID TITLEID,TITL_TITLENAME TITLE from HS_Titl_TI' +
        'TLE')
    Left = 8
    Top = 88
  end
