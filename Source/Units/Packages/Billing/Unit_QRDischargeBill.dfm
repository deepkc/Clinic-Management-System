object Form_QRDischargeBill: TForm_QRDischargeBill
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object Qr_DischargeBill: TQuickRep
    Left = 25
    Top = 44
    Width = 922
    Height = 700
    ...
    Page.Values = (
      ...
      1852.100000000000000000
      50.000000000000000000
      2439.500000000000000000
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = True
      Master = Qr_DischargeBill
      DataSet = Query_DischargeBill
    ...
    object GroupFooterBand1: TQRBand
      ...
      object lbl_TaxableTotal: TQRLabel
        Left = 654
        Top = 46
        Width = 77
        Height = 17
      ...
      object lbl_NonTaxableTotal: TQRLabel
        Left = 654
        Top = 83
        Width = 77
        Height = 17
      ...
      object Lbl_BalanceCap: TQRLabel
        Left = 527
        Top = 169
        Width = 113
        Height = 17
      ...
      object Lbl_BalanceAfterRefund: TQRLabel
        Left = 654
        Top = 169
        Width = 77
        Height = 17
    ...
    object lbl_Consultant: TQRLabel
      Left = 76
      Top = 249
      Width = 61
      Height = 17
  ...
  object Query_DischargeBill: TQuery
    DatabaseName = 'D:\Midas Dr. Homs V 4.0\Bin\Temp'
    SQL.Strings = (
      
        'Select PaymentCategory,Sum(Total) as Total From FinalDischargeBi' +
        'll'
  ...
  object Query_TaxableTotal: TQuery
    DatabaseName = 'D:\Midas Dr. Homs V 4.0\Bin\Temp'
    SQL.Strings = (
      
        'Select Sum(Total) as Total,Sum(TaxAmt) as TaxAmt,Sum(Discount) a' +
        's Discount,Sum(NetTotal) as NetTotal'
      'From FinalDischargeBill where IsTaxable='#39'Y'#39)
    Left = 288
    Top = 432
  end
  ...
  object Query_NoTaxableTotal: TQuery
    DatabaseName = 'D:\Midas Dr. Homs V 4.0\Bin\Temp'
    SQL.Strings = (
      
        'Select Sum(Total) as Total,Sum(TaxAmt) as TaxAmt,Sum(Discount) a' +
        's Discount,Sum(NetTotal) as NetTotal'
      'From FinalDischargeBill where IsTaxable='#39'N'#39
      '')
    Left = 160
    Top = 432
  end
