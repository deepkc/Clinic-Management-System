object Form_ServiceAcknowledge: TForm_ServiceAcknowledge
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    object CB_NoDeposit: TCheckBox
      Left = 686
      Top = 6
      Width = 115
      Height = 17
      Caption = 'Dont Check Deposit'
      TabOrder = 1
    end
  end
  ...
  object Ds_List: TDataSource
    ...
    object Table_ServiceAcknowledge: TOraTable
    Left = 256
    Top = 296
  end
end
