...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,Fxn_Hos,
...
begin
     ...
     Lbl_InvDateBS.Caption := '( '+ADToVSS(Copy(GetBillDate(Gs_BillNo),1,10))+' AD )'
     Else
     Lbl_InvDateBS.Caption := '( '+VSTOADS(Copy(GetBillDate(Gs_BillNo),1,10))+' BD )';
