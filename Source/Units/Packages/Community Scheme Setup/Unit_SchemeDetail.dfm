object Form_SchemeDetail: TForm_SchemeDetail
  Left = 0
  Top = 0
    ...
    object TabSheet1: TTabSheet
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'BenefitPackage'
            Title.Caption = 'Benefit Package Name'
            Width = 229
            Visible = True
          end
          item
    ...
    object TabSheet2: TTabSheet
      ...
      object DBGrid2: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'IPDISCOUNT1'
            Title.Caption = 'IP Discount [%]'
            Visible = False
          end>
      end
  ...
  object Table_SchemeDetail: TTable
    Left = 496
    Top = 320
  end
  object Query_List: TQuery
    SQL.Strings = (
      'select  *  from schemeDetail')
    Left = 632
    Top = 248
  end
end
