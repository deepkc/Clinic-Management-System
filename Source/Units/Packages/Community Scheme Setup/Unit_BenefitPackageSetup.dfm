object Form_BenefitPackageSetup: TForm_BenefitPackageSetup
  Left = 0
  Top = 0
  Caption = 'Benefit Package Setup'
  ClientHeight = 359
  ClientWidth = 481
  Color = clBtnFace
