object Form_QRReportBillDepWise: TForm_QRReportBillDepWise
  Left = 309
  Top = 117
  Caption = 'Form_QRReportBillDepWise'
  ClientHeight = 573
  ClientWidth = 835
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroupTop: TQRGroup
      ...
      KeepOnOnePage = False
      Expression = 'QueryDetail.DEPName'
  ...
  object QueryDetail: TOraQuery
    SQL.Strings = (
        ...
        'Select DepName,PatientId as HospNo,0 InpatientId,PayType,BillNo,' +
        'BillDate,BillBy UserName,TestName ServiceType,Sum(SubTotal) as A' +
        'mount,Sum(Discount) as Discount,'
      
        '              Sum(SubTotal) as SubTotal,Sum(SvrTax) as VatAmt,Su' +
        'm(NetTotal) as NetAmount '
      '              From VW_HS_DEPTTESTWISE_DETAIL'
      '              where Billdate='#39'2014/09/10'#39
      
        '              Group BY DepName,PatientId,PayType,BillNo,BillDate' +
        ',BillBy,TestName Order By DepName,PayType,BillNo')
