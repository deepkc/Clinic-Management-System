object Form_QRSchemeWiseRevenueDetail: TForm_QRSchemeWiseRevenueDetail
  Left = 0
  Top = 0
  Caption = 'Form_QRSchemeWiseRevenueDetail'
  ClientHeight = 543
  ClientWidth = 833
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabelReportTitle: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'COMMUNITY/SCHEME WISE REVENUE DETAIL'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
    ...
    object GroupFooterBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'Sum(Query_Data.Amount)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      end
