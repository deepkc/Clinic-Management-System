unit Unit_PendingForReultEntry;
...
type
  TForm_PendingForResultEntry = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_PendingForResultEntry: TForm_PendingForResultEntry;

implementation
       uses Unit_qrPendingForResultEntry,UnitSendToExcel;
{$R *.dfm}

procedure TForm_PendingForResultEntry.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_PendingForResultEntry.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrPendingForResultEntry do
     begin
...
procedure TForm_PendingForResultEntry.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_PendingForResultEntry.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_PendingForResultEntry.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_PendingForResultEntry.DBLCB_DepartmentClick(
  Sender: TObject);
begin
     ...
     begin
          ...
          Session:=DM_Hospital.DB;
          sql.Clear;
          SQL.Add('Select * From hs_tena_TestName tena_Where DepId ='+IntToStr(dblcb_department.KeyValue));
...
procedure TForm_PendingForResultEntry.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrPendingForResultEntry,Form_qrPendingForResultEntry);
end;

procedure TForm_PendingForResultEntry.FormDestroy(Sender: TObject);
begin
     Form_qrPendingForResultEntry.Free;
end;

procedure TForm_PendingForResultEntry.FormKeyDown(Sender: TObject;
...
procedure TForm_PendingForResultEntry.FormShow(Sender: TObject);
begin
...
procedure TForm_PendingForResultEntry.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_PendingForResultEntry.SpeedButton2Click(
  Sender: TObject);
begin
