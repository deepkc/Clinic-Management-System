unit Unit_VerifiedSampleReport;
...
type
  TForm_VerifiedSampleReport = class(TForm)
    Panel_Main: TPanel;
...
var
  Form_VerifiedSampleReport: TForm_VerifiedSampleReport;

implementation
       uses Unit_qrVerifiedSampleReport,UnitSendToExcel;
{$R *.dfm}

procedure TForm_VerifiedSampleReport.BitBtn_CloseClick(
  Sender: TObject);
begin
     Close;
end;

procedure TForm_VerifiedSampleReport.BitBtn_PreviewClick(
  Sender: TObject);
begin
     with Form_qrverifiedSampleReport do
     begin
...
procedure TForm_VerifiedSampleReport.BitBtn_SendToExcelClick(
  Sender: TObject);
begin
...
procedure TForm_VerifiedSampleReport.CheckBox_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_VerifiedSampleReport.CheckBox_TestClick(
  Sender: TObject);
begin
...
procedure TForm_VerifiedSampleReport.DBLCB_DepartmentClick(
  Sender: TObject);
begin
...
procedure TForm_VerifiedSampleReport.FormCreate(Sender: TObject);
begin
     Application.CreateForm(TForm_qrverifiedSampleReport,Form_qrverifiedSampleReport);
end;

procedure TForm_VerifiedSampleReport.FormDestroy(Sender: TObject);
begin
     Form_qrverifiedSampleReport.Free;
end;

procedure TForm_VerifiedSampleReport.FormKeyDown(Sender: TObject;
...
procedure TForm_VerifiedSampleReport.FormShow(Sender: TObject);
begin
...
procedure TForm_VerifiedSampleReport.SpeedButton1Click(
  Sender: TObject);
begin
     ChangeDateSystem(DateEditX1,SpeedButton1);
end;

procedure TForm_VerifiedSampleReport.SpeedButton2Click(
  Sender: TObject);
begin
