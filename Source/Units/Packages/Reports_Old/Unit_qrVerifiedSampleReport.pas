unit Unit_qrVerifiedSampleReport;
...
type
  TForm_qrVerifiedSampleReport = class(TForm)
...
var
  Form_qrVerifiedSampleReport: TForm_qrVerifiedSampleReport;

implementation

{$R *.dfm}

procedure TForm_qrVerifiedSampleReport.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrVerifiedSampleReport.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
