unit Unit_qrPendingForAuthentication;
...
type
  TForm_qrPendingForAuthentication = class(TForm)
...
var
  Form_qrPendingForAuthentication: TForm_qrPendingForAuthentication;

implementation

{$R *.dfm}

procedure TForm_qrPendingForAuthentication.lbl_hosaddressPrint(
  sender: TObject; var Value: string);
begin
     Value:=gs_HospitalAddress;
end;

procedure TForm_qrPendingForAuthentication.lbl_hosnamePrint(
  sender: TObject; var Value: string);
begin
