object Form_TestNameSetup: TForm_TestNameSetup
  ...
  object Query_list: TQuery
    ...
    SQL.Strings = (
        ...
        'DEPID,TN.TESTNAME,to_number(TO_CHAR(TN.TESTPRICE,'#39'99999990D00'#39'))' +
        'TESTPRICE'
      
        ',TO_NUMBER(TO_CHAR(TN.VAT,'#39'99999990D00'#39'))VAT,TN.ISVATABLE,TN.ISE' +
        'DITABLE,TN.ISACTIVE,TN.ISOT,TN.TESTPRICEFOREIGNER ,TN.TNCATEGORY' +
        'CODE,TN.ISDISCOUNTABLE,TN.REMARKS,TN.TAXFRG,TN.ISPACKAGETEST,TN.' +
        'ISFRACTIONABLEITEM'
      
        ',TN.DATAPOSTBY,TN.DATAPOSTDATE,TN.DATAPOSTTIME,TN.WORKLIST,TN.SA' +
        'MPLESOURCEID,TN.DISPLAYORDER,TN.HIDETESTINPATIENTLIST'
