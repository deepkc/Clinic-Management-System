object Form_StaffDepSetup: TForm_StaffDepSetup
  Left = 0
  Top = 0
  Caption = 'Staff Department Setup'
  ClientHeight = 224
  ClientWidth = 339
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'StaffDepartment'
          Title.Caption = 'Staff Department'
          Width = 143
          Visible = True
        end>
    end
