...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,fxn,Unit_Master,
  Dialogs, Grids,Dm, DBGrids, StdCtrls, Buttons, ExtCtrls, DB, DBTables, DBAccess, Ora, OraSmart, MemDS, OraError;
...
begin
     ...
     begin
          ...
          begin
               ...
               sql.Clear;
               sql.Add('Insert into staffdepartment(staffdepartmentId,staffdepartment) values');
               sql.Add('('+Inttostr(GetMaxId('staffdepartment','staffdepartmentId'))+','+#39+Edit_UserDep.Text+#39);
               sql.Add(')');
               ExecSQL;
          end;
     end
