unit Unit_MasterReportPrevilage;
...
type
     TForm_MasterReportPrevilege = class(TForm)
...
var
     Form_MasterReportPrevilege: TForm_MasterReportPrevilege;
...
procedure TForm_MasterReportPrevilege.BB_ExitClick(Sender: TObject);
begin
     close;
end;

procedure TForm_MasterReportPrevilege.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
     IF (Key = VK_F12) Then
          BB_OKClick(Sender);
     if Key = 27 then
...
procedure TForm_MasterReportPrevilege.FormShow(Sender: TObject);
var
...
procedure TForm_MasterReportPrevilege.AddMyChilds(MyId: Integer; MyNode: TTreeNode);
var
    ...
    if not MyNode.HasChildren then
     begin
          ...
          begin
               ...
               sql.Clear;
               sql.Add(' select * from hs_uasm_useraccesssubmenu order by uasm_SUBMENUID ');
               Open;

               First;
               while not EOF do
               begin
                         ls_childNode :='1'+'.'+ FieldByName('uasm_SUBMENUID')
                           .AsString + '- ' + FieldByName('uasm_captionname').AsString;
     ...
     begin
          ...
          begin
               ...
               begin
                    ...
                    sql.Clear;
                    sql.Add
                      (' SELECT * FROM hs_rome_rootmenu WHERE rome_SUBMENUID = '
                           + IntToStr(li_childId));
                    SQL.Add(' order by rome_SUBMENUID');
                    ...
                    begin
                          ...
                          ls_childNode := '2'+'.'+FieldByName('rome_ROOTMENUID')
                                .AsString + '- ' + FieldByName('rome_captionname').AsString;
              ...
              //childnode.StateIndex:=2;
               ...
               begin
                    ...
                    Session:=DM_Hospital.DB;
                    sql.Clear;
                    sql.Add('select * from hs_hoac_hospitalaccess');
                    Sql.Add('where hoac_HOSPITALID='+inttostr(pi_hospitalid));
                   ...
                   while not Query_checkbox.eof do
                    ...
                    begin
                         if Childnode.text=FieldByName('hoac_nodetext').AsString then
                         begin
                              Childnode.StateIndex:=2;
          ...
          selnode.StateIndex:=1;
           ...
           begin
              ...
              while not Query_checkbox.eof do
               //for j := 0 to Query_checkbox.RecordCount - 1 do
               begin
                    if SelNode.text=FieldByName('hoac_nodetext').AsString then
                    begin
...
procedure TForm_MasterReportPrevilege.AddMyGrandChilds(ChildId: Integer; ChildNode: TTreeNode);
var
...
procedure TForm_MasterReportPrevilege.AddCheckedOnes(ChildId: Integer; ChildNode: TTreeNode);
 var
 li_childId: Integer;
 ls_childNode:string;
...
procedure TForm_MasterReportPrevilege.tv_previlageClick(Sender: TObject);
var
...
procedure TForm_MasterReportPrevilege.tv_previlageNodeCheckedChanged(Sender: TObject;
...
procedure TForm_MasterReportPrevilege.BB_OKClick(Sender: TObject);
var
     ...
     // showmessage(rootnode.text);
      ...
      begin
             ...
             begin
                ...
                Session:=DM_Hospital.DB;
                sql.Clear;
                sql.Add('Delete from hs_hoac_hospitalaccess ');
                sql.Add('where hoac_HOSPITALID='+inttostr(pi_hospitalid));
           ...
           begin
               ...
               begin
                    PREVILAGEID := GetMaxID('hs_hoac_hospitalaccess', 'hoac_PREVILAGEID');
                    with Query_function do
                     begin
                        close;
                        Session:=DM_Hospital.DB;
                        sql.Clear;
                        sql.Add('Insert into hs_hoac_hospitalaccess(hoac_PREVILAGEID,hoac_hospitalID,hoac_SUBMENUID,hoac_ROOTMENUID,hoac_NODETEXT) ');
                        sql.Add('values('+inttostr(PREVILAGEID)+','+inttostr(pi_hospitalid)+','+inttostr(li_childid)+','+inttostr(li_childid1)+','+Quotedstr(childnode.Text)+')');
               ...
               begin
                 with Query_function do
                     begin
                        ...
                        sql.Add('Delete from hs_hoac_hospitalaccess ');
                        sql.Add('where hoac_hospitalid='+inttostr(pi_hospitalid));
                         sql.Add('and hoac_nodetext='+Quotedstr(childnode.Text));
                         ...
                         begin
                              ...
                              with Query_function do
                               begin
                                  ...
                                  sql.Clear;
                                  sql.Add('Insert into hs_hoac_hospitalaccess(hoac_PREVILAGEID,hoac_hospitalid,hoac_SUBMENUID,hoac_ROOTMENUID,hoac_nodetext) ');
                                  sql.Add('values('+inttostr(PREVILAGEID)+','+inttostr(pi_hospitalid)+','+inttostr(li_childId)+','+inttostr(li_childId1)+','+Quotedstr(SelNode.Text)+')');
                                  //sql.SaveToFile('d:\ok.txt');
                                  ExecSQL;
                               end;
                               //node.StateIndex:=2;
                         ...
                         begin
                           with Query_function do
                               begin
                                  ...
                                  sql.Add('Delete from hs_hoac_hospitalaccess ');
                                  sql.Add('where hoac_hospitalid='+inttostr(pi_hospitalid));
                                   sql.Add('and hoac_nodetext='+Quotedstr(selnode.Text));
                                 // sql.add('and uspr_userprivilegeid='+inttostr(uspr_previlegeid));
                                  //sql.SaveToFile('d:\ok1.txt');
                                  ExecSQL;
...
procedure TForm_MasterReportPrevilege.SaveThirdDepth(Id: Integer; Node: TTreeNode);
var
Query_Function:Tquery;
thirdnode:ttreenode;
...
procedure TForm_MasterReportPrevilege.SaveFourthDepth(Id: Integer; Node: TTreeNode);
var
Query_Function:Tquery;
...
function TForm_MasterReportPrevilege.checkDatas(accessid: Integer; userid: Integer): Boolean;
begin
     with Query1 do
     begin
          close;
